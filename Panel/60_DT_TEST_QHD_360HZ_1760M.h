...
#if(_PANEL_TYPE == _DT_TEST_QHD_360HZ_1760M)
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _PANEL_DPTX_LINK_RATE                   _PANEL_DPTX_LINK_HBR3
...
#define _PANEL_MAX_FRAME_RATE                   3600
#define _PANEL_MIN_FRAME_RATE                   480

#define _PANEL_DP_FREESYNC_MAX_FRAME_RATE       3600
#define _PANEL_DP_FREESYNC_MIN_FRAME_RATE       480

#define _PANEL_HDMI_FREESYNC_MAX_FRAME_RATE     3600
#define _PANEL_HDMI_FREESYNC_MIN_FRAME_RATE     480

#define _PANEL_HDMI21_VRR_MAX_FRAME_RATE        3600
...
#define _PANEL_DH_TOTAL                         2816
#define _PANEL_DH_TOTAL_MAX                     2952
#define _PANEL_DH_TOTAL_MIN                     2800

#define _PANEL_DV_START                         16
#define _PANEL_DV_HEIGHT                        1440
#define _PANEL_DV_END                           1456

#define _PANEL_DV_TOTAL                         1675
#define _PANEL_DV_TOTAL_MAX                     13000
#define _PANEL_DV_TOTAL_MIN                     1479

#define _PANEL_DH_SYNC_WIDTH                    16
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      984
#define _PANEL_PIXEL_CLOCK_MAX                  1760
#define _PANEL_PIXEL_CLOCK_MIN                  192 // 240
...
#endif // End of #if(_PANEL_TYPE == _DT_TEST_QHD_360HZ_1760M)
