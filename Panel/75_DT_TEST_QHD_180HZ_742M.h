...
#if(_PANEL_TYPE == _DT_TEST_QHD_180HZ_742M)
//----------------------------------------------------------------------------------------------------
// ID Code      : 75_DT_TEST_QHD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_MAX_FRAME_RATE                   1800
#define _PANEL_MIN_FRAME_RATE                   400

#define _PANEL_DP_FREESYNC_MAX_FRAME_RATE       1800
#define _PANEL_DP_FREESYNC_MIN_FRAME_RATE       400

#define _PANEL_HDMI_FREESYNC_MAX_FRAME_RATE     1800
#define _PANEL_HDMI_FREESYNC_MIN_FRAME_RATE     400

#define _PANEL_HDMI21_VRR_MAX_FRAME_RATE        1800
...
#define _PANEL_DV_TOTAL_MAX                     4500 // 5600 // 1483
...
#define _PANEL_PIXEL_CLOCK_MAX                  742 // 600
...
//--------------------------------------------------
#define _PANEL_LAST_LINE_MAX                    (_PANEL_DH_TOTAL_MIN - 100)
#define _PANEL_LAST_LINE_MIN                    (_PANEL_DH_TOTAL_MIN - 200)
...
#endif // End of #if(_PANEL_TYPE == _DT_TEST_QHD_180HZ_742M)
