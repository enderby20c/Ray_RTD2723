...
#if(_PANEL_TYPE == _INNOLUX_LED_VBO_28_UHD_FREESYNC)
//----------------------------------------------------------------------------------------------------
// ID Code      : _INNOLUX_LED_VBO_28_UHD_FREESYNC.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_VBO_OUTPUT_PORT                  _VBO_16_DATA_LANE
...
#define _PANEL_MIN_FRAME_RATE                   1000
...
#define _PANEL_DH_TOTAL                         4192 // 4560
#define _PANEL_DH_TOTAL_MAX                     4800
#define _PANEL_DH_TOTAL_MIN                     4192

#define _PANEL_DV_START                         10
#define _PANEL_DV_HEIGHT                        2160
#define _PANEL_DV_END                           2170

#define _PANEL_DV_TOTAL                         2196 // 2250
#define _PANEL_DV_TOTAL_MAX                     12000
#define _PANEL_DV_TOTAL_MIN                     2196

#define _PANEL_DH_SYNC_WIDTH                    16
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      1232
#define _PANEL_PIXEL_CLOCK_MAX                  1332
#define _PANEL_PIXEL_CLOCK_MIN                  1000
...
#endif // End of #if(_PANEL_TYPE == _INNOLUX_LED_VBO_28_UHD_FREESYNC)
