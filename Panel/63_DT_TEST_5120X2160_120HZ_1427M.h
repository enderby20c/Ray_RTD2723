...
#if(_PANEL_TYPE == _DT_TEST_5120X2160_120HZ_1427M)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_WIDTH                         5120                // Display Horizontal Width
#define _PANEL_DH_END                           5200                // Display Horizontal End Position

#define _PANEL_DH_TOTAL                         5280                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     6400                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     5280                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         12                  // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        2160                // Display Vertical Width
#define _PANEL_DV_END                           2172                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         2222                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     5657                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     2222                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    16                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      704                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  1427                // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  564                 // Mininum Pixel Clock in MHz
...
#endif // End of #if(_PANEL_TYPE == _DT_TEST_5120X2160_120HZ_1427M)
