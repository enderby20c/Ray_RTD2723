...
#if(_PANEL_TYPE == _DT_TEST_UHD_60HZ_610M)
//----------------------------------------------------------------------------------------------------
// ID Code      : 74_DT_TEST_UHD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_WIDTH                         4096
#define _PANEL_DH_END                           4144

#define _PANEL_DH_TOTAL                         4500
#define _PANEL_DH_TOTAL_MAX                     4652
#define _PANEL_DH_TOTAL_MIN                     4272
...
#define _PANEL_DV_TOTAL_MAX                     3900 // 2860
#define _PANEL_DV_TOTAL_MIN                     2180

#define _PANEL_DH_SYNC_WIDTH                    8 // 16
...
//--------------------------------------------------
#define _PANEL_LAST_LINE_MAX                    (_PANEL_DH_TOTAL_MIN - 100) // 150
#define _PANEL_LAST_LINE_MIN                    (_PANEL_DH_TOTAL_MIN - 200) // 50
...
#endif // End of #if(_PANEL_TYPE == _DT_TEST_UHD_60HZ_610M)
