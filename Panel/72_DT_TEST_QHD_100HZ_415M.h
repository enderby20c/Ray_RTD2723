...
#if(_PANEL_TYPE == _DT_TEST_QHD_100HZ_415M)
//----------------------------------------------------------------------------------------------------
// ID Code      : 72_DT_TEST_QHD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DP_FREESYNC_MAX_FRAME_RATE       1000
#define _PANEL_DP_FREESYNC_MIN_FRAME_RATE       400

#define _PANEL_HDMI_FREESYNC_MAX_FRAME_RATE     1000
#define _PANEL_HDMI_FREESYNC_MIN_FRAME_RATE     400

#define _PANEL_HDMI21_VRR_MAX_FRAME_RATE        1000
...
#define _PANEL_PIXEL_CLOCK_MAX                  415 // 600
...
#endif // End of #if(_PANEL_TYPE == _DT_TEST_QHD_100HZ_415M)
