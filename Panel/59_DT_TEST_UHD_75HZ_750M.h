...
#if(_PANEL_TYPE == _DT_TEST_UHD_75HZ_750M)
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DV_TOTAL_MAX                     3600 // 2372
...
#define _PANEL_PIXEL_CLOCK_MAX                  750 // 560
...
#endif // End of #if(_PANEL_TYPE == _DT_TEST_UHD_75HZ_750M)
