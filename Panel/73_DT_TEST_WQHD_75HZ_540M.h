...
#if(_PANEL_TYPE == _DT_TEST_WQHD_75HZ_540M)
//----------------------------------------------------------------------------------------------------
// ID Code      : 73_DT_TEST_WQHD.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DV_TOTAL_MAX                     3500 // 4500
...
#define _PANEL_PIXEL_CLOCK                      335                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  540 // 690          // Maxinum Pixel Clock in MHz500//
#define _PANEL_PIXEL_CLOCK_MIN                  100                 // Mininum Pixel Clock in MHz300//
...
#endif // End of #if(_PANEL_TYPE == _DT_TEST_WQHD_75HZ_540M)
