...
#if(_PANEL_TYPE == _DT_TEST_QHD_60HZ_1066M)
//----------------------------------------------------------------------------------------------------
// ID Code      : _DT_TEST_QHD_60HZ_1066M.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_MAX_FRAME_RATE                   608
...
#define _PANEL_DH_END                           2640

#define _PANEL_DH_TOTAL                         11072
#define _PANEL_DH_TOTAL_MAX                     11072
#define _PANEL_DH_TOTAL_MIN                     11072

#define _PANEL_DV_START                         10
#define _PANEL_DV_HEIGHT                        1440
#define _PANEL_DV_END                           1450

#define _PANEL_DV_TOTAL                         1603
#define _PANEL_DV_TOTAL_MAX                     2440
#define _PANEL_DV_TOTAL_MIN                     1580

#define _PANEL_DH_SYNC_WIDTH                    16
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                      1065
#define _PANEL_PIXEL_CLOCK_MAX                  1099
#define _PANEL_PIXEL_CLOCK_MIN                  1026
...
//--------------------------------------------------
#define _PANEL_LAST_LINE_MAX                    (11072 - 50)
#define _PANEL_LAST_LINE_MIN                    (11072 - 250)
...
#endif // End of #if(_PANEL_TYPE == _DT_TEST_QHD_60HZ_1066M)
