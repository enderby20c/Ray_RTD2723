...
//----------------------------------------------------------------------------------------------------
// ID Code      : LedDriver_05_MBLOCK_MBI6353.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _LOCAL_DIMMING_PWM2SPI_APPEND_NUM_OF_BYTES      1               // 0:Not Append ; 1:Append
#define _LOCAL_DIMMING_PWM2SPI_PATTERN_OF_DUMMY_BYTE    0               // 0:0x00 ; 1:0xFF
#define _LOCAL_DIMMING_PWM2SPI_DUMMY_WIDTH_BY_BYTE      2
#define _DEVICE_LED_DRIVER_COMMUNICATE_TYPE             _INTERFACE_SPI
#define _DEVICE_LED_DRIVER_SUPPORT_BROADCAST            _ON
#define _DEVICE_LED_DRIVER_SPI_CMD_HEADER_BYTES         6
...
#define _DEVICE_LED_DRIVER_CHECKSUM_BYTE_NUM            0               // not use checksum function
#define _DEVICE_LED_DRIVER_MCU_TYPE                     _OFF
#define _DEVICE_LED_DRIVER_READ_DUMMY_BYTE_NUM          0
#define _DEVICE_LED_DRIVER_BROADCAST_ID                 0x8000
...
#define _DEVICE_LED_DRIVER_ADIM_ADDR                    0x0020
#define _DEVICE_LED_DRIVER_ADIM_WIDTH_BY_BYTE           2
