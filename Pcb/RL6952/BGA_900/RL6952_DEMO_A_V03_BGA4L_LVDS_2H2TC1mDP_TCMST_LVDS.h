...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_DEMO_A_V03_BGA4L_LVDS_2H2TC1mDP_TCMST_LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6952_DEMO_A_V03_BGA4L_LVDS_2H2TC1mDP_TCMST_LVDS)
...
#define _D1_DP_CONNECTOR_TYPE                       _DP_CONNECTOR_TYPE_C
#define _D1_DP_LINK_CLK_RATE                        _DP_ULTRA_SPEED_1350MHZ
...
#define _D1_TYPE_C_EMB_UNATTACH_HW_FORCE_VBUS_OFF   _ON
...
// For Type-C Embedded Port Controller PMIC
#define _D1_TYPE_C_PMIC_TYPE                        _PMIC_SY9228
#define _D1_TYPE_C_PMIC_SLAVE_ADDRESS               0xE6
#define _D1_TYPE_C_PMIC_IIC                         _PMIC_HW_IIC_PIN_E3_H8_1_0
#define _D1_TYPE_C_PMIC_VBUS_ADC_CHANNEL            _TYPE_C_PMIC_ADC_MAPPING_10_BIT_ADC_2
...
// D9 Input Port
//--------------------------------------------------
//#define _D9_INPUT_PORT_TYPE                         _D9_DP_PORT
//#define _D9_EMBEDDED_XRAM_MAX_SIZE                  _EDID_SIZE_384
//#define _D9_EMBEDDED_XRAM_LOCATION                  _EDID_TABLE_LOCATION_USER
...
//#define _D9_INPUT_PORT_GROUP                        _INPUT_PORT_GROUP_1
...
//#define _INPUT_PORT_SEARCH_PRI_5                    _D9_INPUT_PORT
...
#define _PCB_SYS_EEPROM_IIC                         _HW_IIC_PIN_AG6_AG7
...
// Macro of DP Cable ID Detect Setting
//-----------------------------------------------
#define SET_D2_CABLEID_DET_CONFIG1(x)               {SET_GPIO_PIN_C5(x);}
...
// Series Pin Share //
//////////////////////
#include <RL6952/BGA_900/RL6952_DEMO_A_V03_BGA4L_LVDS_2H2TC1mDP_TCMST_LVDS_PINSHARE.h>
...
//-----------------------------------------------
#define SET_VCCKOFFPOWER(x)                         {SET_GPIO_PIN_F9(x);}
...
//-----------------------------------------------
#define SET_DDRPOWER(x)                             {SET_GPIO_PIN_E12(x);}
...
//-----------------------------------------------
#define SET_USBLVPOWER(x)                           {SET_GPIO_PIN_H7(x);}
...
//--------------------------------------------------
#define GET_PANELPOWER()                            (GET_GPIO_PIN_E11())
#define SET_PANELPOWER(x)                           {SET_GPIO_PIN_E11(x);}
...
//--------------------------------------------------
#define SET_BACKLIGHTPOWER(x)                       {SET_GPIO_PIN_G9(x);}
...
//-----------------------------------------------
#define SET_FLASH_WRITE_PROTECT(x)                  {SET_GPIO_PIN_AF6(x);}
...
//-----------------------------------------------
#define GET_EEPROM_WRITE_PROTECT()                  (GET_GPIO_PIN_AF7())
#define SET_EEPROM_WRITE_PROTECT(x)                 {SET_GPIO_PIN_AF7(x);}
...
//-----------------------------------------------
#define SET_EDID_WRITE_PROTECT(x)                   {SET_GPIO_PIN_F8(x);}
...
//-----------------------------------------------
#define SET_D3_EXT_SWITCH_EDID_0(x)                 {SET_GPIO_PIN_E5(x);}
#define SET_D4_EXT_SWITCH_EDID_0(x)                 {SET_GPIO_PIN_B5(x);}
...
//-----------------------------------------------
#define GET_D0_DP_PIN15_CONNECT()                   (GET_GPIO_PIN_G5())
#define GET_D0_DP_PIN17_CONNECT()                   (GET_GPIO_PIN_F4())
#define GET_D0_CONNECT()                            (GET_GPIO_PIN_A5())

#define GET_D1_DP_PIN15_CONNECT()                   (GET_GPIO_PIN_H5())
#define GET_D1_DP_PIN17_CONNECT()                   (GET_GPIO_PIN_F3())
#define GET_D1_CONNECT()                            (GET_GPIO_PIN_A4())

#define GET_D2_DP_PIN15_CONNECT()                   (GET_GPIO_PIN_K4())
#define GET_D2_DP_PIN16_CONNECT()                   (GET_GPIO_PIN_G6())
#define GET_D2_DP_PIN17_CONNECT()                   (GET_GPIO_PIN_J4())
...
#define GET_D3_CONNECT()                            (GET_GPIO_PIN_K9())
#define GET_D4_CONNECT()                            (GET_GPIO_PIN_H11())
...
//-----------------------------------------------
#define GET_D2_HPD()                                (GET_GPIO_PIN_H4())
#define SET_D2_HPD(x)                               {SET_GPIO_PIN_H4(x);}
#define GET_D3_HPD()                                (GET_GPIO_PIN_H13())
#define SET_D3_HPD(x)                               {SET_GPIO_PIN_H13(x);}
#define GET_D4_HPD()                                (GET_GPIO_PIN_K8())
#define SET_D4_HPD(x)                               {SET_GPIO_PIN_K8(x);}
...
// Macro of LED On/Off
//--------------------------------------------------
#define SET_LED1(x)                                 {SET_GPIO_PIN_AG12(x);}
#define SET_LED2(x)                                 {SET_GPIO_PIN_AG11(x);}
#define SET_LED3_1(x)                               {SET_GPIO_PIN_EMPTY(x);}
#define SET_LED4_1(x)                               {SET_GPIO_PIN_AA25(x);}
...
//-----------------------------------------------
#define SET_D0_PMIC_POWER(x)                        {SET_GPIO_PIN_D12(x);}
#define SET_D1_PMIC_POWER(x)                        {SET_GPIO_PIN_B4(x);}
...
//-----------------------------------------------
#define SET_D0_PMIC_VBUS_SINK_CONTROL(x)            {SET_GPIO_PIN_T4(x);}
#define SET_D1_PMIC_VBUS_SINK_CONTROL(x)            {SET_GPIO_PIN_A3(x);}
...
//-----------------------------------------------
#define GET_D0_PMIC_INTERRUPT()                     (GET_GPIO_PIN_D3())
#define GET_D1_PMIC_INTERRUPT()                     (GET_GPIO_PIN_J9())
...
//-----------------------------------------------
#define SET_D0_TYPE_C_ADC_SWITCH(x)                 {SET_GPIO_PIN_D13(x);}
#define SET_D1_TYPE_C_ADC_SWITCH(x)                 {SET_GPIO_PIN_H9(x);}
...
//-----------------------------------------------
#define SET_D0_TYPE_C_HIGH_VBUS_DETECT_SWITCH(x)    {} // For EPR: {SET_GPIO_PIN_E5(x);}
#define SET_D1_TYPE_C_HIGH_VBUS_DETECT_SWITCH(x)    {} // For EPR: {SET_GPIO_PIN_B5(x);}
...
//-----------------------------------------------
#define GET_HUB_BPWR_0_POWER()                      (GET_GPIO_PIN_E4())
#define SET_HUB_BPWR_0_POWER(x)                     {SET_GPIO_PIN_E4(x);}

#define _VBUS_0_POWER_ON                            1
#define _VBUS_0_POWER_OFF                           0
...
#endif // End of #if(_PCB_TYPE == _RL6952_DEMO_A_V03_BGA4L_LVDS_2H2TC1mDP_TCMST_LVDS)
