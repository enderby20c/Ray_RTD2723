...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_BGA2L_PCB_LVDS_EXAMPLE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6952_BGA2L_PCB_LVDS_EXAMPLE)


//////////////////////
// Series Pin Share //
//////////////////////
#include <RL6952/BGA_900/RL6952_BGA2L_PCB_LVDS_EXAMPLE_PINSHARE.h>
...
// For HDMI Edid
#define _D1_MAX_HDMI_EDID_COUNT                         0
#define _D1_HDMI_CEC_PIN                                _HDMI_CEC_NONE
#define _D1_HDMI_CEC_EDID_PHYSICAL_ADDR                 0x0000

// For HDMI
#define _D1_HDMI_MAC_TYPE                               _HDMI_MAC_NONE
#define _D1_HDMI_LINK_CLK_RATE                          _HDMI_LINK_SPEED_NONE
#define _D1_HDMI_MAIN_LINK_LANES                        _HDMI_LANE_AUTO_MODE
...
#define _P0_DP_LINK_CLK_RATE                            _DP_HIGH_SPEED3_810MHZ
...
#define PCB_A0_PIN()                                    (GET_GPIO_PIN_EMPTY())
...
#define PCB_D12_PIN()                                   (GET_GPIO_PIN_EMPTY())
#define PCB_D13_PIN()                                   (GET_GPIO_PIN_EMPTY())
#define PCB_D14_PIN()                                   (GET_GPIO_PIN_EMPTY())
#define PCB_D15_PIN()                                   (GET_GPIO_PIN_EMPTY())
...
#endif // End of #if(_PCB_TYPE == _RL6952_BGA2L_PCB_LVDS_EXAMPLE)
