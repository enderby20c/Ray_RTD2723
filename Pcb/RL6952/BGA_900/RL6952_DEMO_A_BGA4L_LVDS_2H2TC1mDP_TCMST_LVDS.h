...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_DEMO_A_BGA4L_LVDS_2H2TC1mDP_TCMST_LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6952_DEMO_A_BGA4L_LVDS_2H2TC1mDP_TCMST_LVDS)
...
// Series Pin Share //
//////////////////////
#include <RL6952/BGA_900/RL6952_DEMO_A_BGA4L_LVDS_2H2TC1mDP_TCMST_LVDS_PINSHARE.h>
...
#define SET_D4_EXT_SWITCH_EDID_0(x)                 {SET_GPIO_PIN_D12(x);}
...
//-----------------------------------------------
#define SET_D0_PMIC_POWER(x)                        {SET_GPIO_PIN_B5(x);}
#define SET_D1_PMIC_POWER(x)                        {SET_GPIO_PIN_D13(x);}
...
//-----------------------------------------------
#define SET_D0_TYPE_C_ADC_SWITCH(x)                 {SET_GPIO_PIN_B4(x);}
...
#define SET_D1_TYPE_C_HIGH_VBUS_DETECT_SWITCH(x)    {} // For EPR: {SET_GPIO_PIN_D12(x);}
...
#endif // End of #if(_PCB_TYPE == _RL6952_DEMO_A_BGA4L_LVDS_2H2TC1mDP_TCMST_LVDS)
