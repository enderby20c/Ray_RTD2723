...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_QA_A_BGA4L_LVDS_2H2TC1DP_TCMST_LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6952_QA_A_BGA4L_LVDS_2H2TC1DP_TCMST_LVDS)
...
// Series Pin Share //
//////////////////////
#include <RL6952/BGA_900/RL6952_QA_A_BGA4L_LVDS_2H2TC1DP_TCMST_LVDS_PINSHARE.h>
...
#define SET_LED3_1(x)                               {SET_GPIO_PIN_E4(x);}
...
#endif // End of #if(_PCB_TYPE == _RL6952_QA_A_BGA4L_LVDS_2H2TC1DP_TCMST_LVDS)
