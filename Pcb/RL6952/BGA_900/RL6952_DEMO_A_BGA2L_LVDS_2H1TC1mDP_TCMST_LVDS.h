...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_DEMO_A_BGA2L_LVDS_1H2TC1mDP_TCMST_LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6952_DEMO_A_BGA2L_LVDS_2H1TC1mDP_TCMST_LVDS)
...
// Series Pin Share //
//////////////////////
#include <RL6952/BGA_900/RL6952_DEMO_A_BGA2L_LVDS_2H1TC1mDP_TCMST_LVDS_PINSHARE.h>
...
//-----------------------------------------------
#define GET_HUB_BPWR_0_POWER()                      (GET_GPIO_2L_900PIN_PIN_C4())
#define SET_HUB_BPWR_0_POWER(x)                     {SET_GPIO_2L_900PIN_PIN_C4(x);}
...
#endif // End of #if(_PCB_TYPE == _RL6952_DEMO_A_BGA2L_LVDS_2H2TC1mDP_TCMST_LVDS)
