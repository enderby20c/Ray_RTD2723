...
{
#if(_EDID_D4_TYPE_SEL == _EDID_HDMI_1920_1080_60HZ)
...
#elif(_EDID_D4_TYPE_SEL == _EDID_HDMI_1920_1080_40HZ_75HZ_FREESYNC)
#include <EDID/EdidHdmi/EDID_HDMI_BC_1920x1080@40-75_DRR0.h>
#elif(_EDID_D4_TYPE_SEL == _EDID_HDMI_1920_1080_40HZ_120HZ_FREESYNC)
...
#elif(_EDID_D4_TYPE_SEL == _EDID_HDMI_2560_1440_40HZ_70HZ_FREESYNC)
#include <EDID/EdidHdmi/EDID_HDMI_BC_2560x1440@40-70_DRR0.h>
#elif(_EDID_D4_TYPE_SEL == _EDID_HDMI2_3840_2160_60HZ_WITH_420)
#include <EDID/EdidHdmi/EDID_HDMI_BC_3840x2160@60_M0.h>
#elif(_EDID_D4_TYPE_SEL == _EDID_HDMI2_3840_2160_60HZ)
#include <EDID/EdidHdmi/EDID_HDMI_BC_3840x2160@60.h>
#elif(_EDID_D4_TYPE_SEL == _EDID_HDMI2_3840_2160_60HZ_WITH_420_HDR)
