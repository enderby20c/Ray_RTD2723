...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerGDIPhyRx0Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
extern void ScalerGDIPhyRx0LaneMode(EnumLaneConfig enumLaneMode, BYTE ucLane);
extern void ScalerGDIPhyRx0LanePower(bit bEnable, BYTE ucLane);
#endif
