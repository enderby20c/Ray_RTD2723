...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerTypeC1Pd_WDINT.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//****************************************************************************
//--------------------------------------------------
// Description  : WD Timer Event Proc of PD RX1
// Input Value  : enumEventID, pucActiveWDID, pucActiveWDTime
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdWDTimerEventProc_WDINT(EnumScalerWDTimerEventID enumEventID, BYTE *pucActiveWDID, BYTE *pucActiveWDTime)
{
    // Only Run PD WD Timer Event Proc When CC is Attached
    if(GET_TYPE_C_1_CC_ATTACHED() == _FALSE)
    {
        return;
    }
    ...
    switch(enumEventID)
    {
        case _SCALER_WD_TIMER_EVENT_PD_1_CBL_TIMEOUT:
            ...
            {
                ScalerTypeC1PdWDTimerEventCableProc_WDINT(pucActiveWDID, pucActiveWDTime);
            }
...
#endif
                // Send SRC_CAP
                SET_TYPE_C_1_PD_FW_STATE(_PD_SRC_INT_SEND_CAP);
                SET_TYPE_C_1_PD_TX_RETRY_FAIL_EVENT(_PD_TX_RETRY_FAIL_BY_STATE);
                ScalerTypeC1PdSendMsg_WDINT(_PD_SOP_PKT, _PD_CMD_SRC_CAP, _PD_VDM_CMD_RESERVED);
            }
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_SENDER_RESP_TIMEOUT:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() == _PD_SNK_INT_WAIT_SRC_CAP)
            {
                if(GET_TYPE_C_1_PD_WD_TIMER_VALUE() < _SINK_WAIT_CAP_TIMER)
                {
                    if((_SINK_WAIT_CAP_TIMER - GET_TYPE_C_1_PD_WD_TIMER_VALUE()) > _MAX_WD_EVENT_TIME)
                    {
                        *pucActiveWDTime = _MAX_WD_EVENT_TIME;
                        *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_SEND_HARD_RST;

                        SET_TYPE_C_1_PD_WD_TIMER_VALUE(GET_TYPE_C_1_PD_WD_TIMER_VALUE() + _MAX_WD_EVENT_TIME);
                    }
                    else
                    {
                        *pucActiveWDTime = _SINK_WAIT_CAP_TIMER - GET_TYPE_C_1_PD_WD_TIMER_VALUE();
                        *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_SEND_HARD_RST;
                ...
                else
                {
                    ...
                    ScalerUsb3RepeaterMacSetPdNoResponse_WDINT(ScalerTypeCxPcbxMapping_WDINT(_EMB_TYPE_C_1));
#endif

                    // Send Hard Reset
                    ScalerTypeC1PdSendHardRst_WDINT(pucActiveWDID, pucActiveWDTime);
                }
            }
            else
            {
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_PS_TRANSITION_TIMEOUT:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() != _PD_HARDRESET)
            {
                if(GET_TYPE_C_1_PD_WD_TIMER_VALUE() < _PS_TRANSITION_TIMER)
                {
                    if((_PS_TRANSITION_TIMER - GET_TYPE_C_1_PD_WD_TIMER_VALUE()) > _MAX_WD_EVENT_TIME)
                    {
                        *pucActiveWDTime = _MAX_WD_EVENT_TIME;
                        *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_PS_TRANSITION_TIMEOUT;

                        SET_TYPE_C_1_PD_WD_TIMER_VALUE(GET_TYPE_C_1_PD_WD_TIMER_VALUE() + _MAX_WD_EVENT_TIME);
                    }
                    else
                    {
                        *pucActiveWDTime = _PS_TRANSITION_TIMER - GET_TYPE_C_1_PD_WD_TIMER_VALUE();
                        *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_PS_TRANSITION_TIMEOUT;

                        SET_TYPE_C_1_PD_WD_TIMER_VALUE(_PS_TRANSITION_TIMER);
                    }
                }
                else
                {
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() != _PD_HARDRESET)
            {
                switch(GET_TYPE_C_1_PD_DP_ALT_STATE())
                {
                    case _PD_ALT_MODE_INT_WAIT_DISCOVER_ID_RESP:
                        ...
                        ADD_TYPE_C_1_PD_PARTNER_VDM_NO_RESP_CNT();
                    ...
                    case _PD_ALT_MODE_READY:
                        ...
                        if(GET_TYPE_C_1_PD_FORCE_HPD_IRQ() == _TRUE)
                        {
                            ...
                            ScalerTypeC1PdPushHpd_WDINT(_PD_HPD_IRQ, 0);
                        }
                ...
                SET_TYPE_C_1_PD_VDMMSG_WAIT_FLAG();

                // Set AMS = None
                SET_TYPE_C_1_PD_AMS_STATUS(_PD_AMS_NONE);

                // Back to Ready State
                ScalerTypeC1PdBackToReadyState_WDINT();
            }
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_SRC_TURN_ON_POWER:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() != _PD_HARDRESET)
            {
                ...
                ScalerTypeC1PmicSetting_WDINT(_ON, _PD_POWER_SRC, GET_TYPE_C_1_PD_SRC_PDO_TYPE(GET_TYPE_C_1_PD_PARTNER_OBJ_POS() - 1), GET_TYPE_C_1_PD_PARTNER_REQ_VOL(), GET_TYPE_C_1_OCP_CURRENT(), GET_TYPE_C_1_PD_SRC_CAP_PEAK(GET_TYPE_C_1_PD_PARTNER_OBJ_POS() - 1));
#endif
                // Update PDO Status
                SET_TYPE_C_1_PD_PDO_STATUS_VOL(GET_TYPE_C_1_PD_PARTNER_REQ_VOL());
                SET_TYPE_C_1_PD_PDO_STATUS_CUR(GET_TYPE_C_1_PD_PARTNER_MAX_CUR());
                SET_TYPE_C_1_PD_PDO_STATUS_OBJ_POS(GET_TYPE_C_1_PD_PARTNER_OBJ_POS());

#if(_EMB_TYPE_C_1_UNATTACH_HW_FORCE_VBUS_OFF == _OFF)
                if(GET_TYPE_C_1_PD_PDO_STATUS_VOL() > 500)
                {
                    // Tool Show Warning UI when We Provide Vbus > 5V
                    ScalerTypeC1CcToolWarningUIControl_WDINT(_ENABLE);
                }
                else
                {
                    // Tool Not Show Warning UI when We Provide Vbus <= 5V
                    ScalerTypeC1CcToolWarningUIControl_WDINT(_DISABLE);
                }
#endif

                // State Transition
                SET_TYPE_C_1_PD_FW_STATE(_PD_SRC_WDINT_SEND_PSRDY);

                // Active WD Timer to Check Vbus, Then Start PMIC Protection and Send PS_RDY if Vbus Ready
                *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_CHECK_VBUS;

                if(GET_TYPE_C_1_PD_EPR_MODE() == _TRUE)
                {
                    if(GET_TYPE_C_1_PD_REQ_AVS_VOL_SMALL_STEP() != _TRUE)
                    {
                ...
                {
                    if(GET_TYPE_C_1_PD_REQ_PPS_VOL_SMALL_STEP() != _TRUE)
                    {
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_CHECK_VBUS:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() == _PD_WDINT_SEND_CBL_DISCOVER_ID)
            {
                ADD_TYPE_C_1_PD_CHECK_VBUS_CNT();

                if((ScalerTypeCAdcCheckVbusReady_WDINT(_EMB_TYPE_C_1, 500) == _TRUE) || (GET_TYPE_C_1_PD_CHECK_VBUS_CNT() >= 8))
                {
                    ScalerSetBit_EXINT(P6B_19_PD_DUMMY_1, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), GET_TYPE_C_1_PD_CHECK_VBUS_CNT());
            ...
            else if(GET_TYPE_C_1_PD_FW_STATE() == _PD_SRC_WDINT_SEND_CAP)
            {
                ADD_TYPE_C_1_PD_CHECK_VBUS_CNT();
                ...
                if((ScalerTypeCAdcCheckVbusReady_WDINT(_EMB_TYPE_C_1, 500) == _TRUE) || (GET_TYPE_C_1_PD_CHECK_VBUS_CNT() >= 8))
                {
                    ...
                    ScalerTypeC1PmicProtectStart_WDINT(_TYPE_C_POWER_SRC);
#endif
            ...
            else if(GET_TYPE_C_1_PD_FW_STATE() == _PD_SRC_WDINT_SEND_PSRDY)
            {
                ADD_TYPE_C_1_PD_CHECK_VBUS_CNT();

#if(_TYPE_C_EIZO_CUSTOMIZED_VBUS_CHECK_TIMER_SUPPORT == _ON)
                if((ScalerTypeCAdcCheckVbusReady_WDINT(_EMB_TYPE_C_1, GET_TYPE_C_1_PD_PDO_STATUS_VOL()) == _TRUE) || (GET_TYPE_C_1_PD_CHECK_VBUS_CNT() >= 10))
#else
                if((ScalerTypeCAdcCheckVbusReady_WDINT(_EMB_TYPE_C_1, GET_TYPE_C_1_PD_PDO_STATUS_VOL()) == _TRUE) || (GET_TYPE_C_1_PD_CHECK_VBUS_CNT() >= 8))
#endif
                {
                    ScalerSetBit_EXINT(P6B_19_PD_DUMMY_1, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), GET_TYPE_C_1_PD_CHECK_VBUS_CNT());
                    ...
                    ScalerTypeC1PmicSic437aTransitionReadyProc_WDINT();
#endif

                    // Send "PS_RDY" After Accept to Request and Ready to Provide New Negotiated Power Level
                    SET_TYPE_C_1_PD_FW_STATE(_PD_SRC_INT_SEND_PSRDY);
                    SET_TYPE_C_1_PD_TX_RETRY_FAIL_EVENT(_PD_TX_RETRY_FAIL_HARD_RESET);
                    ScalerTypeC1PdSendMsg_WDINT(_PD_SOP_PKT, _PD_CMD_PS_RDY, _PD_VDM_CMD_RESERVED);
                }
                else
                {
                    // Active WD Timer to Check Vbus
            ...
            else if((GET_TYPE_C_1_PD_FW_STATE() == _PD_SNK_READY) && (GET_TYPE_C_1_PD_SUB_STATE() == _PD_SUB_WDINT_SEND_SRC_ON_PSRDY))
            {
                ADD_TYPE_C_1_PD_CHECK_VBUS_CNT();
                ...
                if((ScalerTypeCAdcCheckVbusReady_WDINT(_EMB_TYPE_C_1, 500) == _TRUE) || (GET_TYPE_C_1_PD_CHECK_VBUS_CNT() >= 8))
                {
                    ...
                    if((GET_TYPE_C_1_PD_SPEC_VER() == _PD_VERSION_2_0) && (GET_TYPE_C_1_PD_VCONN_ROLE() == _PD_VCONN_SRC))
                    {
                        ...
                        ScalerSetByte_WDINT(P6B_34_RX_VALID_MSG_TYPE, (_BIT3 | _BIT2 | _BIT1 | _BIT0));
                    }
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_SRC_TURN_OFF_POWER:
            ...
            ScalerTypeC1PmicVbusDischarge_WDINT(_ON);
#endif
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_BACK_TO_READY_STATE:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() != _PD_HARDRESET)
            {
                ...
                if(GET_TYPE_C_1_PD_SUB_STATE() == _PD_SUB_BIST_MODE)
                {
                    ...
                    // Enable Rcv Msg INT
                    ScalerTypeC1PdRxIntControl_WDINT(_ENABLE);
                }
                else if(GET_TYPE_C_1_PD_SUB_STATE() == _PD_SUB_INT_WAIT_VCS_RESP)
                {
                    SET_TYPE_C_1_PD_VCS_REJECT();
                }
                else if(GET_TYPE_C_1_PD_SUB_STATE() == _PD_SUB_INT_WAIT_DRS_RESP)
                {
                    SET_TYPE_C_1_PD_DRS_REJECT();
                }
                else if(GET_TYPE_C_1_PD_SUB_STATE() == _PD_SUB_INT_WAIT_PRS_RESP)
                {
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_TURN_OFF_VCONN_BACK_TO_HW_MODE:
            ...
            ScalerSetBit_EXINT(P6C_30_CC_HW_MODE_CTRL, ~(_BIT7 | _BIT6 | _BIT3 | _BIT1), (_BIT7 | _BIT6));
        ...
        */
        case _SCALER_WD_TIMER_EVENT_PD_1_SNK_SWITCH_TO_SRC:
            ...
            ScalerTypeC1CcSwitchPowerRole_WDINT(_PD_POWER_SRC);
            ...
            ScalerTypeC1PmicSetting_WDINT(_ON, _PD_POWER_SRC, _PD_FIX_SUPPLY_PDO, 500, GET_TYPE_C_1_OCP_CURRENT(), _PD_PEAK_CUR_NONE);
#endif

#if(_TYPE_C_EIZO_CUSTOMIZED_PMIC_SIC437A_SUPPORT == _ON)
            // [Eizo] SIC437A Customized Power Control : Sink Receive PS_RDY When Source Turn Off Vbus in PR Swap
            ScalerTypeC1PmicSic437aPRSwapToSrcProc_WDINT();
#endif

            // 3. Check Vbus 35ms (10ms + 25ms) after Received PS_RDY, Then Start PMIC Protection and Send "PS_RDY" if VbusSafe5V
            SET_TYPE_C_1_PD_SUB_STATE(_PD_SUB_WDINT_SEND_SRC_ON_PSRDY);
            *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_CHECK_VBUS;
            *pucActiveWDTime = 25;
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_SEND_EPR_ENTER_FAILED:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() != _PD_HARDRESET)
            {
                ...
                ScalerTypeC1PdSendMsg_WDINT(_PD_SOP_PKT, _PD_CMD_EPR_MODE, _PD_VDM_CMD_RESERVED);
            }
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_SEND_VCONN_SWAP:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() != _PD_HARDRESET)
            {
                SET_TYPE_C_1_PD_SUB_STATE(_PD_SUB_INT_SEND_VCONN_SWAP);
                SET_TYPE_C_1_PD_TX_RETRY_FAIL_EVENT(_PD_TX_RETRY_FAIL_SOFT_RESET);
                ScalerTypeC1PdSendMsg_WDINT(_PD_SOP_PKT, _PD_CMD_VCONN_SWAP, _PD_VDM_CMD_RESERVED);
            }
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_CHUNK_SENDER_REQ_TIMEOUT:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() != _PD_HARDRESET)
            {
                ...
                SET_TYPE_C_1_PD_TX_RETRY_FAIL_EVENT(_PD_TX_RETRY_FAIL_HARD_RESET);
                ScalerTypeC1PdSendSoftRst_WDINT(_PD_SOP_PKT);
            }
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_SEND_EPR_SRC_CAP:
            ...
            if(GET_TYPE_C_1_PD_FW_STATE() != _PD_HARDRESET)
            {
                ...
                SET_TYPE_C_1_PD_TX_RETRY_FAIL_EVENT(_PD_TX_RETRY_FAIL_SOFT_RESET);
                ScalerTypeC1PdSendMsg_WDINT(_PD_SOP_PKT, _PD_CMD_EPR_SRC_CAP, _PD_VDM_CMD_RESERVED);
            }
                ...
                case _PD_SUB_SEND_DP_VDM_REQ:
                    ...
                    if(GET_TYPE_C_1_PD_FORCE_HPD_IRQ() == _TRUE)
                    {
                        if(GET_TYPE_C_1_PD_DATA_ROLE() == _PD_DATA_UFP)
                        {
                            ...
                            // Send "Attention REQ"
                            ScalerTypeC1PdSendMsg_WDINT(_PD_SOP_PKT, _PD_CMD_VDM, _PD_VDM_CMD_ATTENTION_REQ);
                        }
                        else
                        {
                            SET_TYPE_C_1_PD_TX_RETRY_FAIL_EVENT(_PD_TX_RETRY_FAIL_SOFT_RESET);
                            ...
                            // Send "DP Status REQ"
                            ScalerTypeC1PdSendMsg_WDINT(_PD_SOP_PKT, _PD_CMD_VDM, _PD_VDM_CMD_10);
                        }
                    }
        ...
        case _SCALER_WD_TIMER_EVENT_PD_1_DELL_ATTEN_RETRY:
            ...
            ADD_TYPE_C_1_PD_DELL_ATTEN_RETRY_CNT();
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdWDTimerEventCableProc_WDINT(BYTE *pucActiveWDID, BYTE *pucActiveWDTime)
{
    switch(GET_TYPE_C_1_PD_FW_STATE())
    {
        case _PD_WDINT_SEND_CBL_DISCOVER_ID:
            ...
            ScalerSetBit_WDINT(P6B_EC_TX_PD_RTY_CNT, ~(_BIT5 | _BIT4 | _BIT3), 0x00);
#else
            // Do Not Retry Discover ID When Not Rcv. GoodCRC Resp(For RL6952)
            ScalerSetBit_WDINT(P6B_ED_TX_PD_CBL_RTY_CNT, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
#endif
#else
#if(_HW_PD_FUNCTION_GEN < _PD_FUNCTION_GEN_2)
            // Update Retry Counter According to Cable Spec Version
            ScalerTypeC1PdUpdateCableRetryCounter_WDINT();
#endif
#endif

            // Send Discover ID (SOP') to Get Cable Info
            SET_TYPE_C_1_PD_FW_STATE(_PD_INT_SEND_CBL_DISCOVER_ID);
            SET_TYPE_C_1_PD_TX_RETRY_FAIL_EVENT(_PD_TX_RETRY_FAIL_BY_STATE);
            ScalerTypeC1PdSendMsg_WDINT(_PD_SOP_P_PKT, _PD_CMD_VDM, _PD_VDM_CMD_DISCOVER_ID_REQ);
        ...
        case _PD_INT_WAIT_CBL_DISCOVER_ID_RESP:
            ...
            ScalerTypeC1PdUpdateTxFifoMsgHeader_WDINT();
        ...
        case _PD_WDINT_SEND_CBL_SOFT_RESET:
            ...
            SET_TYPE_C_1_PD_FW_STATE(_PD_INT_SEND_CBL_SOFT_RESET);
            SET_TYPE_C_1_PD_TX_RETRY_FAIL_EVENT(_PD_TX_RETRY_FAIL_BY_STATE);
            ScalerTypeC1PdSendSoftRst_WDINT(_PD_SOP_P_PKT);
        ...
        case _PD_INT_WAIT_CBL_SOFT_RESET_RESP:
            ...
            *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_CBL_TIMEOUT;
            *pucActiveWDTime = 10;
                ...
                case _PD_SUB_CABLE_PROC:
                    ...
                    switch(GET_TYPE_C_1_PD_CBL_STATE())
                    {
                        ...
                        case _PD_CBL_INT_WAIT_DISCOVER_ID_RESP:
                            ...
                            ADD_TYPE_C_1_PD_CBL_VDM_NO_RESP_CNT();

                            if(GET_TYPE_C_1_PD_CBL_VDM_NO_RESP_CNT() >= _MAX_VDM_NO_RESP_CNT)
                            {
                    ...
                    switch(GET_TYPE_C_1_PD_DP_ALT_STATE())
                    {
                        ...
                        case _PD_ALT_MODE_INT_WAIT_DISCOVER_SVID_RESP_SOP_P:
                            ...
                            if(GET_TYPE_C_1_PD_CBL_VDM_NO_RESP_CNT() >= _MAX_VDM_NO_RESP_CNT)
                            {
                                ...
                                SET_TYPE_C_1_PD_DP_ALT_STATE(ScalerTypeC1PdJudgeCableDpFunctionality_WDINT());
                            }
                            else
                            {
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdActiveTimerEvent_WDINT(WORD usTime, EnumScalerTimerEventID enumEventID)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdSendMsg_WDINT(EnumTypeCPDPacketType enumPacketType, EnumTypeCPDCmd enumPdCmd, EnumTypeCVdmCmd enumVdmCmd)
{
    // 1. Clear Flags
    ...
    // 2. Construct Msg.
    ScalerTypeC1PdConstructMsg_WDINT(enumPacketType, enumPdCmd, enumVdmCmd);

    // Start Disable Rcv Msg.
    ScalerTypeC1PdRxIntControl_WDINT(_DISABLE);
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdConstructMsg_WDINT(EnumTypeCPDPacketType enumPacketType, EnumTypeCPDCmd enumPdCmd, EnumTypeCVdmCmd enumVdmCmd)
{
    ...
    switch(enumPdCmd)
    {
        ...
        case _PD_CMD_SRC_CAP:
            ...
            ucExtendedBit_WDINT = 0;
            ucDataObjectCnt_WDINT = GET_TYPE_C_1_PD_SPR_SRC_PDO_CNT();
        ...
        case _PD_CMD_EPR_SRC_CAP:
            ...
            if((GET_TYPE_C_1_PD_EPR_SRC_PDO_CNT() == 0) && (GET_TYPE_C_1_PD_SPR_SRC_PDO_CNT() < 7))
            {
                ...
                ucDataObjectCnt_WDINT = GET_TYPE_C_1_PD_SPR_SRC_PDO_CNT() + 1;
            ...
            else
            {
                ...
                else
                {
                    ...
                    ucDataObjectCnt_WDINT = GET_TYPE_C_1_PD_EPR_SRC_PDO_CNT() + 1;
                }
            }
    ...
    {
        ScalerTypeC1PdConstructDataObj_WDINT(enumPacketType, enumPdCmd, enumVdmCmd);
    }
    ...
    {
        ucMsgHeader_WDINT = ucMsgHeader_WDINT | (GET_TYPE_C_1_PD_POWER_ROLE() << 3);
        ucMsgHeader_WDINT = ucMsgHeader_WDINT | (GET_TYPE_C_1_PD_SPEC_VER() << 1);
        ucMsgHeader_WDINT = ucMsgHeader_WDINT | GET_TYPE_C_1_PD_DATA_ROLE();
    }
    else if((enumPacketType == _PD_SOP_P_PKT) || (enumPacketType == _PD_SOP_PP_PKT))
    {
        ucMsgHeader_WDINT = ucMsgHeader_WDINT | (BYTE)(_PD_DEVICE << 3);
        ucMsgHeader_WDINT = ucMsgHeader_WDINT | (GET_TYPE_C_1_PD_CBL_SPEC_VER() << 1);
    }
    ...
    if(ScalerGetBit_EXINT(P6B_DA_TX_TRANSMIT_CTRL, _BIT7) == 0x00)
    {   // Do Not Write Tx FIFO When Tx is Transmitting During INT
        ...
        // [0x6BE5] Fill in Msg. Header 0
        ScalerSetByte_EXINT(P6B_E5_TX_FIFO_MSG_HEADER0, ucMsgHeader_WDINT);
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdConstructDataObj_WDINT(EnumTypeCPDPacketType enumPacketType, EnumTypeCPDCmd enumPdCmd, EnumTypeCVdmCmd enumVdmCmd)
{
    enumPdCmd = enumPdCmd;
    ...
    switch(enumPdCmd)
    {
        ...
        case _PD_CMD_VDM:
            ...
            ScalerTypeC1PdConstructVdmDataObj_WDINT(enumPacketType, enumVdmCmd);
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdConstructVdmDataObj_WDINT(EnumTypeCPDPacketType enumPacketType, EnumTypeCVdmCmd enumVdmCmd)
{
    switch(enumVdmCmd)
    {
        case _PD_VDM_CMD_DISCOVER_ID_REQ:
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdSendSoftRst_WDINT(EnumTypeCPDPacketType enumPacketType)
{
    ...
    // 2. Construct Msg.
    ScalerTypeC1PdConstructSoftReset_WDINT(enumPacketType);
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdConstructSoftReset_WDINT(EnumTypeCPDPacketType enumPacketType)
{
    // Disable Rcv Msg. INT
    ScalerTypeC1PdRxIntControl_WDINT(_DISABLE);
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdSendHardRst_WDINT(BYTE *pucActiveWDID, BYTE *pucActiveWDTime)
{
    if(GET_TYPE_C_1_PD_HARD_RST_CNT() <= _MAX_HARD_RST_CNT)
    {
        ...
        ScalerTypeC1PdProcHardRst_WDINT(pucActiveWDID, pucActiveWDTime);
    }
    else
    {
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdProcHardRst_WDINT(BYTE *pucActiveWDID, BYTE *pucActiveWDTime)
{
    ...
    if(GET_TYPE_C_1_PD_POWER_ROLE() == _PD_POWER_SRC)
    {
        ...
        ScalerTypeC1PmicSic437aHardRstStartProc_WDINT(_TYPE_C_POWER_SRC);
...
#endif
#else
        *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_SRC_TURN_OFF_POWER;
    ...
    else
    {
        ...
        ScalerTypeCAdcOnOffCompIntControl_WDINT(_TYPE_C_CHANNEL_1_VMON, _OFF, _DISABLE);
#else
        // 2. Turn Off Type-C Unattach Vbus Detection
        ScalerTypeC1CcVbusDetCtrl_WDINT(_DISABLE);

#if(_TYPE_C_EIZO_CUSTOMIZED_PMIC_SIC437A_SUPPORT == _ON)
        // [Eizo] SIC437A Customized Power Control : Send/Receive Hard Reset
        ScalerTypeC1PmicSic437aHardRstStartProc_WDINT(_TYPE_C_POWER_SNK);
#endif
#endif

        ScalerTypeC1PdActiveTimerEvent_WDINT(_SNK_HARD_RST_TIMER, _SCALER_TIMER_EVENT_PD_1_SNK_HARD_RST_TIMEOUT);
    }

    // Turn Off Vconn, If Already Turned On
    if(GET_TYPE_C_1_PD_VCONN_ROLE() == _PD_VCONN_SRC)
    {
        ScalerTypeC1CcVconnControl_WDINT(_OFF);
    }
...
//--------------------------------------------------
EnumTypeCTxCheckResult ScalerTypeC1PdTxAvaliable_WDINT(BYTE *pucActiveWDID, BYTE *pucActiveWDTime)
{
    ...
    if(GET_TYPE_C_1_PD_SPEC_VER() == _PD_VERSION_3_0)
    {
        if(GET_TYPE_C_1_PD_POWER_ROLE() == _PD_POWER_SRC)
        {
            ...
            ScalerSetBit_WDINT(P6C_37_CC_HW_Z_CFG, ~(_BIT7 | _BIT6), _PD_SINK_TX_NG);

            *pucActiveWDID = _SCALER_WD_TIMER_EVENT_PD_1_TX_AVALIABLE;
            *pucActiveWDTime = _SRC_INIT_AMS_TIMER;
            ...
            if(GET_TYPE_C_1_PD_EPR_MODE() == _TRUE)
            {
                ...
                SET_TYPE_C_1_PD_CANCEL_SRC_EPR_KEEP_ALIVE();
        ...
        {
            if(ScalerTypeC1CcDetResistor_WDINT() == _TYPE_C_DET_RP_3P0A)
            {   // Rp = SinkTxOK (Rp 3.0A)
    ...
    {   // Check PHY Idle
        if(ScalerGetBit_WDINT(P6B_05_PD_PHY_IDLE_INT, _BIT2) == _BIT2)
        {   // PHY Idle Flag = 1
            enumTxCheckResult = _PD_TX_AVAILABLE;
        }
        else
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdRxIntControl_WDINT(bit b1Action)
{
    if(b1Action == _ENABLE)
    {
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdUpdateCableRetryCounter_WDINT(void)
{
    ...
    {
        ScalerSetBit_WDINT(P6B_EC_TX_PD_RTY_CNT, ~(_BIT5 | _BIT4 | _BIT3), _BIT4);
    }
    else
    {
        ScalerSetBit_WDINT(P6B_EC_TX_PD_RTY_CNT, ~(_BIT5 | _BIT4 | _BIT3), (_BIT4 | _BIT3));
    }
}
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdUpdateTxFifoMsgHeader_WDINT(void)
{
    // [3] Power Role / [2:1] Spec Version / [0] Data Role
    ScalerSetBit_WDINT(P6B_E5_TX_FIFO_MSG_HEADER0, ~_BIT3, GET_TYPE_C_1_PD_POWER_ROLE() << 3);
    ScalerSetBit_WDINT(P6B_E5_TX_FIFO_MSG_HEADER0, ~(_BIT2 | _BIT1), GET_TYPE_C_1_PD_SPEC_VER() << 1);
    ScalerSetBit_WDINT(P6B_E5_TX_FIFO_MSG_HEADER0, ~_BIT0, GET_TYPE_C_1_PD_DATA_ROLE());
}
...
//--------------------------------------------------
EnumTypeCPDAltModeState ScalerTypeC1PdJudgeCableDpFunctionality_WDINT(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdDpCTSForceHpdIrq_WDINT(BYTE *pucActiveWDID, BYTE *pucActiveWDTime)
{
       ...
       (GET_TYPE_C_1_PD_AMS_STATUS() == _PD_AMS_NONE) && (GET_TYPE_C_1_PD_SYS_EVENT() == _PD_SYS_EVENT_NONE) && (GET_TYPE_C_1_PD_ATTENTION_WAIT() == _FALSE))
    {
        if(GET_TYPE_C_1_PD_DATA_ROLE() == _PD_DATA_UFP)
        {
            enumTxCheckResult = ScalerTypeC1PdTxAvaliable_WDINT(pucActiveWDID, pucActiveWDTime);
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdBackToReadyState_WDINT(void)
{
    // Back to Ready State
    if(GET_TYPE_C_1_PD_POWER_ROLE() == _PD_POWER_SRC)
    {
        ...
        if(GET_TYPE_C_1_PD_SPEC_VER() == _PD_VERSION_3_0)
        {
            ScalerSetBit_WDINT(P6C_37_CC_HW_Z_CFG, ~(_BIT7 | _BIT6), _PD_SINK_TX_OK);
        }

        // Active SourceEPRKeepAliveTimer (750~1000ms) When Back to Ready State in EPR Mode, Timeout : Hard Reset
        if(GET_TYPE_C_1_PD_EPR_MODE() == _TRUE)
        {
            ScalerTypeC1PdActiveTimerEvent_WDINT(_SRC_EPR_KEEP_ALIVE_TIMER, _SCALER_TIMER_EVENT_PD_1_SRC_EPR_KEEP_ALIVE_TIMEOUT);
...
//--------------------------------------------------
EnumTypeCPinCfgType ScalerTypeC1PdGetPinAssignment_WDINT(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdSetSystemEvent_WDINT(EnumTypeCPDSysEvent enumPdSysEvent)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTypeC1PdPushHpd_WDINT(EnumTypeCPDHpdType enumHpdType, WORD usHpdSpaceTime)
{
    BYTE ucIndex = 0;
