...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerDpHdcp2Rx0_WDINT.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// Output Value : None
//--------------------------------------------------
void ScalerDpHdcp2Rx0SkeProc_WDINT(void)
{
    BYTE pucTemp1[16];
    BYTE pucTemp2[16];
    EnumInputPort enumInputPort = ScalerDpHdcpRxRxDxMapping_WDINT(_RX0);
    ...
    // Calculate Dkey 2
    ScalerHdcp2Proc2_WDINT(pucTemp1, g_pucDpHdcp2Rx0Km);

    ScalerDpHdcp2RxDkeyCalculate_WDINT(_HDCP_2_2_DKEY_2, g_pucDpHdcp2Rx0Rtx, g_pucDpHdcp2Rx0Rrx, pucTemp1, g_pucDpHdcp2Rx0Rn);

    // Save Edkey_ks to g_pucHdcp2EDkeyKs
    ScalerDpHdcp2Rx0LoadDpcdValue_WDINT(0x06, 0x93, 0x18, 16, g_pucHdcp2EDkeyKs);

    // Save Riv to g_pucHdcp2Riv
    ScalerDpHdcp2Rx0LoadDpcdValue_WDINT(0x06, 0x93, 0x28, 8, g_pucHdcp2Riv);
    ...
    {
        pucTemp2[ucLoopIndex] = g_pucHdcp2EDkeyKs[ucLoopIndex] ^ (ScalerGetByte_EXINT((P63_81_HDCP_AES_OUT_15 + ucLoopIndex)) ^ g_pucDpHdcp2Rx0Rrx[ucLoopIndex - 8]);
    }
    ...
    if(ScalerDpAuxRxGetDpcdBitInfo_WDINT(enumInputPort, 0x06, 0x92, 0x1F, (_BIT1 | _BIT0)) == _BIT1)
    {
        ...
        SET_DP_HDCP2_RX0_AUTHENTICATION_DONE();
    }

    SET_DP_HDCP2_RX0_SKE_SEND_EKS_RECEIVED();
}
...
// Output Value : None
//--------------------------------------------------
void ScalerDpHdcp2Rx0HPrimeProc_WDINT(void)
{
    BYTE pucTemp1[16];
    BYTE pucTemp2[16];
    BYTE pucTemp3[16];
    ...
    ScalerDpHdcp2Rx0LoadDpcdValue_WDINT(0x06, 0x92, 0xB0, 16, g_pucHdcp2M);
    ...
    ScalerDpHdcp2Rx0LoadDpcdValue_WDINT(0x06, 0x92, 0xA0, 16, pucTemp1);
    ...
    // Calculate DKey0
    ScalerHdcp2DkeyCalculate_WDINT(_HDCP_2_2_DKEY_0, g_pucDpHdcp2Rx0Rtx, g_pucDpHdcp2Rx0Rrx, pucTemp1, g_pucDpHdcp2Rx0Rn);
    ...
    // Calculate Dkey1
    ScalerHdcp2DkeyCalculate_WDINT(_HDCP_2_2_DKEY_1, g_pucDpHdcp2Rx0Rtx, g_pucDpHdcp2Rx0Rrx, pucTemp1, g_pucDpHdcp2Rx0Rn);
    ...
    // Calculate H'
    if(ScalerHdcp2HPrimeCalculate_WDINT(pucTemp2, pucTemp3, g_pucDpHdcp2Rx0Rtx, g_pucDpHdcp2Rx0TxCaps, g_pucDpHdcp2Rx0Caps) == _TRUE)
    {
        ...
        ScalerDpHdcp2Rx0SetDpcdReadValue_WDINT(_HDCP22_RX_H_PRIME, g_pucHdcp2Sha256, 32);
    }

    ScalerDpAuxRxCpIRQ_EXINT0(_DP_HDCP2_H_PRIME_AVAILABLE, enumInputPort);

    ScalerHdcp2Proc2_WDINT(g_pucDpHdcp2Rx0Km, pucTemp1);
    ScalerHdcp2Proc2_WDINT(g_pucDpHdcp2Rx0dKey0, pucTemp2);
    ScalerHdcp2Proc2_WDINT(g_pucDpHdcp2Rx0dKey1, pucTemp3);

    SET_DP_HDCP2_RX0_AKE_STORED_KM_RECEIVED();
...
// Output Value : None
//--------------------------------------------------
void ScalerDpHdcp2Rx0LoadDpcdValue_WDINT(BYTE ucDpcdAccessPortH, BYTE ucDpcdAccessPortM, BYTE ucDpcdAccessPortL, BYTE ucLength, BYTE *pucReadArray)
{
    BYTE ucIndex = 0x00;
...
// Output Value : None
//--------------------------------------------------
void ScalerDpHdcp2Rx0MPrimeProc_WDINT(void)
{
    EnumInputPort enumInputPort = ScalerDpHdcpRxRxDxMapping_WDINT(_RX0);
    ...
    // Get M Prime
    if(ScalerDpHdcp2Rx0MPrimeCalculate_WDINT(enumInputPort) == _TRUE)
    {
        for(BYTE ucLoopIndex = 0; ucLoopIndex < 32; ucLoopIndex++)
        {
        ...
        ScalerDpHdcp2Rx0SetDpcdReadValue_WDINT(_HDCP22_RX_M_PRIME, g_pucHdcp2Sha256, 32);
        ...
        SET_DP_HDCP2_RX0_STREAM_MANAGE_RECEIVED();
    }
...
// Output Value : None
//--------------------------------------------------
BYTE ScalerDpHdcp2Rx0MPrimeCalculate_WDINT(EnumInputPort enumInputPort)
{
    BYTE ucIndex = 0x00;
    ...
    // Get kd
    ScalerHdcp2Proc2_WDINT(pucTemp1, g_pucDpHdcp2Rx0dKey0);
    ScalerHdcp2Proc2_WDINT(pucTemp2, g_pucDpHdcp2Rx0dKey1);
...
#endif // End of #if(_DP_HDCP2_RX0_REPEATER_SUPPORT == _ON)
...
// Output Value : None
//--------------------------------------------------
void ScalerDpHdcp2Rx0SetDpcdReadValue_WDINT(BYTE ucRSAType, BYTE *pucReadArray, WORD usLength)
{
    BYTE ucIndex = 0x00;
    WORD usDpcdAddress = 0;
    EnumInputPort enumInputPort = ScalerDpHdcpRxRxDxMapping_WDINT(_RX0);
