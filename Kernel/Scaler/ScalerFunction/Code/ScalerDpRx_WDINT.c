...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerDpRx_WDINT.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// Output Value : None
//--------------------------------------------------
EnumInputPort ScalerDpRxMacGetInputPortSwitch_WDINT(EnumDpMacSel enumDpMacSel)
{
    switch(enumDpMacSel)
    {
        default:
        ...
        case _DP_MAC_0:
            return ScalerDpRxGetInputPortMappingSourceType_WDINT(g_penumDpRxMacEntityGroup[enumDpMacSel]);
#endif
...
//--------------------------------------------------
EnumInputPort ScalerDpRxGetInputPortMappingSourceType_WDINT(EnumDpMacStreamSourceType enumDpMacStreamSourceType)
{
...
// Output Value : None
//--------------------------------------------------
EnumDpMacSel ScalerDpRxGetMacSwitch_WDINT(EnumInputPort enumInputPort)
{
    ...
    for(enumMacIndex = 0; enumMacIndex < _DP_MAC_ENTITY_MAX; enumMacIndex++)
    {
        ...
        {
            if(g_penumDpRxMacEntityGroup[enumMacIndex] == ScalerDpRxDxMacSourceMapping_WDINT(_DUAL_DP_MAIN_PORT))
            {
                enumDpMacSelMain = enumMacIndex;
            }

            if(g_penumDpRxMacEntityGroup[enumMacIndex] == ScalerDpRxDxMacSourceMapping_WDINT(_DUAL_DP_SUB_PORT))
            {
...
#endif
        {
            if(g_penumDpRxMacEntityGroup[enumMacIndex] == ScalerDpRxDxMacSourceMapping_WDINT(enumInputPort))
            {
...
//--------------------------------------------------
EnumDpMacStreamSourceType ScalerDpRxDxMacSourceMapping_WDINT(EnumInputPort enumInputPort)
{
