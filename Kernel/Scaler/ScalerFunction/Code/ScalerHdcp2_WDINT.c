...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerHdcp2_WDINT.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
BYTE ScalerHdcp2RsaAvailable_WDINT(void)
{
...
// Output Value : None
//--------------------------------------------------
BYTE ScalerHdcp2RxHmacSha256Calculate_WDINT(BYTE *pucInputArray1, BYTE *pucInputArray2)
{
    ...
    if(ScalerHdcp2RxSha256Calculate_WDINT(pucInputArray2, 0) == _TRUE)
    {
        if(ScalerHdcp2RxSha256Calculate_WDINT(pucInputArray1, 1) == _TRUE)
        {
            // KO XOR opad
            for(BYTE ucLoopIndex = 0; ucLoopIndex < 64; ucLoopIndex++)
            {
...
// Output Value : None
//--------------------------------------------------
BYTE ScalerHdcp2RxSha256Calculate_WDINT(BYTE *pucInputArray, BYTE ucCalCount)
{
    ...
    if(ScalerTimerPollingFlagProc_WDINT(10, P63_30_HDCP_SHA_CONTRL, _BIT4, _TRUE) == _TRUE)
    {
...
// Output Value : None
//--------------------------------------------------
BYTE ScalerHdcp2RxRsaOaepCalculate_WDINT(BYTE *pucKmArray)
{
    ...
    if(ScalerHdcp2RxSha256Calculate_WDINT(&pucHdcp2RsaOaepInput[33], 0) == _TRUE)
    {
        ...
        if(ScalerHdcp2RxSha256Calculate_WDINT(g_pucHdcp2SHA256Input, 1) == _TRUE)
        {
            ...
            if(ScalerHdcp2RxSha256Calculate_WDINT(g_pucHdcp2SHA256Input, 0) == _FALSE)
            {
                return _FALSE;
            }
...
// Output Value : None
//--------------------------------------------------
void ScalerHdcp2RxRsaCal_WDINT(BYTE *pucEkpubKmArray)
{
    BYTE ucLoop = 0;
    BYTE pucTemp[128] = {0};
...
// Output Value : None
//--------------------------------------------------
BYTE ScalerHdcp2HPrimeCalculate_WDINT(BYTE *pucHdcp2dKey0, BYTE *pucHdcp2dKey1, BYTE *pucHdcp2Rtx, BYTE *pucHdcp2TxCaps, BYTE *pucHdcp2RxCaps)
{
