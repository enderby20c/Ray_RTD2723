...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerTmdsMacRx3.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __SCALER_TMDSMACRX3__
...
//****************************************************************************
volatile StructTMDSCtrlInfo g_stTmdsMacRx3CtrlInfo;

#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
volatile StructHdmiSpdInfo g_stTmdsMacRx3SpdInfo;
#if((_HDMI_FREESYNC_SUPPORT == _ON) || (_HDMI_FREESYNC_REPLAY_SUPPORT == _ON))
volatile StructHdmiSpdFsInfo g_stTmdsMacRx3SpdFsInfo;
#endif
#endif

volatile WORD g_usTmdsMacRx3ClkCount;
WORD g_usTmdsMacRx3OffLineMeasureClk;

BYTE g_ucTmdsMacRx3DdcramNackStatus;

bit g_bTmdsMacRx3HpdEventHappened;

#if(_HDMI_MAC_RX3_SUPPORT == _ON)
BYTE g_ucTmdsMacRx3AviInfo;
...
volatile StructHdmi21EmpInfo g_stTmdsMacRx3Hdmi21EmpInfo;
#if(_HDMI21_VRR_SUPPORT == _ON)
StructHdmi21EdidVrrCap g_stTmdsMacRx3Hdmi21EdidVrrCap;
#endif
#endif

#if(_HDMI_SBTM_SUPPORT == _ON)
StructHdmiSbtmInfo g_stTmdsMacRx3HdmiSbtmInfo;
#endif
#endif

EnumDDomainRegion g_enumTmdsMacRx3IrqForceBackgrd;

BYTE g_ucTmdsMacRx3Z0Status;
BYTE g_ucTmdsMacRx3SlaveAddr;
BYTE g_ucTmdsMacRx3HdcpType;

#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
BYTE g_pucTmdsMacRx3Caps[3];
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3GetFreeSyncIIData(BYTE *pucFreeSyncIIData)
{
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
    if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) == _BIT6)
    {
        ScalerHdmiFrlMacRx3GetFreeSyncIIData(pucFreeSyncIIData);
    }
    else
#endif
    {
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3GetSBTMData(BYTE *pucSBTMData)
{
    memcpy(&pucSBTMData[0], &g_stTmdsMacRx3HdmiSbtmInfo, 8);
}
#endif // End of #if(_HDMI_FREESYNC_II_SUPPORT == _ON)
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3GetHDR10Data(BYTE *pucHDRData)
{
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
    if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) == _BIT6)
    {
        ScalerHdmiFrlMacRx3GetHDR10Data(pucHDRData);
    }
    else
#endif
    {
        ...
        {
            ucAddressportBackup = ScalerGetByte(P72_D0_HDMI_PSAP2);
            bBackupStatus = _TRUE;
        }

        ScalerGetDataPortByte(P72_D0_HDMI_PSAP2, _HDR10_INFO_HDMI_VERSION, 2, &pucHDRData[0], _AUTOINC);
        ScalerGetDataPortByte(P72_D0_HDMI_PSAP2, _HDR10_INFO_HDMI_EOTF, 2, &pucHDRData[2], _AUTOINC);
        ScalerGetDataPortByte(P72_D0_HDMI_PSAP2, _HDR10_INFO_HDMI_DISPLAY_PRIMARIES_X0_LSB, 24, &pucHDRData[4], _AUTOINC);

        if(bBackupStatus == _TRUE)
        {
            ScalerSetByte(P72_D0_HDMI_PSAP2, ucAddressportBackup);
        }
    }
}
...
//--------------------------------------------------
DWORD ScalerTmdsMacRx3FreeSyncHDMIGetAmdSpdInfo(EnumAmdSpdInfoContent enumContent)
{
    ...
    {
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
        if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) == _BIT6) // HDMI 21 Rx
        {
            return ScalerHdmiFrlMacRx3FreeSyncHDMIGetAmdSpdInfo(enumContent);
        }
        else
#endif
        {
            ...
            if((g_stTmdsMacRx3SpdFsInfo.pucHdmiFreesyncInfo[1] == 0x1A) && (g_stTmdsMacRx3SpdFsInfo.pucHdmiFreesyncInfo[2] == 0x00) && (g_stTmdsMacRx3SpdFsInfo.pucHdmiFreesyncInfo[3] == 0x00))
            {
                switch(enumContent)
                {
                    ...
                    case _SPD_INFO_FRAME_TYPE:
                        ...
                        return (((ScalerGetBit(P72_D6_HDMI_SHDR_IE, (_BIT1 | _BIT0))) == ((ScalerGetBit(P72_D6_HDMI_SHDR_IE, (_BIT3 | _BIT2))) >> 2)) ? _ON : _OFF);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3CEDCheck(void)
{
    ...
    usCEDLane0ErrorCount = (ScalerGetBit(P72_0C_HDMI_CTRL_0C, (_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0)) << 8) + ScalerGetByte(P72_0D_HDMI_CTRL_0D);
    usCEDLane1ErrorCount = (ScalerGetBit(P72_0E_HDMI_CTRL_0E, (_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0)) << 8) + ScalerGetByte(P72_0F_HDMI_CTRL_0F);
    usCEDLane2ErrorCount = (ScalerGetBit(P72_10_HDMI_CTRL_10, (_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0)) << 8) + ScalerGetByte(P72_11_HDMI_CTRL_11);

    DebugMessageRx3("Lane0 error count", usCEDLane0ErrorCount);
    DebugMessageRx3("Lane1 error count", usCEDLane1ErrorCount);
    DebugMessageRx3("Lane2 error count", usCEDLane2ErrorCount);


    if(usCEDLane0ErrorCount != 0)
    {
        ScalerSetBit(P72_0B_HDMI_CTRL_0B, ~_BIT7, 0x00);
        ScalerSetBit(P72_0B_HDMI_CTRL_0B, ~_BIT7, _BIT7);
    }

    if(usCEDLane1ErrorCount != 0)
    {
        ScalerSetBit(P72_0B_HDMI_CTRL_0B, ~_BIT6, 0x00);
        ScalerSetBit(P72_0B_HDMI_CTRL_0B, ~_BIT6, _BIT6);
    }

    if(usCEDLane2ErrorCount != 0)
    {
        ScalerSetBit(P72_0B_HDMI_CTRL_0B, ~_BIT5, 0x00);
        ScalerSetBit(P72_0B_HDMI_CTRL_0B, ~_BIT5, _BIT5);
    }
}
#endif
#endif
...
//--------------------------------------------------
// Description  : TMDS reset RX3 Timer Event
// Input Value  :
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3TimerEventReset(void)
{
    ...
    ScalerTmdsMacRx3HdmiWatchDog((_HDMI_AVI_INFO_VARIATION_WD | _HDMI_AV_MUTE_WD), _DISABLE);

#if(_TMDS_NO_CLK_TRIGGER_AV_WATCHDOG == _ON)
    ScalerTmdsMacRx3HdmiWatchDog(_TMDS_NO_CLK_WD, _DISABLE);
#endif

#if(_HDMI_UNSTABLE_BED_CHECK_SUPPORT == _ON)
    ScalerTimerWDCancelTimerEvent(_SCALER_WD_TIMER_EVENT_RX3_HDMI_UNSTABLE_BED_CHECK);
    CLR_TMDS_MAC_RX3_BED_ERROR();
#endif

#if(_HDMI_ADVANCED_HDR10_SUPPORT_MODE != _ADVANCED_HDR10_NONE)
    ScalerTimerCancelTimerEvent(_SCALER_TIMER_EVENT_RX3_HDMI_ADVANCED_HDR10_DETECT);
#endif
    ...
    ScalerTimerCancelTimerEvent(_SCALER_TIMER_EVENT_RX3_TMDS_EMP_DETECT);
#endif
...
//--------------------------------------------------
// Description  : TMDS RX3 Check D domain mute before
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3ForceMDomainMuteBeforeHpdToggle(void)
{
    if(((ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) == 0x00) && (ScalerGetBit(P72_A6_TMDS_OUTCTL, (_BIT6 | _BIT5 | _BIT4)) == (_BIT6 | _BIT5 | _BIT4))) ||
       ((ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) == _BIT6) && (ScalerGetBit(P68_A0_DPF_OUTPUT_0, (_BIT5 | _BIT4 | _BIT3)) == (_BIT5 | _BIT4 | _BIT3))))
    {
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3DviVideoSetting(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);

    // Manual Set Color Space and disable pixel repetition
    ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_51_PORT_PAGE72_HDMI_ACRCR, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);

    // Disable Down Sampling
    ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_50_PORT_PAGE72_HDMI_VCR, ~(_BIT6 | _BIT5 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
    ...
    ScalerTmdsMacRx3SetPorchColor(GET_COLOR_SPACE(enumMappingPort));
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3SetPorchColor(EnumColorSpace enumColorFormat)
{
...
// Output Value : bit
//--------------------------------------------------
bit ScalerTmdsMacRx3GetInterlace3ddiAvailable(void)
{
    DWORD ulTMDSClkValue = 0x00;
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);

    if(g_usTmdsMacRx3ClkCount == 0)
    {
        return _FALSE;
    }
    ...
    {
        ulTMDSClkValue = (DWORD)_GDIPHY_RX_GDI_CLK_KHZ * 1024 * 2 / g_usTmdsMacRx3ClkCount;
    }
    else
    {
        ulTMDSClkValue = (DWORD)_GDIPHY_RX_GDI_CLK_KHZ * 1024 / g_usTmdsMacRx3ClkCount;
    }
    ...
    if((ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_50_PORT_PAGE72_HDMI_VCR, _BIT6) == _BIT6) && (ulTMDSClkValue < _3DDI_PCLK_LIMIT))
    {
        return _TRUE;
    }
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiVideoSetting(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);

    if(GET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED() == _TRUE)
    {
        // Color Space Auto/ Pixel Repetition auto mode
        ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_51_PORT_PAGE72_HDMI_ACRCR, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT6 | _BIT2));

        pData[0] = ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_COLOR_SPACE);
        ...
        switch(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_PIXEL_REPETITION))
        {
            case _AVI_PIXEL_REPETITION_0:

                DebugMessageRx3("Get Pixel Repetition 0", 0x00);
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_0);
            ...
            case _AVI_PIXEL_REPETITION_1:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_1);
            ...
            case _AVI_PIXEL_REPETITION_2:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_2);
            ...
            case _AVI_PIXEL_REPETITION_3:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_3);
            ...
            case _AVI_PIXEL_REPETITION_4:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_4);
            ...
            case _AVI_PIXEL_REPETITION_5:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_5);
            ...
            case _AVI_PIXEL_REPETITION_6:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_6);
            ...
            case _AVI_PIXEL_REPETITION_7:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_7);
            ...
            case _AVI_PIXEL_REPETITION_8:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_8);
            ...
            case _AVI_PIXEL_REPETITION_9:
                ...
                SET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION(_AVI_PIXEL_REPETITION_9);
        ...
        // Set Colorimetry
        ScalerTmdsMacRx3HdmiColorimetrySetting();

        // Set Quantization
#if((_RGB_QUANTIZATION_RANGE_FUNCTION == _ON) || (_YCC_QUANTIZATION_RANGE_FUNCTION == _ON))
        ScalerTmdsMacRx3HdmiQuantizationSetting();
#endif
    }
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiColorimetrySetting(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    {
        switch(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_COLORIMETRY))
        {
            ...
            case _AVI_COLORIMETRY_11:
                ...
                ScalerTmdsMacRx3HdmiColorimetryExtSetting();
    ...
    {
        SET_RX3_COLORIMETRY_PREVALUE(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_COLORIMETRY));
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiColorimetryExtSetting(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    if((GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR420) || (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR422) || (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR444))
    {
        ...
        SET_RX3_COLORIMETRY_EXT_PREVALUE(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_EXTENDED_COLORIMETRY));
        ...
        switch(GET_RX3_COLORIMETRY_EXT_PREVALUE())
        {
            ...
            case _AVI_COLORIMETRY_EXT_111:
                ...
                DebugMessageRx3("Get Colorimetry Additional Extended", 0x00);

                SET_EXT_COLORIMETRY(enumMappingPort, _COLORIMETRY_EXT_ADD);

                ScalerTmdsMacRx3HdmiColorimetryAddExtSetting();
...
//--------------------------------------------------
// Description  : TMDS Rx3 Colorimetry Additional Extended Setting
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiColorimetryAddExtSetting(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    if((GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR420) || (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR422) || (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR444))
    {
        ...
        SET_RX3_COLORIMETRY_ADD_EXT_PREVALUE(ScalerTmdsMacRx3HdmiRsv6GetAviInfo(_AVI_INFO_ADD_EXTENDED_COLORIMETRY));
        ...
        switch(GET_RX3_COLORIMETRY_ADD_EXT_PREVALUE())
        {
            case _AVI_COLORIMETRY_ADD_EXT_0010:
                ...
                DebugMessageRx3("Get Colorimetry ADD_EXT_YCC_ITUR_BT2100", 0x00);
    ...
    else if(GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_RGB)
    {
        ...
        switch(GET_RX3_COLORIMETRY_ADD_EXT_PREVALUE())
        {
            case _AVI_COLORIMETRY_ADD_EXT_0000:
                ...
                DebugMessageRx3("Get Colorimetry ADD_EXT_RGB_SMPTE_ST2113_P3D65", 0x00);
            ...
            case _AVI_COLORIMETRY_ADD_EXT_0001:
                ...
                DebugMessageRx3("Get Colorimetry ADD_EXT_RGB_SMPTE_ST2113_P3DCI", 0x00);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiQuantizationSetting(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);

    if((GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR420) || (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR422) || (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR444))
    {
        SET_RX3_QUANTIZATION_PREVALUE(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_YCC_QUANTIZATION));
    ...
    {
        switch(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_RGB_QUANTIZATION))
        {
...
//--------------------------------------------------
bit ScalerTmdsMacRx3HdmiColorInfoChanged(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    BYTE pucTemp[2] = {0};

    // Check Color Space
    if(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_COLOR_SPACE) != GET_COLOR_SPACE(enumMappingPort))
    {
        ...
        {
            if(ScalerTmdsMacRx3SeamlessReset() == _SOURCE_NONE)
            {
                return _TRUE;
            }
        }
    ...
    // Check Colorimetry
    if(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_COLORIMETRY) != GET_RX3_COLORIMETRY_PREVALUE())
    {
        DebugMessageRx3("Colorimetry Changed", 0x00);

        if(GET_DIGITAL_COLOR_INFO_CHANGE_RESET() == _FALSE)
        {
            pucTemp[0] = ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_COLORIMETRY);
    ...
    else
    {
        ...
        {
            if(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_EXTENDED_COLORIMETRY) != GET_RX3_COLORIMETRY_EXT_PREVALUE())
            {
                DebugMessageRx3("Ext Colorimetry Changed", 0x00);

                if(GET_DIGITAL_COLOR_INFO_CHANGE_RESET() == _FALSE)
                {
                    pucTemp[0] = ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_EXTENDED_COLORIMETRY);
    ...
    if((GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR420) || (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR422) || (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR444))
    {
        if(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_YCC_QUANTIZATION) != GET_RX3_QUANTIZATION_PREVALUE())
        {
            DebugMessageRx3("YCC Quantization Range Changed", 0x00);

            if(GET_DIGITAL_COLOR_INFO_CHANGE_RESET() == _FALSE)
            {
                pucTemp[0] = ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_YCC_QUANTIZATION);
    ...
    {
        if(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_RGB_QUANTIZATION) != GET_RX3_QUANTIZATION_PREVALUE())
        {
...
//--------------------------------------------------
bit ScalerTmdsMacRx3HdmiDeepColorProc(WORD usTmdsClkCnt)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);

    // Setting Deep Color PLL
    if(ScalerTmdsMacRx3HdmiSetDeepColorPll(usTmdsClkCnt, GET_COLOR_DEPTH(enumMappingPort)) == _FALSE)
    {
        return _FALSE;
    }

    // Wait for Phase lock
    if(ScalerTmdsMacRx3HdmiWaitDeepColorPllLock() == _FALSE)
    {
        return _FALSE;
    }
...
//--------------------------------------------------
bit ScalerTmdsMacRx3HdmiWaitDeepColorPllLock(void)
{
    BYTE ucTemp = 0;
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiPacketDetect(bit bWait)
{
#if(_DM_FUNCTION == _ON)
    ...
    if(bWait == _WAIT)
    {
        ...
        if(ScalerTimerPollingFlagProc(130, P72_D5_HDMI_RSV64_IE, (_BIT1 | _BIT0), _TRUE) == _TRUE)
        {
            // Both GCP & AVI infoframe packet have been received
            if(ScalerGetBit(P72_D5_HDMI_RSV64_IE, (_BIT1 | _BIT0)) == (_BIT1 | _BIT0))
            {
                SET_TMDS_MAC_RX3_HDMI_GCP_RECEIVED();

                SET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED();

                // Clear AVI Info Frame Variation flag
                ScalerSetByte(P72_CC_HDMI_GPVS, 0x01);
            }
            // Only AVI infoframe packet have been received
            else if(ScalerGetBit(P72_D5_HDMI_RSV64_IE, (_BIT1 | _BIT0)) == _BIT0)
            {
                SET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED();
                ...
                if(ScalerTimerPollingFlagProc(180, P72_D5_HDMI_RSV64_IE, _BIT1, _TRUE) == _TRUE)
                {
                    SET_TMDS_MAC_RX3_HDMI_GCP_RECEIVED();
                }
                else
                {
                    CLR_TMDS_MAC_RX3_HDMI_GCP_RECEIVED();
                }
            }
            // Only GCP Packet have been received
            else if(ScalerGetBit(P72_D5_HDMI_RSV64_IE, (_BIT1 | _BIT0)) == _BIT1)
            {
                SET_TMDS_MAC_RX3_HDMI_GCP_RECEIVED();

                // Polling more time to wait AVI IF when GCP has been received.
                if(ScalerTimerPollingFlagProc(180, P72_D5_HDMI_RSV64_IE, _BIT0, _TRUE) == _TRUE)
                {
                    SET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED();
                ...
                {
                    CLR_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED();
                }
            }
        }
        ...
        ScalerTmdsMacRx3RoundRobinDetect(_WAIT);
#endif

#if(_HDMI_HDR10_SUPPORT == _ON)
        // Polling 3 frame for detect Packet signals
        if(ScalerTimerPollingFlagProc(130, P72_D5_HDMI_RSV64_IE, (_BIT2), _TRUE) == _TRUE)
        {
        ...
        ucRSVColorDepth = ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x42, (_BIT3 | _BIT2 | _BIT1 | _BIT0));  // 0x42: RSV5 GCP SB1

        if(((GET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED() == _TRUE) && (ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_COLOR_SPACE) == _COLOR_SPACE_YCBCR422)) ||
           ((GET_TMDS_MAC_RX3_HDMI_GCP_RECEIVED() == _TRUE) && (ScalerGetBit(P72_B4_TMDS_DPC0, (_BIT3 | _BIT2 | _BIT1 | _BIT0)) != ucRSVColorDepth)))
        {
            ...
            if(GET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED() == _TRUE)
            {
                ...
                if(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_VIC) != 0x00)
                {
                    ucFrameRate = ScalerTmdsMacRxGetVicVfreqParameter(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_VIC));
                }
                else if(ScalerTmdsMacRx3HdmiRsv6GetAviInfo(_AVI_INFO_FR) != 0x00)
                {
                    ucFrameRate = ScalerTmdsMacRxGetOvtVfreqParameter(ScalerTmdsMacRx3HdmiRsv6GetAviInfo(_AVI_INFO_FR));
                }
                ...
                if(ucFrameRate != 0x00)
                {
                    ...
                    if(ScalerGetBit(P72_B4_TMDS_DPC0, (_BIT3 | _BIT2 | _BIT1 | _BIT0)) != ucRSVColorDepth)
                    {
                        // Wait 3 more frame for HW auto update color depth value
                        ScalerTimerDelayXms(3000 / (WORD)ucFrameRate);
                        DebugMessageRx3("More delay for GCP DPC HW update", ScalerGetBit(P72_B4_TMDS_DPC0, (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
                    }
                }
                else
                {
        ...
        CLR_TMDS_MAC_RX3_HDMI_PACKET_DETECTING();

#if(_HDMI_ADVANCED_HDR10_SUPPORT_MODE != _ADVANCED_HDR10_NONE)
        CLR_TMDS_MAC_RX3_ADVANCED_HDR10_DETECTING();
#endif

#if(_DM_FUNCTION == _ON)
        CLR_TMDS_MAC_RX3_DM_INFO_DETECTING();
        CLR_DRAM_RECEIVED_FROM_DM_DETECT(enumDx);
#endif
    }
    else
    {
        if(ScalerGetBit(P72_D5_HDMI_RSV64_IE, _BIT1) == _BIT1)
        {
            ScalerTmdsMacRx3HdmiWatchDog(_HDMI_AV_MUTE_WD, _ENABLE);

            SET_TMDS_MAC_RX3_HDMI_GCP_RECEIVED();

            // Clear Detection Flag
            ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
        }
        else
        {
            ScalerTmdsMacRx3HdmiWatchDog(_HDMI_AV_MUTE_WD, _DISABLE);

            CLR_TMDS_MAC_RX3_HDMI_GCP_RECEIVED();
        }

        if(ScalerGetBit(P72_D5_HDMI_RSV64_IE, _BIT0) == _BIT0)
        {
            // Color Space Auto/ Pixel Repetition auto mode
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_51_PORT_PAGE72_HDMI_ACRCR, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT6 | _BIT2));

            ScalerTmdsMacRx3HdmiWatchDog(_HDMI_AVI_INFO_VARIATION_WD, _ENABLE);

            SET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED();

            // Clear Detection Flag
            ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
        }
        else
        {
            ...
            ScalerTmdsMacRx3HdmiWatchDog(_HDMI_AVI_INFO_VARIATION_WD, _DISABLE);

            CLR_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED();
        }

#if((_HDMI_SPD_IF_RCV_BY_RR == _ON) || (_HDMI_VSIF_RCV_BY_RR == _ON))
        ScalerTmdsMacRx3RoundRobinDetect(_NOT_WAIT);
#endif

#if(_HDMI_HDR10_SUPPORT == _ON)
#if(_DM_FUNCTION == _ON)
        if((ScalerGetBit(P72_D5_HDMI_RSV64_IE, _BIT2) == _BIT2) || (GET_DRAM_RECEIVED_FROM_DM_DETECT(enumDx) == _TRUE))
#else
        if(ScalerGetBit(P72_D5_HDMI_RSV64_IE, _BIT2) == _BIT2)
#endif
        {
            SET_TMDS_MAC_RX3_HDMI_HDR10_INFO_FRAME_RECEIVED();
            ...
            else
            {
                ...
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT2);
            }
#else
            // w1c RSV received bit
            ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT2);
        ...
        SET_TMDS_MAC_RX3_HDMI_PACKET_DETECTING();
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiPacketDetectEvent(void)
{
    CLR_TMDS_MAC_RX3_HDMI_PACKET_DETECTING();
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3RoundRobinDetect(bit bWait)
{
    if(bWait == _WAIT)
    {
        ...
        //-----------------------------------------
        if((ScalerTimerPollingFlagProc(130, P72_CC_HDMI_GPVS, (_BIT6 | _BIT5), _TRUE) == _TRUE) || (ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_00_PORT_PAGE72_HDMI_SCR, (_BIT7 | _BIT6)) != 0x00))
        {
            // Check for RSV0
            if(ScalerGetBit(P72_CC_HDMI_GPVS, _BIT5) == _BIT5)
            {
                ScalerSetByte(P72_CC_HDMI_GPVS, _BIT5);

#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
                if(ScalerGetByte(P72_F8_HDMI_RECEIVE_TAG_RSV0) == _SPD_INFO_TYPE)
                {
                    ScalerTmdsMacRx3RsvSpdHandler(_HDMI_RSV_0);
                }
                else
#endif
                {
#if(_HDMI_VSIF_RCV_BY_RR == _ON)
                    ScalerTmdsMacRx3RsvVsifHandler(_HDMI_RSV_0);
#endif
                }
            }
            ...
            {
                ScalerSetByte(P72_CC_HDMI_GPVS, _BIT6);

#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
                if(ScalerGetByte(P72_F9_HDMI_RECEIVE_TAG_RSV1) == _SPD_INFO_TYPE)
                {
                    ScalerTmdsMacRx3RsvSpdHandler(_HDMI_RSV_1);
                }
                else
#endif
                {
#if(_HDMI_VSIF_RCV_BY_RR == _ON)
                    ScalerTmdsMacRx3RsvVsifHandler(_HDMI_RSV_1);
#endif
                }
            }
...
#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
                if(ScalerGetByte(P72_FA_HDMI_RECEIVE_TAG_RSV2) == _SPD_INFO_TYPE)
                {
                    ScalerTmdsMacRx3RsvSpdHandler(_HDMI_RSV_2);
                }
                else
#endif
                {
#if(_HDMI_VSIF_RCV_BY_RR == _ON)
                    ScalerTmdsMacRx3RsvVsifHandler(_HDMI_RSV_2);
#endif
                }
            }
...
#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
                if(ScalerGetByte(P72_FB_HDMI_RECEIVE_TAG_RSV3) == _SPD_INFO_TYPE)
                {
                    ScalerTmdsMacRx3RsvSpdHandler(_HDMI_RSV_3);
                }
                else
#endif
                {
#if(_HDMI_VSIF_RCV_BY_RR == _ON)
                    ScalerTmdsMacRx3RsvVsifHandler(_HDMI_RSV_3);
#endif
                }
            }
        }
        ...
        if(ScalerTimerPollingFlagProc(130, P72_D5_HDMI_RSV64_IE, _BIT3, _TRUE) == _TRUE)
        {
    ...
    else
    {
        ...
        //-----------------------------------------
#if(_HDMI_FREESYNC_REPLAY_SUPPORT == _ON)
        if(ScalerGetBit(P72_D5_HDMI_RSV64_IE, _BIT3) == _BIT3)
        {
            SET_TMDS_RX3_FREESYNC_REPLAY_RECEIVED();
        }
        else
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3RsvSpdHandler(EnumHdmiRsvNumber enumRsvNumber)
{
    BYTE ucI = 0;
    BYTE ucVnCount = 0;
    ...
    {
        case _HDMI_RSV_0:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x52);
            break;

        case _HDMI_RSV_1:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x71);
            break;

        case _HDMI_RSV_2:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x90);
            break;

        case _HDMI_RSV_3:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0xAF);
            break;
    ...
    {
        pucHdmiVenderName[ucVnCount] = ScalerGetByte(P72_CE_HDMI_PSDP);
    }
       ...
       ((pucHdmiVenderName[0] == 'N') && (pucHdmiVenderName[1] == 'V') && (pucHdmiVenderName[2] == 'I') && (pucHdmiVenderName[3] == 'D')))
    {
        ...
        {
            case _HDMI_RSV_0:
                ScalerSetByte(P72_CD_HDMI_PSAP, 0x5A);
                break;

            case _HDMI_RSV_1:
                ScalerSetByte(P72_CD_HDMI_PSAP, 0x79);
                break;

            case _HDMI_RSV_2:
                ScalerSetByte(P72_CD_HDMI_PSAP, 0x98);
                break;

            case _HDMI_RSV_3:
                ScalerSetByte(P72_CD_HDMI_PSAP, 0xB7);
                break;
        ...
        {
            g_stTmdsMacRx3SpdInfo.pucHdmiProductDescription[ucI] = ScalerGetByte(P72_CE_HDMI_PSDP);
        }
    }
#if((_HDMI_FREESYNC_SUPPORT == _ON) || (_HDMI_FREESYNC_II_SUPPORT == _ON))
    else if((pucHdmiVenderName[0] == 0x1A) && (pucHdmiVenderName[1] == 0x00) && (pucHdmiVenderName[2] == 0x00) && (GET_TMDS_MAC_RX3_FS_VALUABLE() == _FALSE))
    {
        ...
        {
            case _HDMI_RSV_0:
                ScalerSetByte(P72_CD_HDMI_PSAP, 0x51);
                break;

            case _HDMI_RSV_1:
                ScalerSetByte(P72_CD_HDMI_PSAP, 0x70);
                break;

            case _HDMI_RSV_2:
                ScalerSetByte(P72_CD_HDMI_PSAP, 0x8F);
                break;

            case _HDMI_RSV_3:
                ScalerSetByte(P72_CD_HDMI_PSAP, 0xBF);
                break;
        ...
        {
            g_stTmdsMacRx3SpdFsInfo.pucHdmiFreesyncInfo[ucI] = ScalerGetByte(P72_CE_HDMI_PSDP);
        }
    }
#endif
}
...
// Output Value : void
//--------------------------------------------------
void ScalerTmdsMacRx3RsvVsifHandler(EnumHdmiRsvNumber enumRsvNumber)
{
    ...
    switch(ulOui)
    {
        ...
        case _HDMI_VSIF_OUI:
            ...
            SET_TMDS_MAC_RX3_HDMI_VSIF_RECEIVED();

            ScalerTmdsMacRx3HdmiVsif3dVideoProc(enumRsvNumber);
        ...
        case _HF_VSIF_OUI:
            ...
            ScalerTmdsMacRx3AllmProc(enumRsvNumber);
#endif

#if(_HDMI21_CCBPC_SUPPORT == _ON)
            ScalerTmdsMacRx3CcbpcProc(enumRsvNumber);
#endif

#if(_HDMI_3D_VIDEO_IDENTIFY_SUPPORT == _ON)
            ScalerTmdsMacRx3HfVsif3dVideoProc(enumRsvNumber);
#endif
            break;
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiVsif3dVideoProc(EnumHdmiRsvNumber enumRsvNumber)
{
    bit b3dVideo = _FALSE;
    ...
    {
        case _HDMI_RSV_0:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x55);
            b3dVideo = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT(7, 5)) == _BIT6) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_1:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x74);
            b3dVideo = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT(7, 5)) == _BIT6) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_2:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x93);
            b3dVideo = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT(7, 5)) == _BIT6) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_3:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0xB2);
            b3dVideo = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT(7, 5)) == _BIT6) ? _TRUE : _FALSE);
            break;
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HfVsif3dVideoProc(EnumHdmiRsvNumber enumRsvNumber)
{
    bit b3dVideo = _FALSE;
    ...
    {
        case _HDMI_RSV_0:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x56);
            b3dVideo = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT0) == _BIT0) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_1:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x75);
            b3dVideo = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT0) == _BIT0) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_2:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x94);
            b3dVideo = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT0) == _BIT0) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_3:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0xB3);
            b3dVideo = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT0) == _BIT0) ? _TRUE : _FALSE);
            break;
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3AllmProc(EnumHdmiRsvNumber enumRsvNumber)
{
    bit bAllm = 0;
    ...
    switch(enumRsvNumber)
    {
        case _HDMI_RSV_0:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x56);
            bAllm = (((ScalerGetByte(P72_CE_HDMI_PSDP) & _BIT1) == _BIT1) ? _TRUE : _FALSE);
            break;
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3CcbpcProc(EnumHdmiRsvNumber enumRsvNumber)
{
    BYTE ucCcbpcValue = 0;
    ...
    switch(enumRsvNumber)
    {
        case _HDMI_RSV_0:
            ScalerSetByte(P72_CD_HDMI_PSAP, 0x56);
            ucCcbpcValue = (ScalerGetByte(P72_CE_HDMI_PSDP) & 0xF0) >> 4;
            break;
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiAdvancedHdr10DetectEvent(void)
{
    CLR_TMDS_MAC_RX3_ADVANCED_HDR10_DETECTING();
}
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiDmDetectEvent(void)
{
    CLR_TMDS_MAC_RX3_DM_INFO_DETECTING();
}
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3EmpDetectEvent(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3EmpPacketDetect(bit bWait)
{
#if(_HDMI_SBTM_SUPPORT == _ON)
    ...
    if(bWait == _WAIT)
    {
        ...
        if((ScalerTimerPollingFlagProc(90, P72_54_PAGE72_EMP_CTRL_0, _BIT6, _TRUE) == _TRUE) && ((ScalerGetByte(P72_5B_PAGE72_HDMI_EMP_6) != 0x00) || (ScalerGetByte(P72_5C_PAGE72_HDMI_EMP_7) != 0x00)))
        {
        ...
        while(ucHdmiSbtmCheckTime != 0)
        {
            ...
            {
                DebugMessageRx3("HDMI Rx3 SBTM Receive", 0x00);
        ...
        {
            DebugMessageRx3("HDMI Rx3 SBTM not Receive", 0x00);
    ...
    else
    {
        ...
        if((ScalerGetBit(P72_54_PAGE72_EMP_CTRL_0, _BIT6) == _BIT6) && ((ScalerGetByte(P72_5B_PAGE72_HDMI_EMP_6) != 0x00) || (ScalerGetByte(P72_5C_PAGE72_HDMI_EMP_7) != 0x00)))
        {
            ...
            // Clear VTEM flag
            ScalerSetBit(P72_54_PAGE72_EMP_CTRL_0, ~(_BIT6 | _BIT5 | _BIT4), _BIT6);

#if(_HDMI21_VRR_SUPPORT == _ON)
            if((((bit)ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_VRR_EN)) == _ENABLE) && (GET_TMDS_MAC_RX3_HDMI21_VRR_EN() != _ENABLE))
            {
                DebugMessageRx3("TMDS Rx3: VRR_EN from 0 -> 1", 0x00);
                SET_TMDS_MAC_RX3_HDMI21_VRR_RECEIVE_CHG();
                SET_TMDS_MAC_RX3_HDMI21_VRR_EN();
            }
            else if((((bit)ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_VRR_EN)) == _DISABLE) && (GET_TMDS_MAC_RX3_HDMI21_VRR_EN() != _DISABLE))
            {
                DebugMessageRx3("TMDS Rx3: VRR_EN from 1 -> 0", 0x00);
                SET_TMDS_MAC_RX3_HDMI21_VRR_RECEIVE_CHG();
                CLR_TMDS_MAC_RX3_HDMI21_VRR_EN();
            }

            if((((bit)ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_QMS_EN)) == _ENABLE) && (GET_TMDS_MAC_RX3_HDMI21_QMS_EN() != _ENABLE))
            {
                DebugMessageRx3("TMDS Rx3: QMS_EN from 0 -> 1", 0x00);
                SET_TMDS_MAC_RX3_HDMI21_QMS_RECEIVE_CHG();
                SET_TMDS_MAC_RX3_HDMI21_QMS_EN();
            }
            else if((((bit)ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_QMS_EN)) == _DISABLE) && (GET_TMDS_MAC_RX3_HDMI21_QMS_EN() != _DISABLE))
            {
                DebugMessageRx3("TMDS Rx3: QMS_EN from 1 -> 0", 0x00);
                SET_TMDS_MAC_RX3_HDMI21_QMS_RECEIVE_CHG();
                CLR_TMDS_MAC_RX3_HDMI21_QMS_EN();
            }
#endif
        ...
        else
        {
            ...
            if(GET_TMDS_MAC_RX3_HDMI21_VTEM_RECEIVED() == _TRUE)
            {
                ...
                {
                    DebugMessageRx3("VTEM->No Received(VRR_EN from 1->0)", 0x00);
                    SET_TMDS_MAC_RX3_HDMI21_VRR_RECEIVE_CHG();
                    CLR_TMDS_MAC_RX3_HDMI21_VRR_EN();
                }
                ...
                {
                    DebugMessageRx3("VTEM->No Received(QMS_EN from 1->0)", 0x00);
                    SET_TMDS_MAC_RX3_HDMI21_QMS_RECEIVE_CHG();
                    CLR_TMDS_MAC_RX3_HDMI21_QMS_EN();
                }
#endif
        ...
        ScalerTimerActiveTimerEvent(540, _SCALER_TIMER_EVENT_RX3_TMDS_EMP_DETECT);
    }
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3SetVrrVfmaxFromTable(WORD usSourceBrr)
{
    // Check VRRmax > 100?
    // if yes, VFmax = VRRmax
...
// Output Value : Content Value
//--------------------------------------------------
WORD ScalerTmdsMacRx3HdmiGetVtemInfo(EnumHdmi21VtemInfoContent enumContent)
{
    if(GET_TMDS_MAC_RX3_HDMI21_VTEM_RECEIVED() == _TRUE)
    {
        switch(enumContent)
        {
            case _HDMI21_VTEM_INFO_VRR_EN:
                ...
                return (((ScalerGetByte(P72_5D_PAGE72_HDMI_EMP_8) & _BIT0) == _BIT0) ? _ON : _OFF);

            case _HDMI21_VTEM_INFO_M_CONST:

                return (((ScalerGetByte(P72_5D_PAGE72_HDMI_EMP_8) & _BIT1) == _BIT1) ? _ON : _OFF);

            case _HDMI21_VTEM_INFO_FVA_FACTOR_M1:

                return ((ScalerGetByte(P72_5D_PAGE72_HDMI_EMP_8) & (_BIT7 | _BIT6 | _BIT5 | _BIT4)) >> 4);

            case _HDMI21_VTEM_INFO_BASE_VFRONT:

                return (ScalerGetByte(P72_5E_PAGE72_HDMI_EMP_9));


            case _HDMI21_VTEM_INFO_BASE_REFRESH_RATE:

                return (((WORD)(ScalerGetByte(P72_5F_PAGE72_HDMI_EMP_A) & 0x03) << 8) | (WORD)(ScalerGetByte(P72_60_PAGE72_HDMI_EMP_B)));

            case _HDMI21_VTEM_INFO_QMS_EN:

                return (((ScalerGetByte(P72_5D_PAGE72_HDMI_EMP_8) & _BIT2) == _BIT2) ? _ON : _OFF);

            case _HDMI21_VTEM_NEXT_TFR:

                return ((ScalerGetByte(P72_5F_PAGE72_HDMI_EMP_A) & (_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3)) >> 3);
...
// Output Value : Content Value
//--------------------------------------------------
BYTE ScalerTmdsMacRx3HdmiGetAVIInfo(EnumAviInfoContent enumContent)
{
    if(GET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED() == _TRUE)
    {
        switch(enumContent)
        {
            ...
            case _AVI_INFO_CONTENT_TYPE:
                ...
                return (ScalerGetDataPortBit(P72_CD_HDMI_PSAP, 0x08, (_BIT5 | _BIT4)) >> 4);
            ...
            case _AVI_INFO_VIC:
                ...
                return ScalerGetDataPortSingleByte(P72_CD_HDMI_PSAP, 0x07);
...
// Output Value : Content Value
//--------------------------------------------------
BYTE ScalerTmdsMacRx3HdmiRsv6GetAviInfo(EnumAviInfoContent enumContent)
{
    if(GET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED() == _TRUE)
    {
        switch(enumContent)
        {
            case _AVI_INFO_COLOR_SPACE:
                ...
                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x61, (_BIT6 | _BIT5)) >> 5);

            case _AVI_INFO_COLORIMETRY:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x62, (_BIT7 | _BIT6)) >> 6);

            case _AVI_INFO_EXTENDED_COLORIMETRY:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x63, (_BIT6 | _BIT5 | _BIT4)) >> 4);

            case _AVI_INFO_ADD_EXTENDED_COLORIMETRY:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x6E, (_BIT7 | _BIT6 | _BIT5 | _BIT4)) >> 4);

            case _AVI_INFO_RGB_QUANTIZATION:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x63, (_BIT3 | _BIT2)) >> 2);

            case _AVI_INFO_YCC_QUANTIZATION:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x65, (_BIT7 | _BIT6)) >> 6);

            case _AVI_INFO_SCAN_INFO:

                return ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x61, (_BIT1 | _BIT0));

            case _AVI_INFO_IT_CONTENT:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x63, _BIT7) >> 7);

            case _AVI_INFO_CONTENT_TYPE:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x65, (_BIT5 | _BIT4)) >> 4);

            case _AVI_INFO_PIXEL_REPETITION:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x65, (_BIT3 | _BIT2 | _BIT1 | _BIT0)));

            case _AVI_INFO_AR:

                return (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x62, (_BIT5 | _BIT4)) >> 4);

            case _AVI_INFO_VIC:

                return ScalerGetDataPortSingleByte(P72_D0_HDMI_PSAP2, 0x64);

            case _AVI_INFO_FR:

                return ((ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x6F, _BIT6) >> 2) | (ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x6E, (_BIT3 | _BIT2 | _BIT1 | _BIT0))));

            case _AVI_INFO_RID:

                return ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x6F, (_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
...
//--------------------------------------------------
bit ScalerTmdsMacRx3HdmiAviPixelRepInfoChanged(void)
{
    // Check Tmds Pixel Repetition
    if(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_PIXEL_REPETITION) != GET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION())
    {
        return _TRUE;
    }
...
//--------------------------------------------------
EnumContentType ScalerTmdsMacRx3HdmiGetAviContentType(void)
{
    BYTE ucContentType = ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_CONTENT_TYPE);

    switch(ucContentType)
    {
        case 0x00:

            if(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_IT_CONTENT) == 0x01)
            {
...
//--------------------------------------------------
BYTE ScalerTmdsMacRx3HdmiGetColorDepth(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    if(GET_TMDS_MAC_RX3_HDMI_GCP_RECEIVED() == _TRUE)
    {
        if(ScalerGetBit(P72_B4_TMDS_DPC0, (_BIT3 | _BIT2 | _BIT1 | _BIT0)) == (_BIT2 | _BIT0))
        {
            return _COLOR_DEPTH_10_BITS;
        }
        else if(ScalerGetBit(P72_B4_TMDS_DPC0, (_BIT3 | _BIT2 | _BIT1 | _BIT0)) == (_BIT2 | _BIT1))
        {
            return _COLOR_DEPTH_12_BITS;
        }
        else if(ScalerGetBit(P72_B4_TMDS_DPC0, (_BIT3 | _BIT2 | _BIT1 | _BIT0)) == (_BIT2 | _BIT1 | _BIT0))
        {
...
// TODO: Add EMP Related V WD for S4 or ECO
//--------------------------------------------------
// Description  : Hdmi Enable Watch Dog
// Input Value  : ucWDType => Watch Dog type, bEnable => Enable watch dog flag
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiWatchDog(BYTE ucWDType, bit bEnable)
{
    if(bEnable == _ENABLE)
    {
        if(((ucWDType & _HDMI_AVI_INFO_VARIATION_WD) == _HDMI_AVI_INFO_VARIATION_WD) && (GET_DIGITAL_COLOR_INFO_CHANGE_RESET() == _TRUE))
        {
            ...
            {
                // Clear AVI Info Frame Variation flag
                ScalerSetByte(P72_CC_HDMI_GPVS, _BIT0);
                ...
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_AA_PORT_PAGE72_HDMI_PVGCR3, ~_BIT7, _BIT7);

#if(_HW_HDMI_AVI_ACE_WD_SUPPORT == _ON)
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_AB_PORT_PAGE72_HDMI_PVGCR4, ~_BIT4, _BIT4);
#endif
        ...
        if((ucWDType & _HDMI_AV_MUTE_WD) == _HDMI_AV_MUTE_WD)
        {
            ...
            {
                // CLR AVMute Flag
                ScalerSetBit(P72_CB_HDMI_SR, ~(_BIT7 | _BIT5 | _BIT3 | _BIT2 | _BIT1), _BIT7);
        ...
        {
            // clr NO CLK Flag
            ScalerSetBit(P72_B6_TMDS_UDC1, ~_BIT3, _BIT3);

            // Enable NO CLK video/audio WD
            ScalerSetBit(P72_B2_TMDS_DBB2, ~(_BIT5 | _BIT4), (_BIT5 | _BIT4));
        }
#endif
    }
    else
    {
...
#if(_HW_HDMI_AVI_ACE_WD_SUPPORT == _ON)
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_AB_PORT_PAGE72_HDMI_PVGCR4, ~_BIT4, 0x00);
#endif
        ...
        if((ucWDType & _TMDS_NO_CLK_WD) == _TMDS_NO_CLK_WD)
        {
            ...
            ScalerSetBit(P72_B2_TMDS_DBB2, ~(_BIT5 | _BIT4), 0x00);
        }
#endif
    }
}
...
// Output Value : None
//--------------------------------------------------
bit ScalerTmdsMacRx3BchErrorCheck(EnumInputPort enumInputPort)
{
    BYTE ucBchErrorCount = 0x00;

    for(BYTE ucBchCheck = 0; ucBchCheck < 9; ucBchCheck++)
    {
        if(ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_02_PORT_PAGE72_HDMI_BCHCR, _BIT2) == _BIT2)
        {
            // Clr BCH Error Flag
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_02_PORT_PAGE72_HDMI_BCHCR, ~_BIT2, 0x00);
    ...
    if(ucBchErrorCount == 0x09)
    {
        ...
        DebugMessageRx3("BCH Error Reset PHY FIFO", ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_02_PORT_PAGE72_HDMI_BCHCR, _BIT2));
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3PowerOffProc(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3FreqDetectDisable(void)
{
    // Disable TMDS Freq. Detect IRQ
    ScalerSetBit(P72_E6_HDMI_FREQDET_CTRL, ~(_BIT2 | _BIT1), 0x00);
    ScalerSetBit(P72_EF_HDMI_ERROR_TH, ~(_BIT7 | _BIT6), 0x00);

    // Clear TMDS Clk Count
    g_usTmdsMacRx3ClkCount = 0;

    ScalerTmdsPhyRxFifoAutoResetEnable(ScalerTmdsMacRxRxDxMapping(_RX3), _DISABLE);
    ...
    ScalerSetByte(P72_1B_HDMI_CTRL_1B, (_BIT4 | _BIT0));
#endif
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3FirstActiveProc(EnumSourceType enumSourceType)
{
    enumSourceType = enumSourceType;

#if(_TMDS_NO_CLK_TRIGGER_AV_WATCHDOG == _ON)
    // Enable NO CLK WD
    ScalerTmdsMacRx3HdmiWatchDog(_TMDS_NO_CLK_WD, _ENABLE);
#endif
}
...
//--------------------------------------------------
void ScalerTmdsMacRx3SetDeOnlyModeConfig(EnumDeOnlyConfig enumDeonlyConfig)
{
    // De only enable?
...
//--------------------------------------------------
EnumDeOnlyConfig ScalerTmdsMacRx3GetDeOnlyModeConfig(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3TMDSScanInitial(EnumInputPort enumInputPort)
{
    enumInputPort = enumInputPort;

    ScalerTmdsMacRx3Initial(enumInputPort);
...
//              : False : No Signal
//--------------------------------------------------
bit ScalerTmdsMacRx3TMDSPSPreDetect(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
...
#endif
    {
        ...
        if(ScalerMcuDdcGetDdcDetectFlag(enumMappingPort) == _TRUE)
        {
            ...
            SET_TMDS_MAC_RX3_PS_WAKEUP();
#endif

#if(_TMDS_TOGGLE_HPD_Z0_FOR_ACER == _ON)
            SET_TMDS_MAC_RX3_TOGGLE_Z0();
#endif
            return _TRUE;
        }
    }
    ...
    ScalerSetBit(P72_E6_HDMI_FREQDET_CTRL, ~(_BIT7 | _BIT5 | _BIT2), 0x00);
...
//              : False : No Signal
//--------------------------------------------------
bit ScalerTmdsMacRx3TMDSNormalPreDetect(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
...
//--------------------------------------------------
bit ScalerTmdsMacRx3HdcpEnabled(void)
{
...
#endif
    {
        pucHDCPFrameCount[0] = ScalerGetDataPortSingleByte(P72_C3_HDCP_AP, _P72_C4_PT_C0_PORT_PAGE72_HDCP_FCR);
        ...
        pucHDCPFrameCount[1] = ScalerGetDataPortSingleByte(P72_C3_HDCP_AP, _P72_C4_PT_C0_PORT_PAGE72_HDCP_FCR);
...
// TODO: Add for DHDR/ VS EMP Flag in S4
//--------------------------------------------------
// Description  : Clear All Received Status of Packet
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3ResetAllPacketReceiveStatus(void)
{
    // Clear AVI infoframe & GCP packet Detection Flag
    ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));

    // Clear RSV 0~3 detection Flag
    ScalerSetByte(P72_CC_HDMI_GPVS, (_BIT6 | _BIT5));
    ...
    ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2));
...
//--------------------------------------------------
BYTE ScalerTmdsMacRx3TMDSVideoDetect(bit bWait)
{
    ...
    if(bWait == _WAIT)
    {
        ...
        CLR_TMDS_MAC_RX3_RGBHV_DETECTING();
    ...
    else
    {
        ...
        SET_TMDS_MAC_RX3_RGBHV_DETECTING();
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3TMDSVideoDetectEvent(void)
{
    CLR_TMDS_MAC_RX3_RGBHV_DETECTING();
}
...
//--------------------------------------------------
bit ScalerTmdsMacRx3CheckCDRStable(WORD usClkCount)
{
    BYTE ucStableIrq = 0;
    ...
    if(GET_TMDS_MAC_RX3_HIGH_SPEED_MODE() == _TRUE)
    {
        ...
        if(abs(usClkCount - (ScalerTmdsMacRx3MeasureClk(_CLK_SOURCE_RED) * 4)) > (usClkCount >> 6))
        {
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
            if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) != _BIT6)
#endif
        ...
        if(abs(usClkCount - (ScalerTmdsMacRx3MeasureClk(_CLK_SOURCE_BLUE) * 4)) > (usClkCount >> 6))
        {
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
            if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) != _BIT6)
#endif
        ...
        if(abs(usClkCount - (ScalerTmdsMacRx3MeasureClk(_CLK_SOURCE_GREEN) * 4)) > (usClkCount >> 6))
        {
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
            if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) != _BIT6)
#endif
    ...
    {
        // Check Current Measured Freq. is the same as previously locked
        if(abs(usClkCount - ScalerTmdsMacRx3MeasureClk(_CLK_SOURCE_RED)) > (usClkCount >> 6))
        {
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
            if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) != _BIT6)
#endif
        ...
        if(abs(usClkCount - ScalerTmdsMacRx3MeasureClk(_CLK_SOURCE_BLUE)) > (usClkCount >> 6))
        {
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
            if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) != _BIT6)
#endif
        ...
        if(abs(usClkCount - ScalerTmdsMacRx3MeasureClk(_CLK_SOURCE_GREEN)) > (usClkCount >> 6))
        {
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
            if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) != _BIT6)
#endif
...
// Output Value : None
//--------------------------------------------------
bit ScalerTmdsMacRx3HdmiCheckDeepColorFifo(void)
{
    BYTE ucmMax = 0;

    ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_82_PORT_PAGE72_HDMI_DPC_SET2, ~(_BIT4 | _BIT3), _BIT3);

    ScalerTimerDelayXms(6);

    ucmMax = ((ScalerGetDataPortSingleByte(P72_C9_HDMI_AP, _P72_CA_PT_81_PORT_PAGE72_HDMI_DPC_SET1) & (_BIT7 | _BIT6 | _BIT5 | _BIT4)) >> 4);

    if((ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_82_PORT_PAGE72_HDMI_DPC_SET2, _BIT0) == _BIT0) && (ucmMax < 0x09))
    {
        ucmMax = ucmMax + 1;

        ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_81_PORT_PAGE72_HDMI_DPC_SET1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (ucmMax << 4));
        DebugMessageRx3("RX3: Deep color fifo error", ucmMax);

        return _FALSE;
    }
    else if(ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_82_PORT_PAGE72_HDMI_DPC_SET2, _BIT0) == _BIT0)
    {
        DebugMessageRx3("RX3: Deep color fifo error, Full Notify Level:9", ucmMax);
    }
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiAVMuteProc(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3NoClkWatchDogProc(void)
{
    if((ScalerGetBit(P72_B6_TMDS_UDC1, _BIT3) == _BIT3) && (ScalerGetBit(P72_EF_HDMI_ERROR_TH, _BIT6) == _BIT6))
    {
        ...
        if(ScalerGetBit(P72_EF_HDMI_ERROR_TH, _BIT6) == _BIT6)
        {
            // clr NO CLK Flag
            ScalerSetBit(P72_B6_TMDS_UDC1, ~_BIT3, _BIT3);
...
//--------------------------------------------------
EnumSourceType ScalerTmdsMacRx3FormatDetect(void)
{
    ...
    if(ScalerTimerPollingFlagProc(130, P72_CB_HDMI_SR, _BIT0, _TRUE) == _TRUE)
    {
        ...
        if(ScalerGetBit(P72_00_HDMI_CTRL_00, _BIT0) == _BIT0)
        {
            ...
            SET_TMDS_MAC_RX3_HDMI20_FORMAT_RESET_WAITING();
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3AfterHotPlugEventProc(bit bRestoreZ0)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
...
#else
    if((GET_HDMI_HOTPLUG_TOGGLE() == _TRUE) && ((ScalerTmdsMacRxGetCableStatus(enumMappingPort) == _TRUE) || (GET_TMDS_MAC_RX3_HPD_TIMER_EVENT_TOGGLING_CABLE_ON() == _TRUE)))
#endif
    {
#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
        ...
        ScalerSetDataPortByte(P72_C3_HDCP_AP, _P72_C4_PT_C2_PORT_PAGE72_HDCP_SLAVE_ADD, g_ucTmdsMacRx3SlaveAddr);

#if(_HDMI20_MAC_RX3_SUPPORT == _ON)
        // Enable HDMI 2.0 SCDC Function
        ScalerSetBit(P72_19_HDMI_CTRL_19, ~_BIT7, _BIT7);

        ScalerTmdsMacRxHpd5vPinCheckEvent(ScalerTmdsMacRxRxDxMapping(_RX3), _ENABLE);
#endif

#if(_DELL_HDMI_HPD_DDC_STYLE_SUPPORT == _ON)
        if(g_ucTmdsMacRx3DdcramNackStatus == _FALSE)
        {
        ...
        {
            // Restore Z0 Status
            ScalerTmdsPhyRxRestoreZ0Status(enumMappingPort, g_ucTmdsMacRx3Z0Status);
...
// Output Value :
//--------------------------------------------------
void ScalerTmdsMacRx3HotPlugHighProc(WORD usHpdTime)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
...
// Output Value :
//--------------------------------------------------
void ScalerTmdsMacRx3HotPlugLowProc(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
...
#if(_DP_HDMI_COMPATIBLE_MODE == _ON)
        if(GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() != _TMDS_MAC_RX_HPD_EIZO_PS_WAKEUP)
#endif
        {
...
#if(_DELL_HDMI_HPD_DDC_STYLE_SUPPORT == _ON)
        g_ucTmdsMacRx3DdcramNackStatus = ScalerMcuDdcGetForceNackStatus(enumMappingPort);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3BeforeHotPlugEventProc(bit bDisableZ0)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    if((GET_HDMI_HOTPLUG_TOGGLE() == _TRUE) && (ScalerTmdsMacRxGetCableStatus(enumMappingPort) == _TRUE))
    {
        ...
        // Save Z0 Status
        g_ucTmdsMacRx3Z0Status = ScalerTmdsPhyRxSaveZ0Status(enumMappingPort);

        // Backup Slave Address
        g_ucTmdsMacRx3SlaveAddr = ScalerGetDataPortSingleByte(P72_C3_HDCP_AP, _P72_C4_PT_C2_PORT_PAGE72_HDCP_SLAVE_ADD);
        ...
        if(GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() != _TMDS_MAC_RX_HPD_EDID_SWITCH_KEEP_ACTIVE)
        {
            // Video Mute
            ScalerSetBit(P72_A6_TMDS_OUTCTL, ~(_BIT6 | _BIT5 | _BIT4), 0x00);

            if((GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() != _TMDS_MAC_RX_HPD_NORMAL) && (GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() != _TMDS_MAC_RX_HPD_ACER))
            {
                // Set Notify flag for sys reset mode
                SET_TMDS_MAC_RX3_HPD_RESET_TO_SEARCH_EVENT();
            }
#if(_DP_HDMI_COMPATIBLE_MODE == _ON)
            if(GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() != _TMDS_MAC_RX_HPD_EIZO_PS_WAKEUP)
#endif
        ...
        SET_TMDS_MAC_RX3_HPD_TIMER_EVENT_TOGGLING_CABLE_ON();
#endif
    }
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3BackupHdcpType(void)
{
    if((ScalerGetBit(P72_C0_HDCP_CR, _BIT0) == _BIT0) && (ScalerGetBit(P72_A9_TMDS_ABC0, _BIT6) == _BIT6))
    {
        SET_TMDS_MAC_RX3_BACKUP_HDCP_TYPE(_HDCP_14);
    }
#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
    else if((ScalerGetBit(P2E_26_HDCP_I2C_CTRL_0, _BIT7) == _BIT7) && (ScalerGetByte(P2E_2C_HDCP_I2C_CTRL_6) == 0x10))
    {
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3Hdcp1p4AksvClear(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdcpFlagClear(void)
{
...
// Output Value :
//--------------------------------------------------
void ScalerTmdsMacRx3HotPlugEvent(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    {
        ScalerTmdsMacRx3HotPlugHighProc(GET_HDMI_HOTPLUG_TIME());
    }
    else if(GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() == _TMDS_MAC_RX_HPD_HDCP22)
    {
        ScalerTmdsMacRx3HotPlugHighProc(_TMDS_HDCP_2_2_HPD_TIME);
    }
    else if(GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() == _TMDS_MAC_RX_HPD_ACER)
    {
        ScalerTmdsMacRx3HotPlugHighProc(_TMDS_ACER_HPD_TIME);
    }
    ...
    {
        ScalerTmdsMacRx3HotPlugHighProc(_TMDS_EDID_SWITCH_HPD_TIME);
    }
    else
    {
        ScalerTmdsMacRx3HotPlugHighProc(GET_HDMI_HOTPLUG_TIME());
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3EmpSramSetting(bit bEnable)
{
    if(bEnable == _ENABLE)
    {
        ...
        ScalerSetBit(P2E_70_EMP_VS, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));

#if(_HDMI_SBTM_SUPPORT == _ON)
        // Detect VS EMP w/ org_id and tag
        ScalerSetBit(P2E_8A_VS_EMP_1A, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));

        // org id & tag
        ScalerSetByte(P2E_7C_VS_ORG_ID, _HDMI21);

        ScalerSetByte(P2E_8B_VS_EMP_1B, 0x00);
        ScalerSetByte(P2E_8C_VS_EMP_1C, 0x03);
#elif(_DM_FUNCTION == _ON)
        // Detect VS EMP w/ org_id only
        ScalerSetBit(P2E_8A_VS_EMP_1A, ~(_BIT7 | _BIT6), _BIT6);

        // org id
        ScalerSetByte(P2E_7C_VS_ORG_ID, _VENDOR_SPECIFIC);
#endif
        ...
        ScalerSetBit(P2E_71_EMP_DHDR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));

        // Enable D-HDR EMP stored
        ucEmpConfig |= _BIT6;
#endif
        // Set EMP Config
        ScalerSetBit(P2E_88_HDMI_EMP_SRAM_CTRL0, ~(_BIT7 | _BIT6 | _BIT4), ucEmpConfig);
    }
    else
    {
        // Disable EMP stored
        ScalerSetBit(P2E_88_HDMI_EMP_SRAM_CTRL0, ~(_BIT7 | _BIT6), 0x00);
        ScalerSetBit(P2E_8A_VS_EMP_1A, ~(_BIT7 | _BIT6), 0x00);

        // [7] Disable VS/ D-HDR IRQ
        ScalerSetBit(P2E_70_EMP_VS, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
        ScalerSetBit(P2E_71_EMP_DHDR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
    }
}
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HdmiIrqEnable(bit bEnable, StructHdmiIrqStatus *pstTmdsMacIrqStatus)
{
    if(bEnable == _ENABLE)
    {
        // HDCP 1.4 Write Aksv IRQ have been Received
        ScalerSetBit(P72_AA_TMDS_ABC1, ~_BIT4, (pstTmdsMacIrqStatus->b1HdcpAksvIrqBackup << 4));

#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
        // Enable HDCP 2.2 IRQ
        ScalerSetBit(P2E_35_HDCP_I2C_CTRL_7, ~_BIT0, pstTmdsMacIrqStatus->b1Hdcp2WrDoneIrqBackup);
#endif

#if(_HDMI20_MAC_RX3_SUPPORT == _ON)
        // Enable SCDC 0x20 Change/Source Write Read Request Enable IRQ
        ScalerSetBit(P72_26_HDMI_CTRL_26, ~(_BIT4 | _BIT3), (pstTmdsMacIrqStatus->b2ScdcChangeIrqBackup << 3));

        // Read Request Done into IRQ
        ScalerSetBit(P72_1F_HDMI_CTRL_1F, ~_BIT3, (pstTmdsMacIrqStatus->b1ReadRequestIrqBackup << 3));
#endif
        ...
        if(ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) == _BIT6)
        {
            ...
            ScalerSetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, ~_BIT0, pstTmdsMacIrqStatus->b1FrlRsv0IrqBackup);
            ScalerSetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, ~_BIT1, (pstTmdsMacIrqStatus->b1FrlRsv1IrqBackup << 1));
            ScalerSetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, ~_BIT2, (pstTmdsMacIrqStatus->b1FrlRsv2IrqBackup << 2));
            ScalerSetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, ~_BIT3, (pstTmdsMacIrqStatus->b1FrlRsv3IrqBackup << 3));
#endif

            // Source set FRL rate, Source clear FLT_update, Source clear FRL_Start
            ScalerSetBit(P72_3D_HDMI21_LT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1), (pstTmdsMacIrqStatus->b1FrlRateIrqBackup << 6));
            ScalerSetBit(P72_3D_HDMI21_LT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1), (pstTmdsMacIrqStatus->b1FrlStartIrqBackup << 4));
            ScalerSetBit(P72_3D_HDMI21_LT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1), (pstTmdsMacIrqStatus->b1FltUpdateIrqBackup << 2));

#if((_DM_FUNCTION == _ON) && (_HW_CPU32_IS_BOOT_CPU == _TRUE))
            // "VS EMP" received into IRQ
            ScalerSetBit(P67_51_EMP_VS, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (pstTmdsMacIrqStatus->b1FrlVsEmpIrqBackup << 7));
#endif

#if(_HDMI_ADVANCED_HDR10_SUPPORT_MODE == _ADVANCED_HDR10_VSIF_AND_DHDR_MODE)
            // "D-HDR EMP" received into IRQ
            ScalerSetBit(P67_53_EMP_DHDR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (pstTmdsMacIrqStatus->b1FrlDhdrEmpIrqBackup << 7));
#endif

#if(_AUDIO_SUPPORT == _ON)
            ScalerSetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_8A_PORT_PAGE77_AUDIO_FREQDET, ~(_BIT3 | _BIT1 | _BIT0), (pstTmdsMacIrqStatus->b1FrlAudioIrqBackup << 3));
#endif
        }
        else
#endif
        {
#if((_HDMI_ADVANCED_HDR10_SUPPORT_MODE != _ADVANCED_HDR10_NONE) || (_DM_FUNCTION == _ON))
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT0, pstTmdsMacIrqStatus->b1Rsv0IrqBackup);
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT1, (pstTmdsMacIrqStatus->b1Rsv1IrqBackup << 1));
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT2, (pstTmdsMacIrqStatus->b1Rsv2IrqBackup << 2));
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT3, (pstTmdsMacIrqStatus->b1Rsv3IrqBackup << 3));
#endif

#if((_DM_FUNCTION == _ON) && (_HW_CPU32_IS_BOOT_CPU == _TRUE))
            // "VS EMP" received into IRQ
            ScalerSetBit(P2E_70_EMP_VS, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (pstTmdsMacIrqStatus->b1VsEmpIrqBackup << 7));
#endif

#if(_HDMI_ADVANCED_HDR10_SUPPORT_MODE == _ADVANCED_HDR10_VSIF_AND_DHDR_MODE)
            // "D-HDR EMP" received into IRQ
            ScalerSetBit(P2E_71_EMP_DHDR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (pstTmdsMacIrqStatus->b1DhdrEmpIrqBackup << 7));
#endif

#if(_AUDIO_SUPPORT == _ON)
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_8A_PORT_PAGE72_AUDIO_FREQDET, ~(_BIT3 | _BIT1 | _BIT0), (pstTmdsMacIrqStatus->b1TmdsAudioIrqBackup << 3));
#endif
        }
    }
    else
    {
        ...
        pstTmdsMacIrqStatus->b1HdcpAksvIrqBackup = (ScalerGetBit(P72_AA_TMDS_ABC1, _BIT4) >> 4);
        ScalerSetBit(P72_AA_TMDS_ABC1, ~_BIT4, 0x00);

#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
        // Backup/Disable HDCP 2.2 IRQ
        pstTmdsMacIrqStatus->b1Hdcp2WrDoneIrqBackup = ScalerGetBit(P2E_35_HDCP_I2C_CTRL_7, _BIT0);
        ScalerSetBit(P2E_35_HDCP_I2C_CTRL_7, ~_BIT0, 0x00);
#endif

#if(_HDMI20_MAC_RX3_SUPPORT == _ON)
        // Backup/Disable SCDC 0x20 Change/Source Write Read Request IRQ
        pstTmdsMacIrqStatus->b2ScdcChangeIrqBackup = (ScalerGetBit(P72_26_HDMI_CTRL_26, (_BIT4 | _BIT3)) >> 3);
        ScalerSetBit(P72_26_HDMI_CTRL_26, ~(_BIT4 | _BIT3), 0x00);

        // Backup/Disable Read Request IRQ
        pstTmdsMacIrqStatus->b1ReadRequestIrqBackup = (ScalerGetBit(P72_1F_HDMI_CTRL_1F, _BIT3) >> 3);
        ScalerSetBit(P72_1F_HDMI_CTRL_1F, ~_BIT3, 0x00);
#endif
        ...
        {
#if((_HDMI_ADVANCED_HDR10_SUPPORT_MODE != _ADVANCED_HDR10_NONE) || (_DM_FUNCTION == _ON))
            pstTmdsMacIrqStatus->b1FrlRsv0IrqBackup = ScalerGetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, _BIT0);
            pstTmdsMacIrqStatus->b1FrlRsv1IrqBackup = (ScalerGetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, _BIT1) >> 1);
            pstTmdsMacIrqStatus->b1FrlRsv2IrqBackup = (ScalerGetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, _BIT2) >> 2);
            pstTmdsMacIrqStatus->b1FrlRsv3IrqBackup = (ScalerGetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, _BIT3) >> 3);

            ScalerSetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_B5_PORT_PAGE77_HDMI_BED_FUNC_6, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
#endif

            // Backup/Disable FRL rate, Source clear FLT_update, Source clear FRL_Start IRQ
            pstTmdsMacIrqStatus->b1FrlRateIrqBackup = (ScalerGetBit(P72_3D_HDMI21_LT_0, _BIT6) >> 6);
            pstTmdsMacIrqStatus->b1FrlStartIrqBackup = (ScalerGetBit(P72_3D_HDMI21_LT_0, _BIT4) >> 4);
            pstTmdsMacIrqStatus->b1FltUpdateIrqBackup = (ScalerGetBit(P72_3D_HDMI21_LT_0, _BIT2) >> 2);
            ScalerSetBit(P72_3D_HDMI21_LT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1), 0x00);

#if((_DM_FUNCTION == _ON) && (_HW_CPU32_IS_BOOT_CPU == _TRUE))
            // Backup/Disable Vs EMP IRQ
            pstTmdsMacIrqStatus->b1FrlVsEmpIrqBackup = (ScalerGetBit(P67_51_EMP_VS, _BIT7) >> 7);
            ScalerSetBit(P67_51_EMP_VS, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
#endif

#if(_HDMI_ADVANCED_HDR10_SUPPORT_MODE == _ADVANCED_HDR10_VSIF_AND_DHDR_MODE)
            // Backup/Disable Dhdr EMP IRQ
            pstTmdsMacIrqStatus->b1FrlDhdrEmpIrqBackup = (ScalerGetBit(P67_53_EMP_DHDR, _BIT7) >> 7);
            ScalerSetBit(P67_53_EMP_DHDR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
#endif

#if(_AUDIO_SUPPORT == _ON)
            // Backup/Disable Audio IRQ
            pstTmdsMacIrqStatus->b1FrlAudioIrqBackup = (ScalerGetDataPortBit(P77_C9_HDMI_AP, _P77_CA_PT_8A_PORT_PAGE77_AUDIO_FREQDET, _BIT3) >> 3);
        ...
        {
#if((_HDMI_ADVANCED_HDR10_SUPPORT_MODE != _ADVANCED_HDR10_NONE) || (_DM_FUNCTION == _ON))
            pstTmdsMacIrqStatus->b1Rsv0IrqBackup = ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, _BIT0);
            pstTmdsMacIrqStatus->b1Rsv1IrqBackup = (ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, _BIT1) >> 1);
            pstTmdsMacIrqStatus->b1Rsv2IrqBackup = (ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, _BIT2) >> 2);
            pstTmdsMacIrqStatus->b1Rsv3IrqBackup = (ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, _BIT3) >> 3);

            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
#endif

#if((_DM_FUNCTION == _ON) && (_HW_CPU32_IS_BOOT_CPU == _TRUE))
            // Backup/Disable Vs EMP IRQ
            pstTmdsMacIrqStatus->b1VsEmpIrqBackup = (ScalerGetBit(P2E_70_EMP_VS, _BIT7) >> 7);
            ScalerSetBit(P2E_70_EMP_VS, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
#endif

#if(_HDMI_ADVANCED_HDR10_SUPPORT_MODE == _ADVANCED_HDR10_VSIF_AND_DHDR_MODE)
            // Backup/Disable Dhdr EMP IRQ
            pstTmdsMacIrqStatus->b1DhdrEmpIrqBackup = (ScalerGetBit(P2E_71_EMP_DHDR, _BIT7) >> 7);
            ScalerSetBit(P2E_71_EMP_DHDR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
#endif

#if(_AUDIO_SUPPORT == _ON)
            // Backup/Disable Audio IRQ
            pstTmdsMacIrqStatus->b1TmdsAudioIrqBackup = (ScalerGetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_8A_PORT_PAGE72_AUDIO_FREQDET, _BIT3) >> 3);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3RoundRobinIrqEnable(bit bEnable)
{
    bEnable = bEnable;
    ...
    {
        ScalerTmdsMacRx3RsvIrqEnable(ucRsv, bEnable);
    }
#endif
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3RsvIrqEnable(EnumHdmiRsvNumber enumRsvNumber, bit bEnable)
{
    switch(enumRsvNumber)
    {
        case _HDMI_RSV_0:
            ...
            {
                ScalerSetByte(P72_CC_HDMI_GPVS, _BIT5);
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT0, _BIT0);
            }
            else
            {
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT0, 0x00);
                ScalerSetByte(P72_CC_HDMI_GPVS, _BIT5);
            }
            break;
        ...
        case _HDMI_RSV_1:
            ...
            {
                ScalerSetByte(P72_CC_HDMI_GPVS, _BIT6);
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT1, _BIT1);
            }
            else
            {
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT1, 0x00);
                ScalerSetByte(P72_CC_HDMI_GPVS, _BIT6);
            }
            break;
        ...
        case _HDMI_RSV_2:
            ...
            {
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_00_PORT_PAGE72_HDMI_SCR, ~(_BIT7 | _BIT6), _BIT7);
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT2, _BIT2);
            }
            else
            {
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT2, 0x00);
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_00_PORT_PAGE72_HDMI_SCR, ~(_BIT7 | _BIT6), _BIT7);
            }
            break;
        ...
        case _HDMI_RSV_3:
            ...
            {
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_00_PORT_PAGE72_HDMI_SCR, ~(_BIT7 | _BIT6), _BIT6);
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT3, _BIT3);
            }
            else
            {
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_B5_PORT_PAGE72_HDMI_BED_FUNC_6, ~_BIT3, 0x00);
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_00_PORT_PAGE72_HDMI_SCR, ~(_BIT7 | _BIT6), _BIT6);
            }
            break;
        ...
        case _HDMI_RSV_4:
            ...
            {
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT2);
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT6 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT6);
            }
            else
            {
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT6 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT2);
            }
            break;
        ...
        case _HDMI_RSV_5:
            ...
            {
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT5 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT5);
            }
            else
            {
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT5 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT1);
            }
            break;
        ...
        case _HDMI_RSV_6:
            ...
            {
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT4);
            }
            else
            {
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
            }
            break;
        ...
        case _HDMI_RSV_7:
            if(bEnable == _ENABLE)
            {
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT3);
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT7);
            }
            else
            {
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                ScalerSetBit(P72_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT3);
            }
            break;
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3RsvInitial(void)
{
#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
    ...
    ScalerSetByte(P72_D4_PORT_PAGE72_HDMI_PTRSV6, _HDMI_AVI_INFO_TYPE);

    ScalerSetByte(P72_D3_PORT_PAGE72_HDMI_PTRSV5, _HDMI_GENERAL_CONTROL_TYPE);

#if(_HDMI_HDR10_SUPPORT == _ON)
    ScalerSetByte(P72_D2_PORT_PAGE72_HDMI_PTRSV4, _HDR_INFO_TYPE);
#endif

#if(_HDMI_FREESYNC_REPLAY_SUPPORT == _ON)
    ScalerSetByte(P72_CF_HDMI_PTRSV7, _SPD_INFO_TYPE);
    ScalerSetBit(P72_D7_HDMI_SHDR_IE_FLAG, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT4 | _BIT3 | _BIT2));

    // Freesync Replay disable
    ScalerSetBit(P72_D6_HDMI_SHDR_IE, ~_BIT4, 0x00);

    // PR6 = 2b'10 is Replay, Other is Live Capture
    ScalerSetBit(P72_D6_HDMI_SHDR_IE, ~(_BIT3 | _BIT2), _BIT3);
#endif

#if((_HDMI_SPD_IF_RCV_BY_RR == _ON) && (_HDMI_VSIF_RCV_BY_RR == _ON))
    // write RSV0-2 tag
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_43_PORT_PAGE72_HDMI_PTRSV0, _HDMI_VSIF_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_44_PORT_PAGE72_HDMI_PTRSV1, _HDMI_VSIF_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_A4_PORT_PAGE72_HDMI_PTRSV_2, _SPD_INFO_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_A5_PORT_PAGE72_HDMI_PTRSV_3, _SPD_INFO_TYPE);

    // write Round Robin tag
    ScalerSetByte(P72_DD_PKT_ROUND_ROBIN_PT0, _HDMI_VSIF_TYPE);
    ScalerSetByte(P72_DE_PKT_ROUND_ROBIN_PT1, _HDMI_VSIF_TYPE);
    ScalerSetByte(P72_DF_PKT_ROUND_ROBIN_PT2, _SPD_INFO_TYPE);
#elif((_HDMI_SPD_IF_RCV_BY_RR == _ON) && (_HDMI_VSIF_RCV_BY_RR != _ON))
    // write RSV0-2 tag
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_43_PORT_PAGE72_HDMI_PTRSV0, _SPD_INFO_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_44_PORT_PAGE72_HDMI_PTRSV1, _SPD_INFO_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_A4_PORT_PAGE72_HDMI_PTRSV_2, _SPD_INFO_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_A5_PORT_PAGE72_HDMI_PTRSV_3, _SPD_INFO_TYPE);

    // write Round Robin tag
    ScalerSetByte(P72_DD_PKT_ROUND_ROBIN_PT0, _SPD_INFO_TYPE);
    ScalerSetByte(P72_DE_PKT_ROUND_ROBIN_PT1, _SPD_INFO_TYPE);
    ScalerSetByte(P72_DF_PKT_ROUND_ROBIN_PT2, _SPD_INFO_TYPE);
#elif((_HDMI_SPD_IF_RCV_BY_RR != _ON) && (_HDMI_VSIF_RCV_BY_RR == _ON))
    // write RSV0-2 tag
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_43_PORT_PAGE72_HDMI_PTRSV0, _HDMI_VSIF_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_44_PORT_PAGE72_HDMI_PTRSV1, _HDMI_VSIF_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_A4_PORT_PAGE72_HDMI_PTRSV_2, _HDMI_VSIF_TYPE);
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_A5_PORT_PAGE72_HDMI_PTRSV_3, _HDMI_VSIF_TYPE);

    // write Round Robin tag
    ScalerSetByte(P72_DD_PKT_ROUND_ROBIN_PT0, _HDMI_VSIF_TYPE);
    ScalerSetByte(P72_DE_PKT_ROUND_ROBIN_PT1, _HDMI_VSIF_TYPE);
    ScalerSetByte(P72_DF_PKT_ROUND_ROBIN_PT2, _HDMI_VSIF_TYPE);
#endif

#if((_HDMI_SPD_IF_RCV_BY_RR == _ON) || (_HDMI_VSIF_RCV_BY_RR == _ON))
    // ENABLE Round Robin
    ScalerSetBit(P72_B2_TMDS_DBB2, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT1 | _BIT0));
#endif
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3Initial(EnumInputPort enumInputPort)
{
    enumInputPort = enumInputPort;
    ...
    ScalerTmdsMacRx3RoundRobinIrqEnable(_DISABLE);

#if(_HW_HDMI_EMP_SRAM_SUPPORT == _ON)
    // Inactive EMP SRAM
    ScalerTmdsMacRx3EmpSramSetting(_DISABLE);
#endif
    ...
    ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_02_PORT_PAGE72_HDMI_BCHCR, ~(_BIT6 | _BIT3 | _BIT2 | _BIT1), (_BIT6 | _BIT3));
    ...
    ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_82_PORT_PAGE72_HDMI_DPC_SET2, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3), (_BIT6 | _BIT5));

    // Set Deep Color Fifo Full/Empty Level
    ScalerSetDataPortByte(P72_C9_HDMI_AP, _P72_CA_PT_81_PORT_PAGE72_HDMI_DPC_SET1, 0x73);
#endif

    // Rsv Assignment
    ScalerTmdsMacRx3RsvInitial();
...
#if(_HW_HDMI_AVI_ACE_WD_SUPPORT == _ON)
    ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_AB_PORT_PAGE72_HDMI_PVGCR4, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
#else
...
#if(_HDMI_FRL_MAC_RX3_SUPPORT == _ON)
    if((ScalerGetBit(P72_E6_HDMI_FREQDET_CTRL, _BIT1) == 0x00) && (ScalerGetBit(P67_00_HDMI_TOP_0, _BIT6) == 0x00))
#else
    ...
    ScalerSetBit(P72_1C_HDMI_CTRL_1C, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT2), 0x00);

    // Set Read Request 1ms reference clock to XTAL
    ScalerSetBit(P72_1A_HDMI_CTRL_1A, ~_BIT3, 0x00);

    // Set time interval form bus free to Read Request(4.7us~500us)
    ScalerSetByte(P72_1B_HDMI_CTRL_1B, (_BIT3 | _BIT0));

    // Enable HDMI 2.0 Function
    ScalerSetBit(P72_00_HDMI_CTRL_00, ~(_BIT5 | _BIT3 | _BIT1 | _BIT0), _BIT0);
    ...
    ScalerSetBit(P72_00_HDMI_CTRL_00, ~(_BIT5 | _BIT3 | _BIT1 | _BIT0), 0x00);
...
#else // Else of #if(_HDMI_MAC_RX3_SUPPORT == _ON)
    ...
    ScalerSetBit(P2E_26_HDCP_I2C_CTRL_0, ~_BIT4, 0x00);
    ...
    ScalerSetBit(P72_B5_TMDS_UDC0, ~(_BIT6 | _BIT5), 0x00);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3InterruptInitial(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
...
#endif
    {
        ...
        ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_60_PORT_PAGE72_HDMI_INTCR, ~(_BIT7 | _BIT3), (_BIT7 | _BIT3));
#endif
...
//--------------------------------------------------
WORD ScalerTmdsMacRx3MeasureClk(BYTE ucMeasureClk)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    BYTE ucDelayCount = 0;
    ...
    ScalerSetBit(P72_CA_HDMI_DP, ~(_BIT5 | _BIT3), 0x00);

    if(ucMeasureClk == _CLK_SOURCE_TMDS)
    {
        // Set ref clk = GDI clk & Switch TMDS Clk to be measure
        ScalerSetBit(P72_AD_TMDS_CPS, ~(_BIT6 | _BIT4), (_BIT6 | _BIT4));
    }
    else
    {
        ...
        ScalerSetBit(P72_AD_TMDS_CPS, ~(_BIT6 | _BIT4), _BIT4);
    }

    // Start Measure
    ScalerSetByte(P72_C9_HDMI_AP, _P72_CA_PT_28_PORT_PAGE72_HDMI_NTX1024TR0);
    ScalerSetBit(P72_CA_HDMI_DP, ~(_BIT5 | _BIT3), _BIT3);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3PowerSavingProc(void)
{
    ScalerTmdsMacRx3FreqDetectDisable();
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3SwitchHdcpSlaveAddr(void)
{
...
//                False --> TMDS Unstable
//--------------------------------------------------
bit ScalerTmdsMacRx3TMDSStableDetect(EnumSourceType enumSourceType)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    {
        DebugMessageRx3("HPD Toggle Event Occur!!", 0x00);
        CLR_TMDS_MAC_RX3_HPD_RESET_TO_SEARCH_EVENT();
        return _FALSE;
    }

    if(ScalerTmdsMacRx3CheckCDRStable(g_usTmdsMacRx3ClkCount) == _FALSE)
    {
        DebugMessageRx3("CDR Unstable!!", enumSourceType);
        return _FALSE;
    }
    ...
    {
        DebugMessageRx3("TMDS Clock Output has been disable", enumSourceType);
        return _FALSE;
    }
    ...
    if(ScalerGetBit(P72_00_HDMI_CTRL_00, _BIT0) == _BIT0)
    {
        ...
        {
            if(GET_TMDS_MAC_RX3_HDMI20_FORMAT_RESET_WAITING() == _FALSE)
            {
                ...
                else
                {
                    ...
                    {
                        DebugMessageRx3("TMDS Format Changed", enumSourceType);
    ...
    if(GET_TMDS_MAC_RX3_Z0_ASSERTED() == _TRUE)
    {
        // Hdcp1.4 normal check
        if((ScalerGetBit(P72_C0_HDCP_CR, _BIT0) == _BIT0) && (GET_TMDS_MAC_RX3_BACKUP_HDCP_TYPE() == _HDCP_14))
        {
            ...
            {
                SET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT(_TMDS_MAC_RX_HPD_NORMAL);

                CLR_TMDS_MAC_RX3_Z0_ASSERTED();
...
#if(_HDMI_UNSTABLE_BED_CHECK_SUPPORT == _ON)
    if(GET_TMDS_MAC_RX3_BED_ERROR() == _TRUE)
    {
        CLR_TMDS_MAC_RX3_BED_ERROR();

        DebugMessageRx3("BED Check Error", 0);
    ...
    {
        if(GET_TMDS_MAC_RX3_RGBHV_DETECTING() == _FALSE)
        {
            // TMDS Video Detected
#if(_DVI_DE_ONLY_SUPPORT == _OFF)
            if(ScalerTmdsMacRx3TMDSVideoDetect(_NOT_WAIT) != _TMDS_VIDEO_DATA_RGBHV)
#else
            if(ScalerTmdsMacRx3TMDSVideoDetect(_NOT_WAIT) == _TMDS_VIDEO_DATA_NONE)
#endif
            {
                DebugMessageRx3("TMDS Video format changed", enumSourceType);
    ...
    {
#if(_HDMI_ADVANCED_HDR10_SUPPORT_MODE != _ADVANCED_HDR10_NONE)
        if((GET_ADVANCED_HDR10_METADATA_SUPPORT() == _ADVANCED_HDR10_SUPPORT_ON) && (GET_ADVANCED_HDR10_INITIAL_READY() == _TRUE) && (GET_TMDS_MAC_RX3_ADVANCED_HDR10_DETECTING() == _FALSE))
        {
            bit bAdvancedHDR10VSIFReceive = GET_TMDS_MAC_RX3_ADVANCED_HDR10_VSIF_RECEIVED();
            bit bAdvancedHDR10EMPReceive = _FALSE;

            if(bAdvancedHDR10VSIFReceive == _TRUE)
            {
                CLR_TMDS_MAC_RX3_ADVANCED_HDR10_VSIF_RECEIVED();
            }
            else
            {
...
#if(_HDMI_ADVANCED_HDR10_SUPPORT_MODE == _ADVANCED_HDR10_VSIF_AND_DHDR_MODE)
            bAdvancedHDR10EMPReceive = GET_TMDS_MAC_RX3_DHDR_EMP_TYPE40_RECEIVED();
            if(bAdvancedHDR10EMPReceive == _TRUE)
            {
                CLR_TMDS_MAC_RX3_DHDR_EMP_TYPE40_RECEIVED();
            }
            else
            {
            ...
            if((bAdvancedHDR10VSIFReceive == _TRUE) || (bAdvancedHDR10EMPReceive == _TRUE))
            {
                ...
                ScalerTimerActiveTimerEvent(GET_ADVANCED_HDR10_METADATA_DETECT_TIME(), _SCALER_TIMER_EVENT_RX3_HDMI_ADVANCED_HDR10_DETECT);

                SET_TMDS_MAC_RX3_ADVANCED_HDR10_DETECTING();
            }
        }
#endif
        ...
        if((GET_TMDS_MAC_RX3_DM_INFO_DETECTING() == _FALSE) && (ScalerDMGetMetadataSupport(enumMappingPort) == _TRUE))
        {
            if((GET_TMDS_MAC_RX3_DM_EMP_RECEIVED() == _TRUE) || (GET_TMDS_MAC_RX3_DM_VSIF_RECEIVED() == _TRUE))
            {
                CLR_TMDS_MAC_RX3_DM_EMP_RECEIVED();
                CLR_TMDS_MAC_RX3_DM_VSIF_RECEIVED();

                // when continually receive, TimerEvent to detect DM (only VSIF/EMP -> No VSIF/EMP transition)
                ScalerTimerActiveTimerEvent(100, _SCALER_TIMER_EVENT_RX3_HDMI_DM_DETECT);

                SET_TMDS_MAC_RX3_DM_INFO_DETECTING();
            }
            else
            {
        ...
        if(GET_TMDS_MAC_RX3_HDMI_PACKET_DETECTING() == _FALSE)
        {
            // HDMI Packet Detected
            ScalerTmdsMacRx3HdmiPacketDetect(_NOT_WAIT);

#if(_HDMI_3D_VIDEO_IDENTIFY_SUPPORT == _ON)
            // PRIORITY TOP to check 3D Video format if HDMI or HF VSIF from 1->0
            if((GET_TMDS_MAC_RX3_HDMI_VSIF_RECEIVED() == _FALSE) && (GET_TMDS_MAC_RX3_HF_VSIF_RECEIVED() == _FALSE))
            {
                CLR_TMDS_MAC_RX3_HDMI_3D_VIDEO_VALID();
            }

            if(GET_TMDS_MAC_RX3_HDMI_VSIF_RECEIVED() == _TRUE)
            {
                CLR_TMDS_MAC_RX3_HDMI_VSIF_RECEIVED();
            }
#endif

            if(GET_TMDS_MAC_RX3_HF_VSIF_RECEIVED() == _TRUE)
            {
                CLR_TMDS_MAC_RX3_HF_VSIF_RECEIVED();
            }
            else
            {
#if(_HDMI21_ALLM_SUPPORT == _ON)
            ...
            if(GET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED() == _TRUE)
            {
                if(ScalerTmdsMacRx3HdmiColorInfoChanged() == _TRUE)
                {
                    DebugMessageRx3("Color Info Changed", enumSourceType);
                    return _FALSE;
                }

                if(ScalerTmdsMacRx3HdmiAviPixelRepInfoChanged() == _TRUE)
                {
                    DebugMessageRx3("Pixel Repetition Info Changed", enumSourceType);
                    return _FALSE;
                }
            }
            else
            {
                if(GET_COLOR_SPACE(enumMappingPort) != _COLOR_SPACE_RGB)
                {
                    DebugMessageRx3("HDMI Info Frame Not Received and not RGB", enumSourceType);
                    return _FALSE;
                }
                ...
                {
                    DebugMessageRx3("No Quantization Range Specified", enumSourceType);
                    return _FALSE;
                }
#endif

                if(GET_TMDS_MAC_RX3_AVI_PIXEL_REPETITION() != _AVI_PIXEL_REPETITION_0)
                {
                    DebugMessageRx3("Pixel Repetition Not Received and not Pixel repetition 0", enumSourceType);
                    return _FALSE;
                }
            }
            ...
            if(GET_DIGITAL_COLOR_INFO_CHANGE_RESET() == _TRUE)
            {
                ...
                {
                    DebugMessageRx3("HDMI AVI info frame has changed", enumSourceType);
                    return _FALSE;
                }
            }
            ...
            if(GET_TMDS_MAC_RX3_HDMI_GCP_RECEIVED() == _TRUE)
            {
                if((GET_COLOR_SPACE(enumMappingPort) != _COLOR_SPACE_YCBCR422) && (ScalerTmdsMacRx3HdmiGetColorDepth() != GET_COLOR_DEPTH(enumMappingPort)))
                {
                    DebugMessageRx3("Color Depth Has Changed", GET_COLOR_DEPTH(enumMappingPort));
                    return _FALSE;
                }
            }
            else
            {
                ...
                {
                    DebugMessageRx3("HDMI GCP PACKET Not Received and not 8 bit", enumSourceType);
                    return _FALSE;
                }
            }
        ...
        {
            // EMP Packet Detect
            ScalerTmdsMacRx3EmpPacketDetect(_NOT_WAIT);

#if(_HDMI21_VRR_SUPPORT == _ON)
            if((GET_TMDS_MAC_RX3_HDMI21_VTEM_RECEIVE_CHG() == _TRUE) && (GET_TMDS_MAC_RX3_HDMI21_VTEM_RECEIVED() == _TRUE))
            {
                DebugMessageRx3("Tmds Rx3: VTEM from NA(or MLDS) to received", 0x00);
                CLR_TMDS_MAC_RX3_HDMI21_VTEM_RECEIVE_CHG();
            ...
            {
                // FVA factor change
                if(GET_TMDS_MAC_RX3_HDMI21_FVA_FACTOR() != (ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_FVA_FACTOR_M1) + 1))
                {
                    return _FALSE;
                }
            }
    ...
    if(GET_TMDS_MAC_RX3_TOGGLE_Z0() == _TRUE)
    {
        SET_TMDS_MAC_RX3_TOGGLE_Z0_EVENT();
    ...
    {
        if(GET_TMDS_MAC_RX3_PS_WAKEUP() == _TRUE)
        {
            CLR_TMDS_MAC_RX3_PS_WAKEUP();

            SET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT(_TMDS_MAC_RX_HPD_EIZO_PS_WAKEUP);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3FreqDetectClkGating(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3HDMI2HPDRRIRQEnable(bit bEnable)
{
    if(bEnable == _ENABLE)
    {
        ...
        ScalerSetBit(P72_23_HDMI_CTRL_23, ~(_BIT6 | _BIT1), _BIT6);

        // Write 1 Clear Read Request
        ScalerSetByte(P72_25_HDMI_CTRL_25, _BIT3);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3ScrambleStatusReset(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3ScrambleDetectTimeoutTimerEvent(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3ScrambleDetectDisable(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3SetScdcInfo(void)
{
    // Set SCDC Info
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3SetCedLockTransition(bit bEnable)
{
    if(bEnable == _ENABLE)
    {
        ...
        ScalerSetBit(P72_18_HDMI_CTRL_18, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1 | _BIT0));

        // Enable Character Error Detection Function & Valid Flag
        ScalerSetBit(P72_0B_HDMI_CTRL_0B, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2));
    }
    else
    {
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3SetAmdAupiScdcInfo(bit bEnable)
{
    ...
    if(bEnable == _ENABLE)
    {
        ...
        ScalerSetDataPortByte(P72_39_HDMI_CTRL_39, _P72_3A_PT_E6_PORT_PAGE72_HDMI_SCDC_E6, g_stDrrHdmiAmdAupiInfo.ucScalerDeviceIdL);
        ScalerSetDataPortByte(P72_39_HDMI_CTRL_39, _P72_3A_PT_E7_PORT_PAGE72_HDMI_SCDC_E7, g_stDrrHdmiAmdAupiInfo.ucScalerDeviceIdM);

        DebugMessageRx3("Set Rx3 AMD AUPI SCDC Info", 0x00);
    }
    else
    {
        // Set SCDC Info
        ...
        ScalerSetDataPortByte(P72_39_HDMI_CTRL_39, _P72_3A_PT_E6_PORT_PAGE72_HDMI_SCDC_E6, 0x00);
        ScalerSetDataPortByte(P72_39_HDMI_CTRL_39, _P72_3A_PT_E7_PORT_PAGE72_HDMI_SCDC_E7, 0x00);
    }
}
#endif
#endif
...
//--------------------------------------------------
bit ScalerTmdsMacRx3CheckSeamlessCondition(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    switch(GET_COLOR_SPACE(enumMappingPort))
    {
        ...
        case _COLOR_SPACE_YCBCR444:
            ...
            if(ScalerGetDataPortBit(P72_D0_HDMI_PSAP2, 0x42, (_BIT3 | _BIT2 | _BIT1 | _BIT0)) < 0x05)
            {
                return _TRUE;
            }
...
//--------------------------------------------------
EnumSourceType ScalerTmdsMacRx3SeamlessReset(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    ...
    DebugMessageRx3("===== TMDS Rx3 SDR_DM Seamless flow =====", 0x00);
    ...
    if(GET_TMDS_MAC_RX3_PHY_SET() == _TRUE)
    {
        ...
        if(ScalerTmdsMacRx3FormatDetect() == _SOURCE_HDMI)
        {
        ...
        ucTMDSVideoDataType = ScalerTmdsMacRx3TMDSVideoDetect(_WAIT);
        ...
        if(enumSourceType == _SOURCE_HDMI)
        {
            ...
            ScalerTmdsMacRx3EmpPacketDetect(_NOT_WAIT);
#endif
            ScalerTmdsMacRx3HdmiVideoSetting();

            SET_COLOR_DEPTH(enumMappingPort, ScalerTmdsMacRx3HdmiGetColorDepth());

            // Precheck for (422, 12bpc) <-> (RGB, 8bpc) case
            if(ScalerTmdsMacRx3CheckSeamlessCondition() == _FALSE)
            {
                DebugMessageRx3("TMDS Rx3: NOT Seamless condition", 0x00);
                return _SOURCE_NONE;
            }
               ...
               (GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR420))
            {
                ...
                DebugMessageRx3("Color Depth", GET_COLOR_DEPTH(enumMappingPort));
                ...
                ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_80_PORT_PAGE72_HDMI_DPC_SET0, ~_BIT7, 0x00);

                if(ScalerTmdsMacRx3HdmiDeepColorProc(g_usTmdsMacRx3ClkCount) == _FALSE)
                {
...
// Output Value : None
//--------------------------------------------------
bit ScalerTmdsMacRx3HdmiSetDeepColorPll(WORD usTMDSClkCount, BYTE ucColorDepth)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
...
#if(((_HDMI20_MAC_RX3_SUPPORT == _ON) && (_HDMI20_YCBCR420_SUPPORT == _ON)) || (_3DDI_FUNCTION == _ON))
    BYTE ucRatio = 1;
#endif
...
#if(_3DDI_FUNCTION == _ON)
    // Check 2x clk need?
    if(ScalerTmdsMacRx3GetInterlace3ddiAvailable() == _TRUE)
    {
        ucRatio = 2;
    }
#endif
    ...
    DebugMessageRx3("usTMDSClkCount", usTMDSClkCount);
    ...
    DebugMessageRx3("Pre-Divider", ucPreDiv);
    ...
    DebugMessageRx3("N code", ucNcode);
    ...
    else
    {
        ...
        if(ucOutputDiv == 0)
        {
            ucOutputDiv = 1;
            ucNcode *= 2;
            DebugMessageRx3("Modify N x2 due to OutputDiv 0", ucNcode);
        }
    }
#else
    ucOutputDiv = ucNcode / 8 * ucColorDepth / ucPreDiv;
    ...
    DebugMessageRx3("Outpur Divider", ucOutputDiv);
    ...
    ScalerSetBit(P68_C2_PLL_IN_CONTROL, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));

    // Interger PLL
    ScalerSetBit(P68_C6_M2PLL_1, ~_BIT2, _BIT2);

    // Bypass PI
    ScalerSetBit(P2E_BC_SDM_0, ~_BIT7, _BIT7);
    ...
    if(ucNcode == 16)
    {
        ...
        ScalerSetByte(P2E_B6_N_F_MAX, 16);
        ScalerSetByte(P2E_B7_N_F_MIN, 12);
    }
    else
    {
        // Max = 32 + 2 - 2(reg = actual Ncode - 2), Min = 32 - 2 - 2
        ScalerSetByte(P2E_B6_N_F_MAX, 32);
        ScalerSetByte(P2E_B7_N_F_MIN, 28);
    }

    ScalerTmdsMacRx3DPLLOffProc(usVCOFreq, ucPreDiv, ucOutputDiv, ucNcode);

    ScalerTmdsMacRx3DPLLOnProc(ucNcode);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx3DPLLOnProc(BYTE ucNcode)
{
    // Power On DPLL
    ...
    // Set N.F Code
    ScalerSetByte(P2E_B2_N_F_CODE_1, (ucNcode - 2));
    ScalerSetByte(P2E_B3_N_F_CODE_2, 0x00);
    ScalerSetByte(P2E_B4_N_F_CODE_3, 0x00);
    ScalerSetByte(P2E_B5_N_F_CODE_4, 0x00);

    // Set N.F Double Buffer
    ScalerSetBit(P2E_B1_N_F_CODE_0, ~_BIT0, _BIT0);

    // Wait for DPLL Stable (300us)
    DELAY_XUS(300);
}
#endif // End of #if((_HDMI_MAC_RX3_SUPPORT == _ON) || (_3DDI_FUNCTION == _ON))
...
// Output Value : NONE
//--------------------------------------------------
void ScalerTmdsMacRx3RDCCheck(void)
{
#if(_RDC_TEST_TYPE == _HDMI_RDC_TEST_TYPE_2_0) // HDMI 2.0 setting
    // DVI Mode
    ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_00_PORT_PAGE72_HDMI_SCR, ~(_BIT7 | _BIT6 | _BIT3), _BIT3);
...
//--------------------------------------------------
EnumSourceType ScalerTmdsMacRx3TMDSScanInputPort(EnumPortType enumPortType)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping(_RX3);
    EnumSourceType enumSourceType = _SOURCE_NONE;
    ...
    if(GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() != _TMDS_MAC_RX_HPD_NONE)
#else
    if((GET_TMDS_MAC_RX3_HPD_TRIGGER_EVENT() != _TMDS_MAC_RX_HPD_NONE) || (GET_HDMI_MAC_RX3_INTERFACE_SWITCHING() == _TRUE))
#endif
    {
        return _SOURCE_NONE;
    }
...
#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
    if((ScalerGetBit(P2E_40_HDCP_2PX_ENCRYP_STS, (_BIT7 | _BIT6)) == _BIT7) && (GET_TMDS_HDCP2_RX3_AUTHENTICATION_DONE() != _TRUE) && (GET_TMDS_MAC_RX3_BACKUP_HDCP_TYPE() == _HDCP_22))
    {
        SET_TMDS_MAC_RX3_BACKUP_HDCP_TYPE(_HDCP_NONE);
    ...
    if(GET_TMDS_MAC_RX3_PHY_SET() == _TRUE)
    {
...
#if((_RDC_TEST_TYPE == _HDMI_RDC_TEST_TYPE_1_4) || (_RDC_TEST_TYPE == _HDMI_RDC_TEST_TYPE_2_0))
        ScalerTmdsMacRx3RDCCheck();
#endif

#if(_HDMI20_MAC_RX3_SUPPORT == _ON)
        if((ScalerTmdsMacRx3CheckCDRStable(g_usTmdsMacRx3ClkCount) == _FALSE) || (ScalerTmdsPhyRxCheckDFE(enumMappingPort) == _FALSE) || (ScalerTmdsMacRx3TMDSVideoDetect(_WAIT) == _TMDS_VIDEO_DATA_NONE))
#else
        if((ScalerTmdsMacRx3CheckCDRStable(g_usTmdsMacRx3ClkCount) == _FALSE) || (ScalerTmdsPhyRxCheckDFE(enumMappingPort) == _FALSE))
#endif
        {
            // Set Upper Bound
            ScalerSetByte(P72_E8_HDMI_FREQDET_UPPER_M, HIBYTE(_TMDS_FREQ_NORMAL_HIGH_SPEED_UPPER_BOUND));
            ...
            if((GET_TMDS_MAC_RX3_HIGH_SPEED_MODE() == _FALSE) && ((ScalerTmdsMacRxGetInputPixel(enumMappingPort) >= 850) && (ScalerTmdsMacRxGetInputPixel(enumMappingPort) <= 1500))) // HDMI mode
            {
        ...
        ScalerTmdsMacRx3ResetAllPacketReceiveStatus();

#if(_HDMI_MAC_RX3_SUPPORT == _ON)
        ScalerTmdsMacRx3RoundRobinIrqEnable(_ENABLE);
#endif
        // w1c interface flag
        ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_50_PORT_PAGE72_HDMI_VCR, ~(_BIT6 | _BIT5), (_BIT6 | _BIT5));
        ...
        DebugMessageRx3("9. Freq Check Pass => Pixel Clock", ScalerTmdsMacRxGetInputPixel(enumMappingPort));
        ...
        if(enumSourceType == _SOURCE_HDMI)
        {
            ...
            // HDMI packet detect --> AVI infoframe & GCP packet
            ScalerTmdsMacRx3HdmiPacketDetect(_WAIT);

#if(_HW_HDMI_EMP_SRAM_SUPPORT == _ON)
            // Active EMP SRAM
            ScalerTmdsMacRx3EmpSramSetting(_ENABLE);
#endif

#if((_HDMI21_VRR_SUPPORT == _ON) || (_HDMI21_FVA_SUPPORT == _ON) || (_HDMI_SBTM_SUPPORT == _ON))
            // Get EMP packet
            ScalerTmdsMacRx3EmpPacketDetect(_WAIT);
#endif

            if((ScalerTmdsPhyRxCheckDcdr(enumMappingPort) == _TRUE) && (ScalerTmdsMacRx3BchErrorCheck(enumMappingPort) == _TRUE))
            {
                return _SOURCE_NONE;
            }
...
#endif
            {
                ...
                SET_DRR_VFREQ_MAX(GET_HDMI_RX3_AMD_SPD_INFO(_SPD_INFO_FREESYNC_MAX_VFREQ) * 10);
...
#endif
            {
                ...
                if(GET_TMDS_MAC_RX3_HDMI21_VTEM_RECEIVED() == _TRUE)
                {
                    ...
                    if((GET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED() == _TRUE) && (ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_VIC) != 0x00))
                    {
                        usSourceBrr = ((WORD)ScalerTmdsMacRxGetVicVfreqParameter(ScalerTmdsMacRx3HdmiGetAVIInfo(_AVI_INFO_VIC)) * 10);
                        DebugMessageRx3("VRR BRR (AVI IF VIC)", usSourceBrr);
                    }
                    else if((GET_TMDS_MAC_RX3_HDMI_AVI_INFO_FRAME_RECEIVED() == _TRUE) && (ScalerTmdsMacRx3HdmiRsv6GetAviInfo(_AVI_INFO_FR) != 0x00))
                    {
                        usSourceBrr = (ScalerTmdsMacRxGetOvtVfreqParameter(ScalerTmdsMacRx3HdmiRsv6GetAviInfo(_AVI_INFO_FR)) * 10);
                        DebugMessageRx3("VRR BRR (AVI IF OVT)", usSourceBrr);
                    }
                    else if(ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_BASE_REFRESH_RATE) != 0x00)
                    {
                        usSourceBrr = ((WORD)ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_BASE_REFRESH_RATE) * 10);
                    ...
                    if(((bit)ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_VRR_EN)) == _ENABLE)
                    {
                        SET_TMDS_MAC_RX3_HDMI21_VRR_EN();
                        DebugMessageRx3("VRR_EN", 0x00);
                    }
                    else
                    {
                        CLR_TMDS_MAC_RX3_HDMI21_VRR_EN();
                        DebugMessageRx3("VRR_DIS", 0x00);
                    }

                    if(((bit)ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_QMS_EN)) == _ENABLE)
                    {
                        SET_TMDS_MAC_RX3_HDMI21_QMS_EN();
                        DebugMessageRx3("QMS_EN", 0x00);
                    }
                    else
                    {
                        CLR_TMDS_MAC_RX3_HDMI21_QMS_EN();
                        DebugMessageRx3("QMS_DIS", 0x00);
                    }
...
#if(_HDMI21_FVA_SUPPORT == _ON)
                    SET_TMDS_MAC_RX3_HDMI21_FVA_FACTOR(ScalerTmdsMacRx3HdmiGetVtemInfo(_HDMI21_VTEM_INFO_FVA_FACTOR_M1) + 1);
#endif
                    // Disable DE Only Mode
                    ScalerSetBit(P72_A7_TMDS_PWDCTL, ~_BIT7, 0x00);
                }
            ...
            if(GET_TMDS_RX3_FREESYNC_REPLAY_RECEIVED() == _TRUE)
            {
                ...
                ScalerSetBit(P72_D6_HDMI_SHDR_IE, ~_BIT4, _BIT4);
            }
#endif
        }
        else
        {
            ...
            ScalerTmdsMacRx3DviVideoSetting();

            SET_COLOR_DEPTH(enumMappingPort, _COLOR_DEPTH_8_BITS);

#if(_3DDI_FUNCTION == _ON)
            ScalerSetByte(P72_C9_HDMI_AP, _P72_CA_PT_50_PORT_PAGE72_HDMI_VCR);
            if((ScalerTimerPollingFlagProc(130, P72_CA_HDMI_DP, _BIT6, _TRUE) == _TRUE) && (ScalerTmdsMacRx3GetInterlace3ddiAvailable() == _TRUE))
            {
                // Disable DE Only Mode
                ScalerSetBit(P72_A7_TMDS_PWDCTL, ~_BIT7, 0x00);
...
#if(_HDMI_DPC_FIFO_ERR_CHECK_SUPPORT == _ON)
        if((ScalerGetBit(P72_B5_TMDS_UDC0, _BIT7) == _BIT7) && (ScalerTmdsMacRx3HdmiCheckDeepColorFifo() == _FALSE))
        {
            return _SOURCE_NONE;
        }
#endif
