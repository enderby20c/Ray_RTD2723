...
//----------------------------------------------------------------------------------------------------
// ID Code      : ScalerTmdsMacRx4_EXINT0.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __SCALER_TMDSMACRX4_EXINT0__
...
//--------------------------------------------------
BYTE ScalerTmdsMacRx4CheckCDRStable_EXINT0(WORD usClkCount)
{
    ...
    if(GET_TMDS_MAC_RX4_HIGH_SPEED_MODE() == _TRUE)
    {
        ...
        if(abs(usClkCount - ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_TMDS)) > (usClkCount >> 6))
        {
            return _FALSE;
        }

        if(abs(usClkCount - (ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_RED) * 4)) > (usClkCount >> 6))
        {
            return _FALSE;
        }

        if(abs(usClkCount - (ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_BLUE) * 4)) > (usClkCount >> 6))
        {
            return _FALSE;
        }

        if(abs(usClkCount - (ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_GREEN) * 4)) > (usClkCount >> 6))
        {
            return _FALSE;
        }
    }
...
#endif
    {
        ...
        if(abs(usClkCount - ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_RED)) > (usClkCount >> 6))
        {
            return _FALSE;
        }

        if(abs(usClkCount - ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_BLUE)) > (usClkCount >> 6))
        {
            return _FALSE;
        }

        if(abs(usClkCount - ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_GREEN)) > (usClkCount >> 6))
        {
            return _FALSE;
        }
    }
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4GetAdvancedHdr10Vsif_EXINT0(EnumHdmiRsvNumber enumRsvNumber, StructAdvancedHDR10MetaData *pstSyncAdvancedHDR10Metadata)
{
    ...
    // Get HDR10+ VSIF pkt
    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 1));
    pstSyncAdvancedHDR10Metadata->ucVersion = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);

    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 4));
    for(ucI = 0; ucI < 3; ucI++)
    {
        pstSyncAdvancedHDR10Metadata->pucOUICode[ucI] = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);
    }

    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 7));
    pstSyncAdvancedHDR10Metadata->ucTargetDisplayLv = ((ScalerGetByte_EXINT(P73_CE_HDMI_PSDP) & 0x3F) >> 1);

    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 13));
    pstSyncAdvancedHDR10Metadata->ucDistribution50 = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);

    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 17));
    pstSyncAdvancedHDR10Metadata->ucDistribution99 = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);

    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 21));
    for(ucI = 0; ucI < 9; ucI++)
    {
        pstSyncAdvancedHDR10Metadata->pucBezierAnchor[ucI] = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);
    }

    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 18));
    ucKp1 = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);
    ucKp2 = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);
    ucKp3 = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);
    ...
    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 30));
    pstSyncAdvancedHDR10Metadata->ucGraphicOverlayFlag = (ScalerGetByte_EXINT(P73_CE_HDMI_PSDP) >> 7);

    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, (ucRsvStartAddr + 30));
    pstSyncAdvancedHDR10Metadata->ucNoDelayFlag = ((ScalerGetByte_EXINT(P73_CE_HDMI_PSDP) & 0x40) >> 6);
}
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4GetDmVsif_EXINT0(EnumHdmiRsvNumber enumRsvNumber, BYTE *pucDmMetaData)
{
    BYTE ucRsvStartAddr = 0;
    BYTE ucMdOffset = 4;
    ...
    ScalerGetDataPortByte_EXINT0(P73_CD_HDMI_PSAP, ucRsvStartAddr, 27, pucDmMetaData, _AUTOINC);
}
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4AllmProc_EXINT0(EnumHdmiRsvNumber enumRsvNumber)
{
    bit bAllm = 0;
    ...
    {
        case _HDMI_RSV_0:
            ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x56);
            bAllm = (((ScalerGetByte_EXINT(P73_CE_HDMI_PSDP) & _BIT1) == _BIT1) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_1:
            ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x75);
            bAllm = (((ScalerGetByte_EXINT(P73_CE_HDMI_PSDP) & _BIT1) == _BIT1) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_2:
            ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x94);
            bAllm = (((ScalerGetByte_EXINT(P73_CE_HDMI_PSDP) & _BIT1) == _BIT1) ? _TRUE : _FALSE);
            break;

        case _HDMI_RSV_3:
            ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0xB3);
            bAllm = (((ScalerGetByte_EXINT(P73_CE_HDMI_PSDP) & _BIT1) == _BIT1) ? _TRUE : _FALSE);
            break;
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4CcbpcProc_EXINT0(EnumHdmiRsvNumber enumRsvNumber)
{
    BYTE ucCcbpcValue = 0;
    ...
    switch(enumRsvNumber)
    {
        case _HDMI_RSV_0:
            ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x56);
            ucCcbpcValue = (ScalerGetByte_EXINT(P73_CE_HDMI_PSDP) & 0xF0) >> 4;
            break;
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4HighPriorityIntHandler_EXINT0(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping_EXINT0(_RX4);
    BYTE pucBackUp[8];
    ...
    // Backup DFF #1 & #2
    pucBackUp[4] = ScalerGetByte_EXINT(P73_CD_HDMI_PSAP);
    pucBackUp[5] = ScalerGetByte_EXINT(P73_D0_HDMI_PSAP2);
    ...
    ScalerTmdsMacRx4ClearHighPriorityIrqFlag_EXINT0();
#endif
    ...
    if((ScalerGetByte_EXINT(P73_E6_HDMI_FREQDET_CTRL) & 0x06) == 0x06)
    {
        ...
        if((abs(g_usTmdsMacRx4ClkCount - ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_TMDS)) > (g_usTmdsMacRx4ClkCount >> 6)) ||
           (abs(ScalerTmdsMacRxGetInputPixel_EXINT0(enumMappingPort) - ((GET_TMDS_MAC_RX4_OFFLINE_MEASURE_CLK() << 3) / ((GET_COLOR_SPACE(enumMappingPort) == _COLOR_SPACE_YCBCR422) ? _COLOR_DEPTH_8_BITS : GET_COLOR_DEPTH(enumMappingPort)))) > (ScalerTmdsMacRxGetInputPixel_EXINT0(enumMappingPort) >> 6)))
        {
            ...
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_00_PORT_PAGE73_HDMI_SCR, ~(_BIT7 | _BIT6 | _BIT3), 0x00);
            ...
            if(GET_TMDS_MAC_RX4_ACTIVE_TYPE_HPD_TOGGLING() == _FALSE)
#endif
            {
        ...
        if((bBedCheck == _TRUE) && (ScalerTmdsPhyRxCheckDcdr_EXINT0(enumMappingPort) == _TRUE))
        {
            ...
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_AF_PORT_PAGE73_HDMI_BED_FUNC_0, ~_BIT3, _BIT3);

            ScalerTimerWDActivateTimerEvent_EXINT0(90, _SCALER_WD_TIMER_EVENT_RX4_HDMI_UNSTABLE_BED_CHECK);
        }
#endif
    }
    ...
    if((ScalerGetBit_EXINT(P73_25_HDMI_CTRL_25, _BIT3) == _BIT3) && (ScalerGetBit_EXINT(P73_26_HDMI_CTRL_26, _BIT3) == _BIT3))
    {
        ...
        ScalerSetByte_EXINT(P73_25_HDMI_CTRL_25, _BIT3);

        // Set Read Request Enable
        SET_TMDS_MAC_RX4_HDMI20_RR_ENABLE();

        // Enable Test Read Request HW Auto Mode
        ScalerSetBit_EXINT(P73_1C_HDMI_CTRL_1C, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT1), _BIT1);
    ...
    if((ScalerGetBit_EXINT(P73_17_HDMI_CTRL_17, _BIT2) == _BIT2) && (ScalerGetBit_EXINT(P73_18_HDMI_CTRL_18, _BIT2) == _BIT2))
    {
        ...
        ScalerSetBit_EXINT(P73_17_HDMI_CTRL_17, ~(_BIT6 | _BIT2 | _BIT1 | _BIT0), _BIT2);
    ...
    {
        // Clear Lock Transition Flag
        ScalerSetBit_EXINT(P73_17_HDMI_CTRL_17, ~(_BIT6 | _BIT2 | _BIT1 | _BIT0), _BIT1);
    ...
    {
        // Clear Lock Transition Flag
        ScalerSetBit_EXINT(P73_17_HDMI_CTRL_17, ~(_BIT6 | _BIT2 | _BIT1 | _BIT0), _BIT0);
    ...
    if((ScalerGetBit_EXINT(P73_1F_HDMI_CTRL_1F, _BIT3) == _BIT3) && (ScalerGetBit_EXINT(P73_1C_HDMI_CTRL_1C, _BIT7) == _BIT7))
    {
        ...
        ScalerSetBit_EXINT(P73_1C_HDMI_CTRL_1C, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), _BIT7);

        // Read Request Outcome Processing
        ScalerTmdsMacRx4ReadRequestProc_EXINT0(ScalerGetByte_EXINT(P73_1C_HDMI_CTRL_1C) & 0x70);
    }
    ...
    if(ScalerGetBit_EXINT(P73_23_HDMI_CTRL_23, (_BIT6 | _BIT1)) == (_BIT6 | _BIT1))
    {
        ...
        if(ScalerGetBit_EXINT(P73_23_HDMI_CTRL_23, (_BIT2 | _BIT0)) == 0x00)
        {
            ...
            ScalerSetBit_EXINT(P73_1C_HDMI_CTRL_1C, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT1), 0x00);
            ...
            if((bit)ScalerTmdsMacRx4CheckCDRStable_EXINT(g_usTMDSRx4ClkCount) == _TRUE)
            {
                // Disable Rising to Falling IRQ, Set IRQ Status Falling to Rising edge IRQ
                ScalerSetBit_EXINT(P73_23_HDMI_CTRL_23, ~(_BIT6 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
...
#endif // End of #if(_HDMI20_MAC_RX4_SUPPORT == _ON)
    ...
    ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, pucBackUp[4]);
    ScalerSetByte_EXINT(P73_D0_HDMI_PSAP2, pucBackUp[5]);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4LowPriorityIntHandler_EXINT0(void)
{
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping_EXINT0(_RX4);
    WORD usCount = 0;
    BYTE pucBackUp[8];
#if((_HDMI_MAC_RX4_SUPPORT == _ON) & (_AUDIO_SUPPORT == _ON) & (_AUDIO_MANUAL_SAMPLING_FREQ_SUPPORT == _OFF))
...
#if(_HW_HDMI_IRQ_PRIORITY_MODE == _HDMI_IRQ_OLD_MODE)
    ScalerTmdsMacRx4ClearLowPriorityIrqFlag_EXINT0();
#endif
    ...
    if((ScalerGetByte_EXINT(P73_EF_HDMI_ERROR_TH) & 0xC0) == 0xC0)
    {
        ...
        // Disable NO CLK WD
        ScalerSetBit_EXINT(P73_B2_TMDS_DBB2, ~(_BIT5 | _BIT4), 0x00);
#endif
        ...
        {
            ScalerSetByte_EXINT(P73_39_HDMI_CTRL_39, _P73_3A_PT_20_PORT_PAGE73_HDMI_SCDC_20);

            if(ScalerGetBit_EXINT(P73_3A_HDMI_CTRL_3A, _BIT1) == _BIT1)
            {
        ...
        if(ScalerTmdsMacRxGetInputPixel_EXINT0(enumMappingPort) > 3000)
        {
            ...
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_28_PORT_PAGE73_HDMI_NTX1024TR0, ~_BIT6, _BIT6);
        }
        else
        {
            // Set Input Clock Measure Divider = /1
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_28_PORT_PAGE73_HDMI_NTX1024TR0, ~_BIT6, 0x00);
        }

        if((GET_TMDS_MAC_RX4_PHY_SET() == _FALSE) || ((bit)ScalerTmdsMacRx4CheckCDRStable_EXINT0(g_usTmdsMacRx4ClkCount) == _FALSE))
        {
            g_usTmdsMacRx4ClkCount = ScalerTmdsMacRx4MeasureClk_EXINT0(_CLK_SOURCE_TMDS);

            // If Measure Divider = /2 then CLK x 2
            ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_28_PORT_PAGE73_HDMI_NTX1024TR0);
            if((ScalerGetBit_EXINT(P73_CA_HDMI_DP, _BIT6) == _BIT6) && (g_usTmdsMacRx4ClkCount != 0))
            {
                // TMDS_OFFLine Measure FREQ(MHz) = GDI_CLK(MHz) * 1024 * 2 / g_usTMDSRx4ClkCount
                SET_TMDS_MAC_RX4_OFFLINE_MEASURE_CLK(((DWORD)(_GDIPHY_RX_GDI_CLK_KHZ * 1024) * 2 / 100) / g_usTmdsMacRx4ClkCount);
            }
            else if(g_usTmdsMacRx4ClkCount != 0)
            {
                // TMDS_OFFLine Measure FREQ(MHz) = GDI_CLK(MHz) * 1024 / g_usTMDSRx4ClkCount
                SET_TMDS_MAC_RX4_OFFLINE_MEASURE_CLK(((DWORD)(_GDIPHY_RX_GDI_CLK_KHZ * 1024) / 100) / g_usTmdsMacRx4ClkCount);
            }

#if(_HDMI20_MAC_RX4_SUPPORT == _ON)
            if(GET_TMDS_MAC_RX4_HIGH_SPEED_MODE() == _TRUE)
            {
                SET_TMDS_MAC_RX4_OFFLINE_MEASURE_CLK((GET_TMDS_MAC_RX4_OFFLINE_MEASURE_CLK() * 4));
            }
#endif
            ScalerTmdsPhyRxSetPhy_EXINT0(enumMappingPort);

#if(_TMDS_RETRY_SET_PHY_SUPPORT == _ON)
            if(GET_TMDS_MAC_RX4_RETRY_SET_PHY() == _FALSE)
            {
                ScalerTimerWDActivateTimerEvent_EXINT0(_TMDS_RETRY_SET_PHY_TIME, _SCALER_WD_TIMER_EVENT_RX4_TMDS_RETRY_SET_PHY);
            }
#endif
        ...
        ScalerSetBit_EXINT(P73_14_HDMI_CTRL_14, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (ScalerTmdsMacRxGetInputPixel_EXINT0(enumMappingPort) / 10) >> 8);
        ScalerSetByte_EXINT(P73_15_HDMI_CTRL_15, (ScalerTmdsMacRxGetInputPixel_EXINT0(enumMappingPort) / 10));

#if(_HDMI_FRL_MAC_RX4_SUPPORT == _ON)
        // Switch to HDMI 2.0 SCDC Module
        ScalerSetBit_EXINT(P73_31_HDMI_CTRL_31, ~_BIT7, 0x00);
#endif

        // Enable TMDS CED Function & Lock Transition
        ScalerTmdsMacRx4SetCedLockTransition_EXINT0(_ENABLE);
#endif
    }

#if((_HDMI_ADVANCED_HDR10_SUPPORT_MODE != _ADVANCED_HDR10_NONE) || (_DM_FUNCTION == _ON))
    // --- RSV0 Into IRQ ---
    ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_B5_PORT_PAGE73_HDMI_BED_FUNC_6);
    if((ScalerGetBit_EXINT(P73_CA_HDMI_DP, _BIT0) == _BIT0) && (ScalerGetBit_EXINT(P73_CC_HDMI_GPVS, _BIT5) == _BIT5))
    {
        ScalerSetByte_EXINT(P73_CC_HDMI_GPVS, _BIT5);

#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
        if(ScalerGetByte_EXINT(P73_F8_HDMI_RECEIVE_TAG_RSV0) == _SPD_INFO_TYPE)
        {
            ScalerTmdsMacRx4RsvSpdHandler_EXINT0(_HDMI_RSV_0);
        }
        else
#endif
        {
#if(_HDMI_VSIF_RCV_BY_RR == _ON)
            ScalerTmdsMacRx4RsvVsifHandler_EXINT0(_HDMI_RSV_0);
#endif
        }
    }
    ...
    // --- RSV1 Into IRQ ---
    ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_B5_PORT_PAGE73_HDMI_BED_FUNC_6);
    if((ScalerGetBit_EXINT(P73_CA_HDMI_DP, _BIT1) == _BIT1) && (ScalerGetBit_EXINT(P73_CC_HDMI_GPVS, _BIT6) == _BIT6))
    {
        ScalerSetByte_EXINT(P73_CC_HDMI_GPVS, _BIT6);

#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
        if(ScalerGetByte_EXINT(P73_F9_HDMI_RECEIVE_TAG_RSV1) == _SPD_INFO_TYPE)
        {
            ScalerTmdsMacRx4RsvSpdHandler_EXINT0(_HDMI_RSV_1);
        }
        else
#endif
        {
#if(_HDMI_VSIF_RCV_BY_RR == _ON)
            ScalerTmdsMacRx4RsvVsifHandler_EXINT0(_HDMI_RSV_1);
#endif
        }
    }
    ...
    // --- RSV2 Into IRQ ---
    ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_B5_PORT_PAGE73_HDMI_BED_FUNC_6);
    if(ScalerGetBit_EXINT(P73_CA_HDMI_DP, _BIT2) == _BIT2)
    {
        ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_00_PORT_PAGE73_HDMI_SCR);
        if(ScalerGetBit_EXINT(P73_CA_HDMI_DP, _BIT7) == _BIT7)
        {
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_00_PORT_PAGE73_HDMI_SCR, ~(_BIT7 | _BIT6), _BIT7);

#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
            if(ScalerGetByte_EXINT(P73_FA_HDMI_RECEIVE_TAG_RSV2) == _SPD_INFO_TYPE)
            {
                ScalerTmdsMacRx4RsvSpdHandler_EXINT0(_HDMI_RSV_2);
            }
            else
#endif
            {
#if(_HDMI_VSIF_RCV_BY_RR == _ON)
                ScalerTmdsMacRx4RsvVsifHandler_EXINT0(_HDMI_RSV_2);
#endif
            }
        }
    }
    ...
    // --- RSV3 Into IRQ ---
    ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_B5_PORT_PAGE73_HDMI_BED_FUNC_6);
    if(ScalerGetBit_EXINT(P73_CA_HDMI_DP, _BIT3) == _BIT3)
    {
        ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_00_PORT_PAGE73_HDMI_SCR);
        if(ScalerGetBit_EXINT(P73_CA_HDMI_DP, _BIT6) == _BIT6)
        {
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_00_PORT_PAGE73_HDMI_SCR, ~(_BIT7 | _BIT6), _BIT6);

#if(_HDMI_SPD_IF_RCV_BY_RR == _ON)
            if(ScalerGetByte_EXINT(P73_FB_HDMI_RECEIVE_TAG_RSV3) == _SPD_INFO_TYPE)
            {
                ScalerTmdsMacRx4RsvSpdHandler_EXINT0(_HDMI_RSV_3);
            }
            else
#endif
            {
#if(_HDMI_VSIF_RCV_BY_RR == _ON)
                ScalerTmdsMacRx4RsvVsifHandler_EXINT0(_HDMI_RSV_3);
#endif
            }
        }
    }
    ...
    if(ScalerGetBit_EXINT(P6D_70_EMP_VS, (_BIT7 | _BIT6)) == (_BIT7 | _BIT6))
    {
        if(ScalerGetByte_EXINT(P6D_7C_VS_ORG_ID) == _VENDOR_SPECIFIC)
        {
#if((_DM_FUNCTION == _ON) && (_HW_CPU32_IS_BOOT_CPU == _TRUE))
            ScalerTmdsMacRx4DMSetting_EXINT0(enumMappingPort);
#endif
        }
        else if(ScalerGetByte_EXINT(P6D_7C_VS_ORG_ID) == _HDMI21)
        {
#if(_HDMI_SBTM_SUPPORT == _ON)
            ScalerTmdsMacRx4SbtmSetting_EXINT0();
#endif
        }
    }
#endif
    ...
    if(ScalerGetBit_EXINT(P6D_71_EMP_DHDR, (_BIT7 | _BIT6)) == (_BIT7 | _BIT6))
    {
        bit bMldsEmp = _FALSE;

        BYTE ucI = 0x00;
        BYTE ucLegalDataSize = 0x00;
        BYTE ucMaxSize = ((ScalerGetBit_EXINT(P6D_88_HDMI_EMP_SRAM_CTRL0, _BIT4) == _BIT4) ? _HDMI_EMP_SRAM_DHDR_SIZE : _HDMI_EMP_SRAM_TOTAL_SIZE); // 7 Byte as 1 unit
        ...
        // w1c received flag
        ScalerSetBit_EXINT(P6D_71_EMP_DHDR, ~(_BIT6 | _BIT5 | _BIT4), _BIT6);

        // Read EMP SRAM Data
        for(ucI = 0; ucI < ucMaxSize; ucI++)
        {
            if(ScalerTmdsMacRx4GetEmpSramData_EXINT0((0x00 + ucI), pucEmpData) == _TRUE)
            {
                // PB0~6 (EMP Header)
                if(ucI == 0)
                {
        ...
        if(bMldsEmp == _FALSE)
        {
            ...
            {
                SET_TMDS_MAC_RX4_DHDR_EMP_TYPE40_RECEIVED();
    ...
    if(ScalerGetBit_EXINT(P73_CA_HDMI_DP, (_BIT3 | _BIT1)) == (_BIT3 | _BIT1))
    {
        ...
        if(ScalerGetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_03_PORT_PAGE73_HDMI_AFCR, _BIT6) == 0x00)
        {
            // Set X Value
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_32_PORT_PAGE73_HDMI_WDCR1, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));

            // Set Y Value
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_33_PORT_PAGE73_HDMI_WDCR2, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));

            // audio hw mode
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_03_PORT_PAGE73_HDMI_AFCR, ~_BIT6, _BIT6);

            // manual gain enable
            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_03_PORT_PAGE73_HDMI_AFCR, ~_BIT3, _BIT3);

            ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_9F_PORT_PAGE73_PRESET_AFSM_MOD, ~_BIT5, _BIT5);
        }
#endif
        ...
        ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_D0_PORT_PAGE73_HDMI_CMCR);
        ScalerSetBit_EXINT(P73_CA_HDMI_DP, ~(_BIT7 | _BIT5), _BIT7);

#if(_HDMI_AUDIO_SPREAD_PCODE_SUPPORT == _ON)
        // Disable P Code Spread
        ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_E2_PORT_PAGE73_P_SPREAD_0);
        ScalerSetBit_EXINT(P73_CA_HDMI_DP, ~_BIT7, 0x00);
#endif

        // Reload NF code
        ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_D0_PORT_PAGE73_HDMI_CMCR);
        ScalerSetBit_EXINT(P73_CA_HDMI_DP, ~_BIT5, _BIT5);
        ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_D0_PORT_PAGE73_HDMI_CMCR);
        ScalerSetBit_EXINT(P73_CA_HDMI_DP, ~_BIT5, 0x00);
        ...
        enumAudioFreq = ScalerGetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_8B_PORT_PAGE73_AUDIO_FREQ_RESULT, (_BIT3 | _BIT2 | _BIT1 | _BIT0));
        ...
        if(enumAudioFreq > GET_HDMI_RX4_SAMPLING_FREQ_LIMIT())
        {
            ...
            ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_30_PORT_PAGE73_HDMI_AVMCR);
...
#endif
        {
            ...
            ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_D0_PORT_PAGE73_HDMI_CMCR);
            ScalerSetBit_EXINT(P73_CA_HDMI_DP, ~(_BIT6 | _BIT5), 0x00);

            // Set S code User Define
            ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_D5_PORT_PAGE73_HDMI_SCAPR);
            ScalerSetByte_EXINT(P73_CA_HDMI_DP, ScalerAudioGetUserSamplingFreqSCode_EXINT0(_PORT_HDMI, GET_HDMI_RX4_TARGET_SAMPLING_FREQ()));

            ScalerTmdsMacRxSetAudioNfCode_EXINT0(_RX4);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4ClearHighPriorityIrqFlag_EXINT0(void)
{
    // Clear High Priority IRQ Pending Flag
    ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_60_PORT_PAGE73_HDMI_INTCR, ~(_BIT7 | _BIT3), _BIT3);
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4ClearLowPriorityIrqFlag_EXINT0(void)
{
    // Clear Low Priority IRQ Pending Flag
    ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_60_PORT_PAGE73_HDMI_INTCR, ~(_BIT7 | _BIT3), _BIT7);
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4PsClearHighPriorityIrqFlag_EXINT0(void)
{
    // Clear High Priority IRQ Pending Flag
    ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_60_PORT_PAGE73_HDMI_INTCR, ~(_BIT7 | _BIT3), _BIT3);
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4PsClearLowPriorityIrqFlag_EXINT0(void)
{
    // Clear High Priority IRQ Pending Flag
    ScalerSetDataPortBit_EXINT0(P73_C9_HDMI_AP, _P73_CA_PT_60_PORT_PAGE73_HDMI_INTCR, ~(_BIT7 | _BIT3), _BIT7);
}
...
//--------------------------------------------------
WORD ScalerTmdsMacRx4MeasureClk_EXINT0(BYTE ucMeasureClk)
{
    BYTE ucDelayCount = 0;
    WORD usClkCount = 0;
    BYTE ucBackUp = 0;
    ...
    SET_HDMI_RX4_OFF_MEASURE_RESET_EXINT();

    if(ucMeasureClk == _CLK_SOURCE_TMDS)
    {
        // Set ref clk = GDI clk & Switch TMDS Clk to be measure
        ScalerSetBit_EXINT(P73_AD_TMDS_CPS, ~(_BIT6 | _BIT4), (_BIT6 | _BIT4));
    }
    else
    {
        ...
        ScalerSetBit_EXINT(P73_AD_TMDS_CPS, ~(_BIT6 | _BIT4), _BIT4);
    }
    ...
    // Start Measure
    ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_28_PORT_PAGE73_HDMI_NTX1024TR0);
    ScalerSetBit_EXINT(P73_CA_HDMI_DP, ~(_BIT5 | _BIT3), _BIT3);
...
// Output Value : void
//--------------------------------------------------
void ScalerTmdsMacRx4RsvVsifHandler_EXINT0(EnumHdmiRsvNumber enumRsvNumber)
{
    ...
    switch(ulOui)
    {
        ...
        case _ADVANCED_HDR10_OUI:
            ...
            SET_TMDS_MAC_RX4_ADVANCED_HDR10_VSIF_RECEIVED();

            ScalerTmdsMacRx4GetAdvancedHdr10Vsif_EXINT0(enumRsvNumber, &stSyncAdvancedHDR10Metadata);
...
#if(_HDMI21_ALLM_SUPPORT == _ON)
            ScalerTmdsMacRx4AllmProc_EXINT0(enumRsvNumber);
#endif

#if(_HDMI21_CCBPC_SUPPORT == _ON)
            ScalerTmdsMacRx4CcbpcProc_EXINT0(enumRsvNumber);
#endif
            break;
#endif
        ...
        case ((_DM_OUI_0 << 16) | (_DM_OUI_1 << 8) | _DM_OUI_2):
            ...
            ScalerGetDataPortByte_EXINT0(P73_CD_HDMI_PSAP, ucStartAddr, 3, pucDmHb, _AUTOINC);

            if((pucDmHb[1] == 0x01) && ((pucDmHb[2] & 0x1F) == 0x1B))
            {
                ScalerTmdsMacRx4GetDmVsif_EXINT0(enumRsvNumber, pucDmMetaData);

                if(((pucDmMetaData[3] & (_BIT4 | _BIT3 | _BIT2 | _BIT1)) == _BIT1) && ((pucDmMetaData[3] & (_BIT0)) == _BIT0)) // VS10=1, LL=1
                {
                    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping_EXINT0(_RX4);

                    SET_TMDS_MAC_RX4_DM_VSIF_RECEIVED();
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4RsvSpdHandler_EXINT0(EnumHdmiRsvNumber enumRsvNumber)
{
    BYTE ucI = 0;
    BYTE ucVnCount = 0;
    ...
    {
        pucHdmiVenderName[ucVnCount] = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);
    }
       ...
       ((pucHdmiVenderName[0] == 'N') && (pucHdmiVenderName[1] == 'V') && (pucHdmiVenderName[2] == 'I') && (pucHdmiVenderName[3] == 'D')))
    {
        ...
        {
            case _HDMI_RSV_0:
                ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x5A);
                break;

            case _HDMI_RSV_1:
                ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x79);
                break;

            case _HDMI_RSV_2:
                ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x98);
                break;

            case _HDMI_RSV_3:
                ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0xB7);
                break;
        ...
        {
            g_stTmdsMacRx4SpdInfo.pucHdmiProductDescription[ucI] = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);
        }
    }
    ...
    else if((pucHdmiVenderName[0] == 0x1A) && (pucHdmiVenderName[1] == 0x00) && (pucHdmiVenderName[2] == 0x00) && (GET_TMDS_MAC_RX4_FS_VALUABLE() == _FALSE))
    {
        ...
        {
            case _HDMI_RSV_0:
                ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x51);
                break;

            case _HDMI_RSV_1:
                ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x70);
                break;

            case _HDMI_RSV_2:
                ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0x8F);
                break;

            case _HDMI_RSV_3:
                ScalerSetByte_EXINT(P73_CD_HDMI_PSAP, 0xAE);
                break;
        ...
        {
            g_stTmdsMacRx4SpdFsInfo.pucHdmiFreesyncInfo[ucI] = ScalerGetByte_EXINT(P73_CE_HDMI_PSDP);
        }
    }
#endif
}
...
//--------------------------------------------------
bit ScalerTmdsMacRx4GetEmpSramData_EXINT0(BYTE ucReadAddress, BYTE *pucEmpData)
{
    // Set read pointer & popup data
    ScalerSetByte_EXINT(P6D_80_HDMI_EMPAP0, ucReadAddress);
    ScalerSetBit_EXINT(P6D_80_HDMI_EMPAP0, ~_BIT7, _BIT7);

    if(ScalerGetBit_EXINT(P6D_89_HDMI_EMP_SRAM_CTRL1, _BIT3) == 0x00)
    {
        memcpy(pucEmpData, (volatile BYTE xdata *)P6D_81_HDMI_EMPDP0, 7);
        return _TRUE;
    }
    else
    {
        // [3] Read & Write happened at same time
        ScalerSetBit_EXINT(P6D_89_HDMI_EMP_SRAM_CTRL1, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT3);
        return _FALSE;
    }
}
#endif
...
// Output Value : Measured Clk Count
//--------------------------------------------------
WORD ScalerTmdsMacRx4OnMeasureClk_EXINT0(BYTE ucLane)
{
    BYTE ucCount = 0;
    WORD usClkCount = 0;

    // Change Measure Count  64=>3
    ScalerSetByte_EXINT(P73_EC_HDMI_FREQDET_STABLE, _BIT1);

    // Read Lane0 Result
    ScalerSetBit_EXINT(P73_E6_HDMI_FREQDET_CTRL, ~(_BIT7 | _BIT2), 0x00);
    ScalerTmdsPhyRxCdrMeasureClkSelect_EXINT0(ScalerTmdsMacRxRxDxMapping_EXINT0(_RX4), ucLane);
    ScalerSetBit_EXINT(P73_E6_HDMI_FREQDET_CTRL, ~(_BIT5 | _BIT2), _BIT5);
    ScalerSetBit_EXINT(P73_E6_HDMI_FREQDET_CTRL, ~(_BIT7 | _BIT2), _BIT7);
    ...
    for(ucCount = 0; ucCount <= 60; ucCount++)
    {
        ...
        if(ScalerGetBit_EXINT(P73_E6_HDMI_FREQDET_CTRL, _BIT6) == _BIT6)
        {
            ...
            usClkCount = ((DWORD)((WORD)(ScalerGetByte_EXINT(P73_ED_HDMI_FREQDET_RESULT_M) << 8) | ScalerGetByte_EXINT(P73_EE_HDMI_FREQDET_RESULT_L))*27 / 100);
            break;
        }
    }
...
//--------------------------------------------------
BYTE ScalerTmdsMacRx4SaveOnMeasureSettings_EXINT0(void)
{
    return ScalerGetByte_EXINT(P73_EC_HDMI_FREQDET_STABLE);
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4RestoreOnMeasureSettings_EXINT0(BYTE ucStableTimes)
{
    ScalerSetByte_EXINT(P73_EC_HDMI_FREQDET_STABLE, ucStableTimes);
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4ResetMacInput_EXINT0(void)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4PSHighPriorityIntHandler_EXINT0(void)
{
#if(_TMDS_HDMI20_SCDC_RR_CTS_SUPPORT == _ON)
    EnumInputPort enumMappingPort = ScalerTmdsMacRxRxDxMapping_EXINT0(_RX4);
#endif
...
#if(_HW_HDMI_IRQ_PRIORITY_MODE == _HDMI_IRQ_OLD_MODE)
    ScalerTmdsMacRx4PsClearHighPriorityIrqFlag_EXINT0();
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4PSLowPriorityIntHandler_EXINT0(void)
{
    BYTE pucBackUp[2];
...
#if(_HW_HDMI_IRQ_PRIORITY_MODE == _HDMI_IRQ_OLD_MODE)
    // Clear Low Priority IRQ Pending Flag
    ScalerTmdsMacRx4PsClearLowPriorityIrqFlag_EXINT0();
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4SbtmSetting_EXINT0(void)
{
    bit bTrueVsEmp = _FALSE;
    bit bSbtmSetTag = _FALSE;
    bit bMldsEmp = _FALSE;
    BYTE ucI = 0x00;
    BYTE ucMaxSize = ((ScalerGetBit_EXINT(P6D_88_HDMI_EMP_SRAM_CTRL0, _BIT4) == _BIT4) ? _HDMI_EMP_SRAM_VS_SIZE : _HDMI_EMP_SRAM_TOTAL_SIZE); // 7 Byte as 1 unit
    BYTE pucEmpData[7] = {0};

    // W1C received flag
    ScalerSetBit_EXINT(P6D_70_EMP_VS, ~(_BIT6 | _BIT5 | _BIT4), _BIT6);

    // Read EMP SRAM Data
    for(ucI = 0; ucI < ucMaxSize; ucI++)
    {
        if(ScalerTmdsMacRx4GetEmpSramData_EXINT0((0x28 + ucI), pucEmpData) == _TRUE)
        {
            // PB0~6 (EMP Header)
            if(ucI == 0)
            {
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4DMSetting_EXINT0(EnumInputPort enumMappingPort)
{
    ...
    {
        SET_TMDS_MAC_RX4_DM_EMP_RECEIVED();
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4ReadRequestProc_EXINT0(BYTE ucRROutCome)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4SetScdcInfo_EXINT0(void)
{
    // Set SCDC Info
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D0_PORT_PAGE73_HDMI_SCDC_D0, g_stTmdsMacRxScdcInfoSet.ucManufactureOuiL);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D1_PORT_PAGE73_HDMI_SCDC_D1, g_stTmdsMacRxScdcInfoSet.ucManufactureOuiM);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D2_PORT_PAGE73_HDMI_SCDC_D2, g_stTmdsMacRxScdcInfoSet.ucManufactureOuiH);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D3_PORT_PAGE73_HDMI_SCDC_D3, g_stTmdsMacRxScdcInfoSet.pucIdstring[0]);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D4_PORT_PAGE73_HDMI_SCDC_D4, g_stTmdsMacRxScdcInfoSet.pucIdstring[1]);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D5_PORT_PAGE73_HDMI_SCDC_D5, g_stTmdsMacRxScdcInfoSet.pucIdstring[2]);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D6_PORT_PAGE73_HDMI_SCDC_D6, g_stTmdsMacRxScdcInfoSet.pucIdstring[3]);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D7_PORT_PAGE73_HDMI_SCDC_D7, g_stTmdsMacRxScdcInfoSet.pucIdstring[4]);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D8_PORT_PAGE73_HDMI_SCDC_D8, g_stTmdsMacRxScdcInfoSet.pucIdstring[5]);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_D9_PORT_PAGE73_HDMI_SCDC_D9, g_stTmdsMacRxScdcInfoSet.pucIdstring[6]);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_DA_PORT_PAGE73_HDMI_SCDC_DA, g_stTmdsMacRxScdcInfoSet.pucIdstring[7]);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_DB_PORT_PAGE73_HDMI_SCDC_DB, g_stTmdsMacRxScdcInfoSet.ucHdmiHwVersion);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_DC_PORT_PAGE73_HDMI_SCDC_DC, g_stTmdsMacRxScdcInfoSet.ucHdmiFwVersionMajor);
    ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_DD_PORT_PAGE73_HDMI_SCDC_DD, g_stTmdsMacRxScdcInfoSet.ucHdmiFwVersionMinor);
}
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4SetCedLockTransition_EXINT0(bit bEnable)
{
    if(bEnable == _ENABLE)
    {
        // Clear CED Lock Transition Flag
        ScalerSetBit_EXINT(P73_17_HDMI_CTRL_17, ~(_BIT6 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1 | _BIT0));
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4SetAmdAupiScdcInfo_EXINT0(bit bEnable)
{
    ...
    {
        // Set SCDC Info
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E0_PORT_PAGE73_HDMI_SCDC_E0, g_stDrrHdmiAmdAupiInfo.ucPanelManufactureIdL);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E1_PORT_PAGE73_HDMI_SCDC_E1, g_stDrrHdmiAmdAupiInfo.ucPanelManufactureIdM);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E2_PORT_PAGE73_HDMI_SCDC_E2, g_stDrrHdmiAmdAupiInfo.ucPanelIdL);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E3_PORT_PAGE73_HDMI_SCDC_E3, g_stDrrHdmiAmdAupiInfo.ucPanelIdM);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E4_PORT_PAGE73_HDMI_SCDC_E4, g_stDrrHdmiAmdAupiInfo.ucFwCheckSumL);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E5_PORT_PAGE73_HDMI_SCDC_E5, g_stDrrHdmiAmdAupiInfo.ucFwCheckSumM);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E6_PORT_PAGE73_HDMI_SCDC_E6, g_stDrrHdmiAmdAupiInfo.ucScalerDeviceIdL);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E7_PORT_PAGE73_HDMI_SCDC_E7, g_stDrrHdmiAmdAupiInfo.ucScalerDeviceIdM);
    }
    else
    {
        // Set SCDC Info
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E0_PORT_PAGE73_HDMI_SCDC_E0, 0x00);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E1_PORT_PAGE73_HDMI_SCDC_E1, 0x00);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E2_PORT_PAGE73_HDMI_SCDC_E2, 0x00);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E3_PORT_PAGE73_HDMI_SCDC_E3, 0x00);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E4_PORT_PAGE73_HDMI_SCDC_E4, 0x00);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E5_PORT_PAGE73_HDMI_SCDC_E5, 0x00);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E6_PORT_PAGE73_HDMI_SCDC_E6, 0x00);
        ScalerSetDataPortByte_EXINT0(P73_39_HDMI_CTRL_39, _P73_3A_PT_E7_PORT_PAGE73_HDMI_SCDC_E7, 0x00);
    }
}
#endif
#endif
...
//--------------------------------------------------
bit ScalerTmdsMacRx4GetDMDramReceived_EXINT0(void)
{
    if(ScalerGetBit_EXINT(P73_D5_HDMI_RSV64_IE, _BIT2) == _BIT2)
    {
        // w1c RSV received bit
        ScalerSetBit_EXINT(P73_D5_HDMI_RSV64_IE, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT2);
        return _TRUE;
    }
    else
    {
...
// Output Value : None
//--------------------------------------------------
void ScalerTmdsMacRx4DMPacketReCheck_EXINT0(void)
{
    BYTE pucBackUp[8];
    ...
    if(ScalerGetBit_EXINT(P73_CA_HDMI_DP, _BIT7) == _BIT7)
    {
        ...
        if(ScalerGetBit_EXINT(P73_CA_HDMI_DP, (_BIT3 | _BIT1)) == (_BIT3 | _BIT1))
        {
            ...
            if(ScalerGetBit_EXINT(P73_CA_HDMI_DP, (_BIT3 | _BIT2 | _BIT1 | _BIT0)) == 0x00)
            {
                ...
                // Set S code User Define
                ScalerSetByte_EXINT(P73_C9_HDMI_AP, _P73_CA_PT_D5_PORT_PAGE73_HDMI_SCAPR);
                ScalerSetByte_EXINT(P73_CA_HDMI_DP, ScalerAudioGetUserSamplingFreqSCode_EXINT0(_PORT_HDMI, GET_HDMI_RX4_SAMPLING_FREQ_USER_DEFINE()));
