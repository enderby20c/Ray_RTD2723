...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_Series_DpPhyRx1_WDINT.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6952_SERIES_DPPHYRX1_WDINT__
...
// Output Value : None
//--------------------------------------------------
void ScalerDpPhyRx1RebuildPhy_WDINT(EnumDpLinkRate enumDpLinkRate)
{
    EnumInputPort enumInputPort = ScalerDpPhyRxRxDxMapping_WDINT(_RX1);
    ...
    if((ScalerTypeCRxGetPortCtrlType_WDINT(enumInputPort) == _TYPE_C_PORT_CTRL_EMBEDDED) && (ScalerTypeCRxGetPinAssignment_WDINT(enumInputPort) == _TYPE_C_PIN_ASSIGNMENT_D))
    {
        ...
        {
            ScalerDpPhyRx1RebuildPhyUnFlip2Lane_WDINT(enumDpLinkRate);
        }
        else
        {
            ScalerDpPhyRx1RebuildPhyFlip2Lane_WDINT(enumDpLinkRate);
        }
    }
    else
#endif
    {
        ScalerDpPhyRx1RebuildPhy4Lane_WDINT(enumDpLinkRate);
    }
}
...
// Output Value : None
//--------------------------------------------------
void ScalerDpPhyRx1RebuildPhy4Lane_WDINT(EnumDpLinkRate enumDpLinkRate)
{
...
// Output Value : None
//--------------------------------------------------
void ScalerDpPhyRx1RebuildPhyUnFlip2Lane_WDINT(EnumDpLinkRate enumDpLinkRate)
{
    enumDpLinkRate = enumDpLinkRate;
    /*
    EnumInputPort enumInputPort = ScalerDpPhyRxRxDxMapping_WDINT(_RX1);
...
// Output Value : None
//--------------------------------------------------
void ScalerDpPhyRx1RebuildPhyFlip2Lane_WDINT(EnumDpLinkRate enumDpLinkRate)
{
    enumDpLinkRate = enumDpLinkRate;
    /*
    EnumInputPort enumInputPort = ScalerDpPhyRxRxDxMapping_WDINT(_RX1);
