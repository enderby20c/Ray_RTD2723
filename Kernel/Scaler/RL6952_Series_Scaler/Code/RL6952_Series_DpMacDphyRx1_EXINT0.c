...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_Series_DpMacDphyRx1_EXINT0.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6952_SERIES_DPRX1_EXINT0__
...
//--------------------------------------------------
BYTE ScalerDpMacDphyRx1Tp1DecodeCheck_8b10b_EXINT0(BYTE ucDpLane)
{
    // Disable scramble
    ScalerSetBit_EXINT(PB0_07_SCRAMBLE_CTRL, ~_BIT5, _BIT5);

    // Enable TP1 Error Detect
    ScalerSetBit_EXINT(PB0_0B_BIST_PATTERN3, ~_BIT7, 0x00);
    ScalerSetBit_EXINT(PB0_0B_BIST_PATTERN3, ~_BIT7, _BIT7);

    // Lane Select
    ScalerSetBit_EXINT(PB0_08_BIST_PATTERN_SEL, ~(_BIT4 | _BIT3), (ucDpLane << 3));

    // Bist Method = Detect Non-control Data != 4A/B5
    ScalerSetBit_EXINT(PB0_08_BIST_PATTERN_SEL, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
    ScalerSetBit_EXINT(PB0_08_BIST_PATTERN_SEL, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));

    DELAY_5US_EXINT();

    if((((ScalerGetByte_EXINT(PB0_09_BIST_PATTERN1) & 0x7F) | ScalerGetByte_EXINT(PB0_0A_BIST_PATTERN2)) != 0x00) &&
       (((ScalerGetByte_EXINT(PB0_0B_BIST_PATTERN3) & 0x7F) | ScalerGetByte_EXINT(PB0_0C_BIST_PATTERN4)) == 0x00))
    {
...
// Output Value : TRUE/FALSE
//--------------------------------------------------
BYTE ScalerDpMacDphyRx1Tp2DecodeCheck_8b10b_EXINT0(EnumDpLane enumDpLane)
{
    ...
    {
        // eq_crc_ans = 0x22C
        ScalerSetByte_EXINT(PB0_15_EQ_CRC_4, 0x2C);
       ...
       (ScalerDpAuxRxTrainingPatternSet_EXINT0(enumInputPort) == _DP_TRAINING_PATTERN_3))
    {
        ...
        ScalerSetBit_EXINT(PB0_12_EQ_CRC_1, ~(_BIT7 | _BIT6), _BIT6);
        ScalerSetBit_EXINT(PB0_12_EQ_CRC_1, ~_BIT7, _BIT7);
        ...
        {
            for(g_ucDpMacDphyRx1Temp = 0; g_ucDpMacDphyRx1Temp <= 30; g_ucDpMacDphyRx1Temp++)
            {
        ...
        {
            for(g_ucDpMacDphyRx1Temp = 0; g_ucDpMacDphyRx1Temp <= 5; g_ucDpMacDphyRx1Temp++)
            {
                ucEQCRCStatus1 = ucEQCRCStatus1 & ScalerGetByte_EXINT(PB0_12_EQ_CRC_1);
            }
        }
        ...
        // Enable EQ-CRC and Clear EQ-CRC Status(+ K28.5)
        ScalerSetBit_EXINT(PB0_12_EQ_CRC_1, ~(_BIT7 | _BIT6), 0x00);
        ScalerSetBit_EXINT(PB0_12_EQ_CRC_1, ~_BIT7, _BIT7);
        ...
        g_ucDpMacDphyRx1EQCRC = (ucEQCRCStatus1 | ucEQCRCStatus2);

        ucTp2Result = g_ucDpMacDphyRx1EQCRC;
    }
    else
    {
        // Reset Error Count
...
#else
        // bist_seed = 0x00
        ScalerSetByte_EXINT(PB0_0D_BIST_SEED_0, 0x00);
        ...
        // Lane3
        ScalerSetBit_EXINT(PB0_08_BIST_PATTERN_SEL, ~(_BIT4 | _BIT3), (_BIT4 | _BIT3));
        if(((ScalerGetByte_EXINT(PB0_0B_BIST_PATTERN3) & 0x7F) | ScalerGetByte_EXINT(PB0_0C_BIST_PATTERN4)) == 0x00)
        {
            ucTp2Result = ucTp2Result | _BIT3;
        }

        // Lane2
        ScalerSetBit_EXINT(PB0_08_BIST_PATTERN_SEL, ~(_BIT4 | _BIT3), _BIT4);
        if(((ScalerGetByte_EXINT(PB0_0B_BIST_PATTERN3) & 0x7F) | ScalerGetByte_EXINT(PB0_0C_BIST_PATTERN4)) == 0x00)
        {
        ...
        // Lane1
        ScalerSetBit_EXINT(PB0_08_BIST_PATTERN_SEL, ~(_BIT4 | _BIT3), _BIT3);
        if(((ScalerGetByte_EXINT(PB0_0B_BIST_PATTERN3) & 0x7F) | ScalerGetByte_EXINT(PB0_0C_BIST_PATTERN4)) == 0x00)
        {
        ...
        // Lane0
        ScalerSetBit_EXINT(PB0_08_BIST_PATTERN_SEL, ~(_BIT4 | _BIT3), 0x00);
        if(((ScalerGetByte_EXINT(PB0_0B_BIST_PATTERN3) & 0x7F) | ScalerGetByte_EXINT(PB0_0C_BIST_PATTERN4)) == 0x00)
        {
...
// Output Value : TRUE/FALSE
//--------------------------------------------------
BYTE ScalerDpMacDphyRx1Tp1Detect_EXINT0(EnumDpLane enumDpLane)
{
    ...
    switch(enumDpLane)
    {
        case _DP_SCALER_LANE0:
            ...
            if(ScalerDpAuxRxGetCodingType_EXINT0(enumInputPort) == _CODING_TYPE_128B132B)
            {
                if(ScalerGetBit_EXINT(P1F_B4_TP1_DETECT_DP20_1, (_BIT4 | _BIT0)) == _BIT4)
                {
                    return _TRUE;
                }
            }
...
#endif
            {
                if(ScalerGetBit_EXINT(PB0_13_EQ_CRC_2, _BIT4) == _BIT4)
                {
                    return _TRUE;
                }
            }
        ...
        case _DP_SCALER_LANE1:
            ...
            if(ScalerDpAuxRxGetCodingType_EXINT0(enumInputPort) == _CODING_TYPE_128B132B)
            {
                if(ScalerGetBit_EXINT(P1F_B4_TP1_DETECT_DP20_1, (_BIT5 | _BIT1)) == _BIT5)
                {
                    return _TRUE;
                }
            }
...
#endif
            {
                if(ScalerGetBit_EXINT(PB0_13_EQ_CRC_2, _BIT5) == _BIT5)
                {
                    return _TRUE;
                }
            }
        ...
        case _DP_SCALER_LANE2:
            ...
            if(ScalerDpAuxRxGetCodingType_EXINT0(enumInputPort) == _CODING_TYPE_128B132B)
            {
                if(ScalerGetBit_EXINT(P1F_B4_TP1_DETECT_DP20_1, (_BIT6 | _BIT2)) == _BIT6)
                {
                    return _TRUE;
                }
            }
...
#endif
            {
                if(ScalerGetBit_EXINT(PB0_13_EQ_CRC_2, _BIT6) == _BIT6)
                {
                    return _TRUE;
                }
            }
        ...
        case _DP_SCALER_LANE3:
            ...
            if(ScalerDpAuxRxGetCodingType_EXINT0(enumInputPort) == _CODING_TYPE_128B132B)
            {
                if(ScalerGetBit_EXINT(P1F_B4_TP1_DETECT_DP20_1, (_BIT7 | _BIT3)) == _BIT7)
                {
                    return _TRUE;
                }
            }
...
#endif
            {
                if(ScalerGetBit_EXINT(PB0_13_EQ_CRC_2, _BIT7) == _BIT7)
                {
                    return _TRUE;
                }
            }
