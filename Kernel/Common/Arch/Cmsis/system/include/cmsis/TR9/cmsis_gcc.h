...
#define MCCTL2_DMEM0_NR         (_BIT16)            // Read write access to exported DMEM0 is non-re-ordered            (No-Config in MNT TR9)
#define MCCTL2_DMEM1_NR         (_BIT17)            // Read write access to exported DMEM1 is non-re-ordered            (No-Config in MNT TR9)
#define MCCTL2_L2CMASK_EN_WAY01 (0)                 // Runtime L2Cache reduction (00: enable way 0 ~ way 1)             (No-Config in MNT TR9)
#define MCCTL2_L2CMASK_EN_WAY03 (_BIT24)            // Runtime L2Cache reduction (01: enable way 0 ~ way3)              (No-Config in MNT TR9)
#define MCCTL2_L2CMASK_RESERVED (_BIT25)            // Runtime L2Cache reduction (10: Reserved)                         (No-Config in MNT TR9)
#define MCCTL2_L2CMASK_EN_WAY07 (_BIT25 | _BIT24)   // Runtime L2Cache reduction (11: enable way 0 ~ way 7) , default   (No-Config in MNT TR9)
...
/*
    https://wiki.realtek.com/display/PSPRSDK/RISC-V+(TR9)+Memory+Protection+Functions+Porting+on+FreeRTOS
*/
