...
/**************************************************************************//**
 * @file     core_kr0.h
 * @brief    CMSIS KR4 Core Peripheral Access Layer Header File
 * @version  V0.0.1
...
#ifndef __CORE_KR4_H_GENERIC
#define __CORE_KR4_H_GENERIC
...
/**
  \brief   Refresh 48bits KR4 Internal Timer MTIMECMP
  \details Refresh 48bits KR4 Internal Timer MTIMECMP
  \param [in]  None
  \return  None
...
/**
  \brief   Get Current 48bits KR4 Internal Timer Count Value
  \details Get Current 48bits KR4 Internal Timer Count Value(MTIME)
  \param [in]  None
...
__STATIC_INLINE void MTimer_Init(uint32_t cpu_ticks)
{
    ...
    // Enable KR4 Internal Timer Clk
    Scaler32SetBit(KR4_MTIME_CLK_EN_ADDR, ~_BIT18, _BIT18);
}
