...
#ifndef Device_RTK32_KR4_H      /* ToDo: replace '<Device>' with your device name */
#define Device_RTK32_KR4_H
...
#define KR4_MTIME_CLK_EN_ADDR           (0xA4001000)

#define KR4_KCPU_SW_INT0_CTRL_ADDR      (0xA4001410)
#define KR4_KCPU_SW_INT1_CTRL_ADDR      (0xA4001414)
#else
#define INT_PRIORITY_CTRL_BASE_ADDR     (0xA3000080)
#define INT_PENDING_STATUS_ADDR         (0xA3000040)
#define KR4_MTIME_CLK_EN_ADDR           (0xA3000000)
#endif
...
extern EnumCpuIrqPriority const tINTERRUPT_PRIORITY_KR4[];

#define GET_INT_PRIORITY(enumIRQnTypeIdx)       (tINTERRUPT_PRIORITY_KR4[enumIRQnTypeIdx])
...
#if(_HW_CPU32_IS_BOOT_CPU == _TRUE)
#define KR4_SW_INT0_CTRL_ADDR               KR4_KCPU_SW_INT0_CTRL_ADDR
#define KR4_SW_INT1_CTRL_ADDR               KR4_KCPU_SW_INT1_CTRL_ADDR
#else
#define KR4_SW_INT0_CTRL_ADDR               KR4_SCPU_SW_INT0_CTRL_ADDR
#define KR4_SW_INT1_CTRL_ADDR               KR4_SCPU_SW_INT1_CTRL_ADDR
#endif
#define SET_SW_INT0()                       {\
                                                Scaler32SetDWord(KR4_SW_INT0_CTRL_ADDR, 1);\
                                                Scaler32GetDWord(KR4_SW_INT0_CTRL_ADDR);\
                                            }
#define CLEAR_SW_INT0()                     {\
                                                Scaler32SetDWord(KR4_SW_INT0_CTRL_ADDR, 0);\
                                                Scaler32GetDWord(KR4_SW_INT0_CTRL_ADDR);\
                                            }

#define SET_SW_INT1()                       {\
                                                Scaler32SetDWord(KR4_SW_INT1_CTRL_ADDR, 1);\
                                                Scaler32GetDWord(KR4_SW_INT1_CTRL_ADDR);\
                                            }
#define CLEAR_SW_INT1()                     {\
                                                Scaler32SetDWord(KR4_SW_INT1_CTRL_ADDR, 0);\
                                                Scaler32GetDWord(KR4_SW_INT1_CTRL_ADDR);\
                                            }
...
#define KR4_DDR_CACHEABLE()                 (__csr_write(0x7C3, (__csr_read(0x7C3) & (0xFFFF0FFF))))
#define KR4_DDR_UNCACHEABLE()               (__csr_write(0x7C3, ((__csr_read(0x7C3) & (0xFFFF0FFF))|0x00008000)))
#define KR4_FLASH_CACHEABLE()               (__csr_write(0x7C3, (__csr_read(0x7C3) & (0xFFFFFFF0))))
#define KR4_FLASH_UNCACHEABLE()             (__csr_write(0x7C3, ((__csr_read(0x7C3) & (0xFFFFFFF0))|0x00000008)))

// SET KR4 DDR access always from align to 00 (this ic's DDR controller not support wrap mode access)
// The ZWF range is calculated with a range comparator and a mask.
// ZWF_RANGE[31:16] : HIGH_BITS, ZWF Range address high bits
// ZWF_RANGE[15:00] : MASK, ZWF Range address high bits mask
// The IsZwfRange returns if the address is in the ZWF range:
// bool IsZwfRange(uint address, uint ZWF_RANGE)
// {
//     return (ZWF_RANGE.MASK != 0) & ((address[31:16] & ZWF_RANGE.MASK) == (ZWF_RANGE.HIGH_BITS & ZWF_RANGE.MASK));
// }
#define DDR_ZWF_RANGE                       (0x6000F000)  // ZWF range = 6000_0000 ~ 6FFF_FFFF
#define KR4_DDR_ZERO_WORD_FIRST()           (CSR_SET_WITH_DSB(0x7E8, (DDR_ZWF_RANGE)))
...
// KR4 Internal Timer      0xE0000000  0xE0000013  20        CCA7,(0x8) Non-Cacheable   Default (R/W/X)         Default (R/W/X)
...
#if((_HW_CPU32_IS_BOOT_CPU == _TRUE) && (_HW_CPU32_MEMORYMAP_ACCESS_DDR == _TRUE))
#define PMP1CFG_VALUE                       (PMP_L | PMP_A_NAPOT | PMP_X | PMP_W | PMP_R)           // DDR_RAM_TEXT(X/R/W)
#else
#define PMP1CFG_VALUE                       (PMP_L | PMP_A_NAPOT | PMP_X | PMP_R)                   // DDR_RAM_TEXT(X/R)
#endif
#define PMP1ADDR_VALUE                      ((_KCPU_DDR_TEXT_BASE_ADDR / 4) | (0x001FFFFF >> 3))    // 0x6000_0000 ~ 0x601F_FFFF

#define PMP2CFG_VALUE                       (PMP_L | PMP_A_NAPOT | PMP_W | PMP_R)                   // DDR_RAM_DATA
#define PMP2ADDR_VALUE                      ((_KCPU_DDR_DATA_BASE_ADDR / 4) | (0x001FFFFF >> 3))    // 0x6020_0000 ~ 0x603F_FFFF

#define PMP3CFG_VALUE                       (PMP_L | PMP_A_TOR | PMP_W | PMP_R)                     // DDR_RAM_PROTECT
#define PMP3ADDR_VALUE                      (_KCPU_DDR_MAX_ADDR / 4)                                // 0x6040_0000 ~ 0x6FFF_FFFF
...
#define PMP5CFG_VALUE                       (PMP_L | PMP_A_TOR | PMP_X | PMP_W | PMP_R)                     // 32B REG (RBUS/RBUSD)
...
#define PMP7CFG_VALUE                       (PMP_L | PMP_A_NAPOT | PMP_W | PMP_R)                   // KR4 Internal Timer
#define PMP7ADDR_VALUE                      ((TIMER_BASE_ADDR / 4) | (0x000003FF >> 3))             // 0xE000_0000 ~ 0xE000_03FF

#if((_HW_CPU32_IS_BOOT_CPU == _TRUE) || defined(CPU32_BOOTLOADER))
...
// KR4 Default exception handlers.
