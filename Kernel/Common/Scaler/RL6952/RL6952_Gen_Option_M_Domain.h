...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_Gen_Option_M_Domain.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _HW_MEMORY_DEVICE_PLL_GEN_TYPE                          _MEMORY_DEVICE_PLL_GEN_4
...
#define _HW_MEMORY_DDR3_DPIDLL_GEN_TYPE                         _MEMORY_DDR3_DPIDLL_GEN_2
#define _HW_MEMORY_DDR3_GEN_TYPE                                _MEMORY_DDR3_GEN_2
#define _HW_MEMORY_DEVICE_MAX_COUNT                             1
...
//-------------------------------------------------
#define _HW_DISPLAY_ROTATION_TYPE                               _DISPLAY_ROTATION_GEN_IV

//-------------------------------------------------
// Display Rotation
//-------------------------------------------------
#define _HW_DISPLAY_ROTATION_90_SUPPORT                         _ON
#define _HW_DISPLAY_ROTATION_180_SUPPORT                        _ON
#define _HW_DISPLAY_ROTATION_270_SUPPORT                        _ON
...
// FB To EO
//-------------------------------------------------
#define _HW_FB2EO_HWIDTH_SETTING_TYPE                           _FB2EO_HWIDTH_SETTING_GEN_1
#define _HW_FB2EO_INDEPENDENT_OF_IMC_DEC                        _TRUE
...
#define _HW_M_DOMAIN_IMG_CMP_PATH_COUNT                         3

#define _HW_M_DOMAIN_IMG_CMP_ALL_PATH                           (_INPUT_PATH_M1_M2 | _INPUT_PATH_S1)
#define _HW_M_DOMAIN_IMG_DECMP_ALL_PATH                         (_MDOMAIN_DISP_PATH_M1_M2 | _MDOMAIN_DISP_PATH_S1)
...
#define _HW_MEMORY_BW_CTRL_GOSD_SUPPORT                         _OFF
...
//-------------------------------------------------
#define _FW_MEM_ROW_ADDR_SHIFT_BIT_NUM                          11
#define _FW_MEM_BANK_ADDR_SHIFT_BIT_NUM                         8
