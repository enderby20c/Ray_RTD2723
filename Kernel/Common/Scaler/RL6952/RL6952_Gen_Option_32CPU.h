...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6952_Gen_Option_32CPU.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
//--------------------------------------------------
...
#define _HW_CPU32_MEMORYMAP_ACCESS_DDR                          (_FALSE)
#define _HW_CPU32_ALLOCATE_DDR_SPACE                            (_FALSE)
#define _HW_CPU32_CACHED_DDR                                    (_FALSE)
...
//--------------------------------------------------
#define _FW_CPU32_DDR_MEMORY_SIZE                               (((DWORD)132) << _FW_MEM_ROW_ADDR_SHIFT_BIT_NUM) // 4M Byte: (4*1024^2*8) / (1024*8*32) = 128 row, Consider GOSD Use DDR Size
