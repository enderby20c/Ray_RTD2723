...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6829_Gen_Option_MCU.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _HW_ISP_SPEED_UP_SUPPORT                                _OFF
#define _HW_XRAM_BG_ISP_SPEED_UP_MAPPING_ADDR_START             (0x00000000) // Invaild Address for not use
#define _HW_ISP_SPEED_UP_SRAM_SIZE                              (0)
...
//--------------------------------------------------
#define _HW_MCU_SARADC_GEN                                      _HW_SARADC_GEN_0
...
// EPLL Option
//-------------------------------------------------
#define _HW_EPLL_SUPPORT                                        _ON// Confirm
...
// HW IIC Gen Options
//--------------------------------------------------
#define _HW_HW_IIC_GEN                                          _HW_IIC_GEN_1
...
//--------------------------------------------------
#define _HW_GPIO_PORT_18_1F_SUPPORT                             _ON
