...
#define _HW_FORMAT_CONVERSION_FB_SUPPORT                        _OFF
#define _HW_FORMAT_CONVERSION_PIXEL_MODE                        _OFF
#define _HW_FORMAT_CONVERSION_EO_MODE                           _OFF
#define _HW_FORMAT_CONVERSION_SD_MODE                           _FORMAT_CONVERSION_SD_HALF
#define _HW_FORMAT_CONVERSION_PATH1_SUPPORT                     _OFF
#define _HW_FORMAT_CONVERSION_PATH2_SUPPORT                     _ON
#define _HW_FORMAT_CONVERSION_PATH3_SUPPORT                     _OFF
#define _HW_FORMAT_CONVERSION_PATH4_SUPPORT                     _OFF
#define _HW_FORMAT_CONVERSION_PATH5_SUPPORT                     _OFF
#define _HW_FORMAT_CONVERSION_CLK_GATED_SUPPORT                 _ON
#define _HW_FORMAT_CONVERSION_EAGLE_SIGHT_SUPPORT               _OFF
#define _HW_FORMAT_CONVERSION_EO_MODE_BUFFER_WIDTH              (4096)
...
#define _HW_IDOMAIN_M2_ONLINE_MEASURE_SUPPORT                   _OFF
#define _HW_IDOMAIN_S1_ONLINE_MEASURE_SUPPORT                   _ON
#define _HW_IDOMAIN_S2_ONLINE_MEASURE_SUPPORT                   _OFF
...
//--------------------------------------------------
#define _HW_IDOMAIN_OFFLINE_MEASURE_CLK_DIV_SUPPORT             _OFF

//--------------------------------------------------
// Off-line measure Hstart support
//--------------------------------------------------
#define _HW_IDOMAIN_OFFLINE_HSTART_MEASURE_SUPPORT              _ON

//--------------------------------------------------
// off-line measure Vstart support
//--------------------------------------------------
#define _HW_IDOMAIN_OFFLINE_VSTART_MEASURE_SUPPORT              _ON
...
//--------------------------------------------------
#define _FW_FRL_MEASURE_FROM_INTERFACE                          _OFF
