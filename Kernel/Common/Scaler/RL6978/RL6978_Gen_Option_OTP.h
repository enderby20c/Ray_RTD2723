...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6978_Gen_Option_OTP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _HW_OTPFUSE_LVDS_IBHN_TRIMDATA_STR             1876
...
#define _HW_OTPFUSE_MST_DPTX_TRIMDATA_STR              1922
#define _HW_OTPFUSE_AUDIO_CORNER_CONFIG_STR            1923
#define _HW_OTPFUSE_TYPE_C_SARADC_TRIMDATA_STR         1928
#define _HW_OTPFUSE_PIN60_PIN61_1M_TRIMDATA_STR        1955
#define _HW_OTPFUSE_PACKAGE_TYPE_STR                   1957
#define _HW_OTPFUSE_DDCCI_I_SLAVE_ADDR_STR             1970
#define _HW_OTPFUSE_DDCCI_II_SLAVE_ADDR_STR            1973
...
#define _HW_OTPFUSE_LVDS_IBHN_TRIMDATA_LEN             1
...
#define _HW_OTPFUSE_MST_DPTX_TRIMDATA_LEN              1
#define _HW_OTPFUSE_AUDIO_CORNER_CONFIG_LEN            1
#define _HW_OTPFUSE_TYPE_C_SARADC_TRIMDATA_LEN         8
#define _HW_OTPFUSE_PIN60_PIN61_1M_TRIMDATA_LEN        1
#define _HW_OTPFUSE_PACKAGE_TYPE_LEN                   1
#define _HW_OTPFUSE_DDCCI_I_SLAVE_ADDR_LEN             3
#define _HW_OTPFUSE_DDCCI_II_SLAVE_ADDR_LEN            3
