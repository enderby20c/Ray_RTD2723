...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6978_Gen_Option_MCU.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _HW_XRAM_ISP_MAPPING_ADDR_START                         (0xA0100C00)

//--------------------------------------------------
// HW Fw Update Fw  Speed up Support
//--------------------------------------------------
#define _HW_ISP_SPEED_UP_SUPPORT                                _ON
#define _HW_XRAM_BG_ISP_SPEED_UP_MAPPING_ADDR_START             (0xA0100E00) // Invaild Address for not use
#define _HW_ISP_SPEED_UP_SRAM_SIZE                              (512U)

//--------------------------------------------------
// HW XRAM Reset Support
//--------------------------------------------------
#define _HW_XRAM_AUTO_RESET_TO_ZERO_SUPPORT                     _ON

//--------------------------------------------------
// Definitions of DDCRAM info
//--------------------------------------------------
#define _HW_DDCRAM_START_ADDRESS                                (0xA0100100)
#define _HW_DDCRAM_BLOCK_STEP                                   (768U)

//--------------------------------------------------
// DDC Exist
//--------------------------------------------------
#define _HW_ISP_DDC_EXIST                                       _ON
...
#define _HW_DDC4_EXIST                                          _OFF
#define _HW_DDC5_EXIST                                          _OFF
...
// DDC Mapping Switch
//--------------------------------------------------
#define _HW_DDC_CHANNEL_SWITCH_SUPPORT                          _OFF
...
//--------------------------------------------------
#define _HW_MCU_SARADC_GEN                                      _HW_SARADC_GEN_3
...
#define _HW_FLASH_4BYTE_MODE_SUPPORT                            _ON
...
#define _HW_EXTERNAL_SERIAL_PORT_2_EXIST                        _ON
...
//--------------------------------------------------
#define _HW_TX_HDCP_2_2_KEY_START_ADDRESS_IROM                  0xBFC05400
