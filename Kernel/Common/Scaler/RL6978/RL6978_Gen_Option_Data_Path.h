...
//--------------------------------------------------
#define _HW_I_DOMAIN_PATH_COUNT                                 2

#define _HW_I_DOMAIN_M1_PATH_SUPPORT                            _ON
#define _HW_I_DOMAIN_M2_PATH_SUPPORT                            _OFF
...
#define _HW_M_DOMAIN_M2_PATH_SUPPORT                            _OFF
...
#define _HW_I_DOMAIN_INPUT_PATH_ALL                             (_INPUT_PATH_M1 | _INPUT_PATH_S1)

//! all HW M-domain paths
#define _HW_M_DOMAIN_DISP_PATH_ALL                              (_MDOMAIN_DISP_PATH_M1 | _MDOMAIN_DISP_PATH_S1)
