...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6978_Gen_Option_DSC.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _HW_D_MAC_RX_DSC_MAPPING                                _DSC_MAC_NONE

//--------------------------------------------------
// HW DSC MAC Maximum Throughput (Unit is 0.1 M)
//--------------------------------------------------
#define _HW_DSC_MAC_DEC_MAX_BW                                  0
#define _HW_DSC_PLL_MAX_BOUNDARY                                0
...
//--------------------------------------------------
#define _HW_DSC_MAC_MAX_SLICE_CNT                               0
#define _HW_DSC_MAC_MAX_SLICE_WIDTH                             0
#define _HW_DSC_MAC_SLICE_MERGE_SUPPORT                         _OFF
...
#define _HW_TMDS_MAC_RX3_DSC_MAPPING                            _DSC_MAC_NONE
#define _HW_TMDS_MAC_RX4_DSC_MAPPING                            _DSC_MAC_NONE
#define _HW_TMDS_MAC_RX5_DSC_MAPPING                            _DSC_MAC_NONE

//--------------------------------------------------
// HW Input DP MAC MAPPING TO DSC
//--------------------------------------------------
#define _HW_DP_MAC_RX0_DSC_MAPPING                              _DSC_MAC_NONE
#define _HW_DP_MAC_RX1_DSC_MAPPING                              _DSC_MAC_NONE
#define _HW_DP_MAC_RX2_DSC_MAPPING                              _DSC_MAC_NONE
...
//--------------------------------------------------
#define _HW_DP_AUX_RX0_DSC_MAPPING                              _DSC_MAC_NONE
#define _HW_DP_AUX_RX1_DSC_MAPPING                              _DSC_MAC_NONE
#define _HW_DP_AUX_RX2_DSC_MAPPING                              _DSC_MAC_NONE
...
//--------------------------------------------------
#define _HW_DP_AUX_DPCD_DSC_SLICE_CAPABILITY                    0
