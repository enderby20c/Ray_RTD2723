...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6978_Gen_Option_GDI_PHY.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _HW_D1_TMDS_PHY_RX_MAPPING                              _MAPPING_RX3
#define _HW_D2_TMDS_PHY_RX_MAPPING                              _MAPPING_RX3
#define _HW_D3_TMDS_PHY_RX_MAPPING                              _MAPPING_RX3
#define _HW_D4_TMDS_PHY_RX_MAPPING                              _MAPPING_RX_MAP_NONE
...
#define _HW_D1_HDMI21_PHY_RX_MAPPING                            _MAPPING_RX3
#define _HW_D2_HDMI21_PHY_RX_MAPPING                            _MAPPING_RX3
#define _HW_D3_HDMI21_PHY_RX_MAPPING                            _MAPPING_RX3
#define _HW_D4_HDMI21_PHY_RX_MAPPING                            _MAPPING_RX_MAP_NONE
...
#define _HW_D2_DP_PHY_RX_MAPPING                                _MAPPING_RX1
...
#define _HW_D7_DP_PHY_RX_MAPPING                                _MAPPING_RX_MAP_NONE
#define _HW_D8_DP_PHY_RX_MAPPING                                _MAPPING_RX_MAP_NONE
...
#define _HW_USB3_REPEATER_D1_TO_UFP_PHY_MAPPING                 _USB3_REPEATER_UFP_PHY_NONE
...
//--------------------------------------------------
#define _HW_DP_RX_PHY_TO_MAC_INTERFACE                          _DP_RX_16_BIT
