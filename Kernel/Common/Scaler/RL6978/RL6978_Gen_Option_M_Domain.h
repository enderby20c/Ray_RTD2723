...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6978_Gen_Option_M_Domain.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define _HW_MEMORY_DEVICE_PLL_GEN_TYPE                          _MEMORY_DEVICE_PLL_GEN_0

//--------------------------------------------------
// Select Fifo Frequency Reference Clk
//--------------------------------------------------
#define _HW_FIFO_FREQ_LINE_BUFFER_SEL                           _SCALER_FIFO_FREQ_DDRPLL
#define _HW_FIFO_FREQ_FRAME_BUFFER_SEL                          _SCALER_FIFO_FREQ_DDRPLL

//--------------------------------------------------
// Fifo Clk Sel Type
//--------------------------------------------------
#define _HW_FIFO_CLK_SEL_TYPE                                   _FIFO_CLK_SEL_GEN_1

//--------------------------------------------------
// Memory Type
//--------------------------------------------------
#define _HW_MEMORY_TYPE                                         _EMBEDDED_MEMORY
#define _HW_MEMORY_DDR3_DPIDLL_GEN_TYPE                         _GEN_NONE
#define _HW_MEMORY_DDR3_GEN_TYPE                                _GEN_NONE
#define _HW_MEMORY_DEVICE_MAX_COUNT                             2
#define _HW_MEMORY_DDR2_DPIDLL_GEN_TYPE                         _MEMORY_DDR2_DPIDLL_GEN_2
#define _HW_MEMORY_DDR2_GEN_TYPE                                _MEMORY_DDR2_GEN_0
#define _HW_MEMORY_DDR2_2PC_SEPARATE_SUPPORT                    _OFF

//-------------------------------------------------
// MPLL Structure
//-------------------------------------------------
#define _HW_MPLL_STRUCT_TYPE                                    _GEN_NONE // For No MPLL Case
...
//--------------------------------------------------
#define _HW_DISPLAY_ROTATION_CTRL_TYPE                          _DISPLAY_ROTATION_CTRL_GEN_1

//-------------------------------------------------
// FB To EO
//-------------------------------------------------
#define _HW_FB2EO_HWIDTH_SETTING_TYPE                           _FB2EO_HWIDTH_SETTING_GEN_NONE
...
#define _HW_M_DOMAIN_IMG_CMP_PATH_COUNT                         2

#define _HW_M_DOMAIN_IMG_CMP_ALL_PATH                           (_INPUT_PATH_M1 | _INPUT_PATH_S1)
#define _HW_M_DOMAIN_IMG_DECMP_ALL_PATH                         (_MDOMAIN_DISP_PATH_M1 | _MDOMAIN_DISP_PATH_S1)

#define _REG_PAGE_M1_M_DOMAIN_IMG_CMP                           0x4B
#define _REG_PAGE_M1_M_DOMAIN_IMG_DECMP                         0x4B
#define _REG_PAGE_M2_M_DOMAIN_IMG_CMP                           _PAGE_NONE
#define _REG_PAGE_M2_M_DOMAIN_IMG_DECMP                         _PAGE_NONE
#define _REG_PAGE_S1_M_DOMAIN_IMG_CMP                           0x4D
#define _REG_PAGE_S1_M_DOMAIN_IMG_DECMP                         0x4D
#define _REG_PAGE_S2_M_DOMAIN_IMG_CMP                           _PAGE_NONE
#define _REG_PAGE_S2_M_DOMAIN_IMG_DECMP                         _PAGE_NONE
#define _REG_PAGE_S3_M_DOMAIN_IMG_CMP                           _PAGE_NONE
#define _REG_PAGE_S3_M_DOMAIN_IMG_DECMP                         _PAGE_NONE
#define _REG_PAGE_S4_M_DOMAIN_IMG_CMP                           _PAGE_NONE
#define _REG_PAGE_S4_M_DOMAIN_IMG_DECMP                         _PAGE_NONE

//--------------------------------------------------
// HW IP Single Path Hwidth Limited
//--------------------------------------------------
#define _HW_IP_SINGLE_PATH_HWIDTH_LIMITED                       (4096) // Linebuffer Size of IP.(PQC, PQDC, SD, SU, LSR, ,DSHP, DisplayConversion)
...
#define _HW_MEMORY_BW_CTRL_3DDI_SUPPORT                         _OFF
...
//--------------------------------------------------
#define _HW_IMD_POWER_CUT_INDEPENDENT_SUPPORT                   _OFF

//--------------------------------------------------
// HW PR Mode Type
//--------------------------------------------------
#define _HW_M_DOMAIN_PR_MODE_TYPE                               _M_DOMAIN_PR_MODE_GEN_1
...
//-------------------------------------------------
#define _FW_MEM_ROW_ADDR_SHIFT_BIT_NUM                          ((GET_MEMORY_PIECE() == _MEMORY_2PCS) ? 10 : 9)
#define _FW_MEM_BANK_ADDR_SHIFT_BIT_NUM                         ((GET_MEMORY_PIECE() == _MEMORY_2PCS) ? 8 : 7)
...
//-------------------------------------------------
#define _HW_FRC_LENGTH_TYPE                                     _FRC_LENGTH_8BIT
