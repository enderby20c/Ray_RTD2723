...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6978_Gen_Option_D_Domain.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//-------------------------------------------------
#define _HW_ADJ_A1_LB_START_ADDR                                _OFF
...
#define _HW_D_DOMAIN_R1_A2_ACTIVE_SUPPORT                       _OFF
...
#define _HW_D_DOMAIN_R2_A2_ACTIVE_SUPPORT                       _OFF

#define _HW_D_DOMAIN_R3_A1_ACTIVE_SUPPORT                       _OFF

#define _HW_D_DOMAIN_R3_A2_ACTIVE_SUPPORT                       _OFF

#define _HW_D_DOMAIN_R1_BACKGROUND_SUPPORT                      _ON

#define _HW_D_DOMAIN_R2_BACKGROUND_SUPPORT                      ((_2P_PIP_DISPLAY_SUPPORT == _ON) ||\
                                                                 (_EAGLE_SIGHT_SUPPORT == _ON) ||\
                                                                 (_2P_PBP_LR_DISPLAY_SUPPORT == _ON))

#define _HW_D_DOMAIN_R3_BACKGROUND_SUPPORT                      _OFF
