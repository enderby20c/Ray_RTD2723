...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6829_Project_Default_Advanced.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// CPU32 Option
//--------------------------------------------------
#ifndef _CPU32_SCPU_PROGRAM_TEXT_ON_FLASH
#define _CPU32_SCPU_PROGRAM_TEXT_ON_FLASH                       (_OFF) // _ON to run on flash
#endif

#ifndef _CPU32_SCPU_PROGRAM_DATA_ON_XRAM
#define _CPU32_SCPU_PROGRAM_DATA_ON_XRAM                        (_OFF) // _ON to put variables on xram
#endif

#ifndef _CPU32_SCPU_XRAM_INIT_ONLY_WHEN_AC_ON
#define _CPU32_SCPU_XRAM_INIT_ONLY_WHEN_AC_ON                   (_OFF) // _ON to init SCPU xram data only on AC ON
#endif

#ifndef _CPU32_COMPRESSED_IMAGE_SUPPORT
#define _CPU32_COMPRESSED_IMAGE_SUPPORT                         ((_SCPU_SUPPORT == _ON) && (_CPU32_SCPU_PROGRAM_TEXT_ON_FLASH == _OFF))
#endif

#ifndef _CPU32_BW32_FORCE_FW_MODE
#define _CPU32_BW32_FORCE_FW_MODE                               (_OFF)
#endif

#ifndef _CPU32_SCPU_FW_MODE
#define _CPU32_SCPU_FW_MODE                                     _SCPU_FW_MODE_COPROCESSOR
#endif

#ifndef _CPU32_SCPU_DDR_TEXT_BANKS
#define _CPU32_SCPU_DDR_TEXT_BANKS                              (32) // 32, 64, 128, 256
#endif

#ifndef _SCPU_RTOS
#define _SCPU_RTOS                                              _OFF
#endif
...
#ifndef _GOSD_DISPLAY_BW_CTRL_SUPPORT
#define _GOSD_DISPLAY_BW_CTRL_SUPPORT                           _OFF
#endif

#ifndef _GOSD_DRAW_BW_CTRL_SUPPORT
#define _GOSD_DRAW_BW_CTRL_SUPPORT                              (_GOSD_SUPPORT == _ON)
#endif
...
//-------------------------------------------------
// Framesync mode Fixed Lastline
//-------------------------------------------------
#ifndef _FRAMESYNC_MODE_FIX_LASTLINE
#define _FRAMESYNC_MODE_FIX_LASTLINE                            _OFF
#endif
...
//--------------------------------------------------
// MTP 3PFLAG Performance Option
//--------------------------------------------------
#ifndef _3P_FLAG_PERFORMANCE_TYPE
#define _3P_FLAG_PERFORMANCE_TYPE                               _MAIN_EQUAL_TO_SUB
#endif
...
//-------------------------------------------------
// Increase 1p BW to 80%
//-------------------------------------------------
#ifndef _BW_80_PERCENT_1P_SUPPORT
#define _BW_80_PERCENT_1P_SUPPORT                               _OFF
#endif
...
// 3DDI Option
//--------------------------------------------------
#ifndef _3DDI_FUNCTION
#define _3DDI_FUNCTION                                          _OFF
#endif
...
#define _ADCNR_SUPPORT                                          (_VGA_SUPPORT == _ON)
#endif
...
#define _OD_6_0_AND_4_5_BIT_MODE_IMPROVE_OPTION                 _ON
#endif
...
#ifndef _GLOBAL_HUE_SATURATION_HDR_SUPPORT
#define _GLOBAL_HUE_SATURATION_HDR_SUPPORT                      _OFF
#endif
...
#ifndef _LOCAL_DIMMING_HISTO_BLACK_LSB_SUPPORT
#define _LOCAL_DIMMING_HISTO_BLACK_LSB_SUPPORT                  _OFF
#endif
...
#ifndef _LOCAL_DIMMING_BOOST_CMD_SEND_BY_SCPU
#define _LOCAL_DIMMING_BOOST_CMD_SEND_BY_SCPU                   _SCPU_SUPPORT
#endif
...
#define _PCM_FULL_TIME_FUNCTION                                 _OFF
#endif
...
// GOSD Option
//-------------------------------------------------
#ifndef _GOSD_SURFACE_NUMBER
#define _GOSD_SURFACE_NUMBER                                    512 // max: 1024
#endif

#ifndef _GOSD_OSD_LINK_DISABLE_IN_DCLK_CHANGING
#define _GOSD_OSD_LINK_DISABLE_IN_DCLK_CHANGING                 _OFF
#endif

//-------------------------------------------------
// DM Function
//-------------------------------------------------
#ifndef _DM_DEMO_FUNCTION
#define _DM_DEMO_FUNCTION                                       (_DM_CUSTOMER_FW_ID == 0x5AE98BCB)
#endif

#ifndef _DM_MUTE_MODE
#define _DM_MUTE_MODE                                           _DM_MUTE_I_DEN_START
#endif

#ifndef _DM_FB_EAGLE_SIGHT_SUPPORT
#define _DM_FB_EAGLE_SIGHT_SUPPORT                              _OFF
#endif

#ifndef _DM_CUSTOM_COLOR_SUPPORT
#define _DM_CUSTOM_COLOR_SUPPORT                                _OFF
#endif
...
///////////
//--------------------------------------------------
// Definitions of Flash 4BYTE MODE
//--------------------------------------------------
#ifndef _FLASH_4BYTE_MODE_FUNCTION_SUPPORT
#define _FLASH_4BYTE_MODE_FUNCTION_SUPPORT                      _OFF
#endif
...
//-------------------------------------------------
// System Source Search Time Option for DP TBT
//-------------------------------------------------
#ifndef _SOURCE_DEFAULT_SEARCH_TIME_TBT
#define _SOURCE_DEFAULT_SEARCH_TIME_TBT                         _SOURCE_DEFAULT_SEARCH_TIME_DP
#endif

#ifndef _SOURCE_DEFAULT_SEARCH_TIME_TBT_NO_CABLE
#define _SOURCE_DEFAULT_SEARCH_TIME_TBT_NO_CABLE                _SOURCE_DEFAULT_SEARCH_TIME_DP_NO_CABLE
#endif
...
//--------------------------------------------------
// F/B power cut group always on
//--------------------------------------------------
#ifndef _POWER_CUT_GROUP_FB_ALWAYS_ON_SUPPORT
#define _POWER_CUT_GROUP_FB_ALWAYS_ON_SUPPORT                   _OFF
#endif
...
//--------------------------------------------------
#ifndef _DIG_FILTER_PHASE_SUPPORT
#define _DIG_FILTER_PHASE_SUPPORT                               (_VGA_SUPPORT == _ON)
#endif
...
//--------------------------------------------------
// VGA Mode Slot Amount
//--------------------------------------------------
#ifndef _MODE_SLOT_AMOUNT
...
#define _HDMI_CEC_ARBITRATION_MODE_FIXED_VERSION                _OFF
#endif

#ifndef _HDMI_CEC_RX_LOWIMPEDANCE_FIXED_VERSION
#define _HDMI_CEC_RX_LOWIMPEDANCE_FIXED_VERSION                 _OFF
#endif

#ifndef _HDMI_CEC_MULTI_LA_FREETIME_FIXED_VERSION
#define _HDMI_CEC_MULTI_LA_FREETIME_FIXED_VERSION               _OFF
#endif

#ifndef _HDMI_CEC_MATCH_ADDR_CLEAR_FIXED_VERSION
#define _HDMI_CEC_MATCH_ADDR_CLEAR_FIXED_VERSION                _OFF
#endif
...
//--------------------------------------------------
// HDMI ON POWER CONTROL BY CABLE
//--------------------------------------------------
...
#define _DP_DYNAMIC_POWER_MANAGEMENT_SUPPORT                    _OFF
#endif
...
//--------------------------------------------------
// DP Rx DC On Assert Long HPD Option
//--------------------------------------------------
#ifndef _DP_DC_ON_LONG_HPD_ASSERT_COMPATIBLE_MODE
#define _DP_DC_ON_LONG_HPD_ASSERT_COMPATIBLE_MODE               _OFF
#endif
...
#define _U3_DYNAMIC_POWER_MANAGEMENT_SUPPORT                    _OFF
#endif
...
#ifndef _DAC_OUTPUT_DC_OFF_SET_SUPPORT
#define _DAC_OUTPUT_DC_OFF_SET_SUPPORT                          _OFF // Speaker & headphone Output join in DC OFF SET Value
#endif
...
#define _DDR3PLL_SSC_AMPLITUDE                                  _1_PERCENT // Support 0.5% & 1%
#endif
...
#define _DDR3_KGD_DCC_SUPPORT                                   (_FW_DDR_PLL_CLOCK != _MEMORY_SPEED_933MHZ)
#endif
...
#define _FW_UPDATE_FW_SPEED_UP_SUPPORT                          _OFF
#endif
...
// OSD disable option
//-------------------------------------------------
#ifndef _SMART_OSD_DISABLE_IN_ASPECT_RATIO_CHANGE
#define _SMART_OSD_DISABLE_IN_ASPECT_RATIO_CHANGE               _OFF
#endif
...
//-------------------------------------------------
// OSD HW H delay limit
//-------------------------------------------------
#ifndef _OSD_H_DELAY_LIMIT_BYPASS
#define _OSD_H_DELAY_LIMIT_BYPASS                               _OFF
#endif

#ifndef _DUAL_BANK_ROLLBACK_SUPPORT
#define _DUAL_BANK_ROLLBACK_SUPPORT                             _OFF
#endif

//-------------------------------------------------
// Display OOR Option
//-------------------------------------------------
#ifndef _DP_IVF_OOR_EXTEND_SUPPORT
#define _DP_IVF_OOR_EXTEND_SUPPORT                              _OFF
#endif
