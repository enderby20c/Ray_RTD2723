...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6829_Project_Default.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#include <Project/RL6829_Project_Default_Advanced.h>
...
//--------------------------------------------------
#ifndef _PCB_TYPE
#define _PCB_TYPE                                               _RL6829_PCB_EXAMPLE
#endif
...
#ifndef _2P_PBP_TB_DISPLAY_SUPPORT
#define _2P_PBP_TB_DISPLAY_SUPPORT                              _OFF
#endif

#ifndef _3P_FLAG_DISPLAY_SUPPORT
#define _3P_FLAG_DISPLAY_SUPPORT                                _OFF
#endif

#ifndef _3P_SKEW_LR_DISPLAY_SUPPORT
#define _3P_SKEW_LR_DISPLAY_SUPPORT                             _OFF
#endif

#ifndef _3P_SKEW_TB_DISPLAY_SUPPORT
#define _3P_SKEW_TB_DISPLAY_SUPPORT                             _OFF
#endif
...
#ifndef _RINGING_FILTER_FUNCTION
...
#ifndef _DM_CUSTOMER_FW_ID
#define _DM_CUSTOMER_FW_ID                                      0x00000000
#endif

#ifndef _DM_CONFIG_TABLE
#define _DM_CONFIG_TABLE                                        "Panel/ZeroTable.h"
#endif

#ifndef _DM_CONFIG_DARK_MODE_INDEX
#define _DM_CONFIG_DARK_MODE_INDEX                              _DM_PICTURE_MODE_NONE
#endif

#ifndef _DM_CONFIG_BRIGHT_MODE_INDEX
#define _DM_CONFIG_BRIGHT_MODE_INDEX                            _DM_PICTURE_MODE_NONE
#endif

#ifndef _DM_CONFIG_GAME_MODE_INDEX
#define _DM_CONFIG_GAME_MODE_INDEX                              _DM_PICTURE_MODE_NONE
#endif

#ifndef _DM_CONFIG_USER_MODE_INDEX
#define _DM_CONFIG_USER_MODE_INDEX                              _DM_PICTURE_MODE_NONE
#endif

//-------------------------------------------------
// OSD Option
//-------------------------------------------------
#ifndef _GOSD_SUPPORT
#define _GOSD_SUPPORT                                           _OFF
#endif

#ifndef _GOSD_IMAGE_SOURCE_NUMBER
#define _GOSD_IMAGE_SOURCE_NUMBER                               2048 // max: 2048
#endif

#ifndef _GOSD_MEMORY_SIZE
#define _GOSD_MEMORY_SIZE                                       2000 // 1 ~ _MEMORY_ROW, unit: row
#endif

#ifndef _GOSD_MEMORY_BW_DISPLAY
#define _GOSD_MEMORY_BW_DISPLAY                                 15 // unit: percent
#endif

#ifndef _GOSD_MEMORY_BW_DRAW
#define _GOSD_MEMORY_BW_DRAW                                    5 // 1 ~ 20, unit: percent
#endif

#ifndef _GOSD_CONTINUOUS_STEP_MAX
#define _GOSD_CONTINUOUS_STEP_MAX                               255 // 1 ~ 255
#endif

#ifndef _GOSD_MAINLOOP_DELAY_MAX_MS
#define _GOSD_MAINLOOP_DELAY_MAX_MS                             100
#endif

#ifndef _FOSD_SU_H_FACTOR_MIN
#define _FOSD_SU_H_FACTOR_MIN                                   16 // x4. HFactor = H input/ H output * 2^6 = 64 ~ 16
#endif
...
#define _INPUTCLOCK_RANG_DP                                     14000 // Unit in 0.1 MHz
#endif

#ifndef _INPUTCLOCK_RANG_USBC
#define _INPUTCLOCK_RANG_USBC                                   14000 // Unit in 0.1 MHz
#endif
...
#define _YPBPR_SUPPORT                                          (_VGA_SUPPORT == _ON)
#endif

#ifndef _SOG_SUPPORT
#define _SOG_SUPPORT                                            (_VGA_SUPPORT == _ON)
#endif

#ifndef _VGA_COMPOSITE_SUPPORT
#define _VGA_COMPOSITE_SUPPORT                                  (_VGA_SUPPORT == _ON)
#endif
...
//--------------------------------------------------
#ifndef _DIG_FILTER_NSMEAR_SUPPORT
#define _DIG_FILTER_NSMEAR_SUPPORT                              (_VGA_SUPPORT == _ON)
#endif

#ifndef _DIG_FILTER_PSMEAR_SUPPORT
#define _DIG_FILTER_PSMEAR_SUPPORT                              (_VGA_SUPPORT == _ON)
#endif

#ifndef _DIG_FILTER_NRING_SUPPORT
#define _DIG_FILTER_NRING_SUPPORT                               (_VGA_SUPPORT == _ON)
#endif

#ifndef _DIG_FILTER_PRING_SUPPORT
#define _DIG_FILTER_PRING_SUPPORT                               (_VGA_SUPPORT == _ON)
#endif

#ifndef _DIG_FILTER_EXTENSION_SUPPORT
#define _DIG_FILTER_EXTENSION_SUPPORT                           (_VGA_SUPPORT == _ON)
#endif

#ifndef _DIG_FILTER_ENHANCE_PHASE_SUPPORT
#define _DIG_FILTER_ENHANCE_PHASE_SUPPORT                       (_VGA_SUPPORT == _ON)
#endif
...
#define _LINE_IN_DAC_AOUT_GAIN_DB                               _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.25dB for each step, Max Gain: 'b111(2.5dB)
#endif

#ifndef _LINE_IN_DAC_HPOUT_GAIN_DB
#define _LINE_IN_DAC_HPOUT_GAIN_DB                              _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.25dB for each step, Max Gain: 'b111(2.5dB)
#endif
...
#define _DIGITAL_DAC_AOUT_GAIN_DB                               _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.25dB for each step, Max Gain: 'b111(2.5dB)
#endif

#ifndef _DIGITAL_DAC_HPOUT_GAIN_DB
#define _DIGITAL_DAC_HPOUT_GAIN_DB                              _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.25dB for each step, Max Gain: 'b111(2.5dB)
#endif
...
// CPU32 Option
//--------------------------------------------------
#ifndef _SCPU_SUPPORT
#define _SCPU_SUPPORT                                           _OFF
#endif
