...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6978_Project_Default.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#include <Project/RL6978_Project_Default_Advanced.h>
...
//--------------------------------------------------
#ifndef _PCB_TYPE
#define _PCB_TYPE                                               _RL6978_PCB_EXAMPLE
#endif
...
#define _INPUTCLOCK_RANG_HDMI21                                 6000 // Unit in 0.1 MHz
#endif
...
#ifndef _USB2_HOST_FW_FILE_NAME_STRING_USER_DEFINE_SUPPORT
#define _USB2_HOST_FW_FILE_NAME_STRING_USER_DEFINE_SUPPORT      _OFF
#endif
...
#define _LINE_IN_DAC_AOUT_GAIN_DB                               _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.4dB for each step, Max Gain: 3'b111(1.6dB)
#endif

#ifndef _LINE_IN_DAC_HPOUT_GAIN_DB
#define _LINE_IN_DAC_HPOUT_GAIN_DB                              _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.4dB for each step, Max Gain: 3'b111(1.6dB)
#endif
...
#define _DIGITAL_DAC_AOUT_GAIN_DB                               _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.4dB for each step, Max Gain: 3'b111(1.6dB)
#endif

#ifndef _DIGITAL_DAC_HPOUT_GAIN_DB
#define _DIGITAL_DAC_HPOUT_GAIN_DB                              _AUDIO_DAC_OUTPUT_GAIN_0_DB // 0dB, 0.4dB for each step, Max Gain: 3'b111(1.6dB)
#endif
